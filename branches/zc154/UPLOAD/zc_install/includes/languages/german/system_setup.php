...
define('PHYSICAL_PATH_INSTRUCTION', 'Der physikalische Pfad zu Ihrem Zen Cart Verzeichnis. Bitte OHNE abschließenden "Slash".');
define('VIRTUAL_HTTP_PATH', 'Virtueller HTTP Pfad');
define('VIRTUAL_HTTP_PATH_INSTRUCTION', 'Virtueller Pfad zu Ihrem Zen Cart Verzeichnis. Bitte OHNE abschließenden "Slash".');
define('VIRTUAL_HTTPS_PATH', 'Virtueller HTTPS Pfad');
define('VIRTUAL_HTTPS_PATH_INSTRUCTION', 'Virtueller Pfad zu Ihrem sicheren Zen Cart Verzeichnis. Bitte OHNE abschließenden "Slash".');
define('VIRTUAL_HTTPS_SERVER', 'Virtueller HTTPS Server');
define('VIRTUAL_HTTPS_SERVER_INSTRUCTION', 'Virtueller Server zu Ihrem sicheren Zen Cart Verzeichnis. Bitte OHNE abschließenden "Slash".');
