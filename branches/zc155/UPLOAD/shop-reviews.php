...
if (file_exists(MH_ROOT_PATH . 'configbeez/config_shopvoting/includes/inc_shopvoting.php')) {
    require_once(MH_ROOT_PATH . 'configbeez/config_shopvoting/includes/inc_shopvoting.php');
} else {
    ?>
