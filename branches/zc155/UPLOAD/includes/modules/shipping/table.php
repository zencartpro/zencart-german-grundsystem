 ...
 * @version $Id: table.php 731 2016-03-10 20:49:16Z webchills $
 */
/**
...
class table extends base {
  ...
  function install() {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Steuerklasse', 'MODULE_SHIPPING_TABLE_HANDLING_METHOD', '43', 'Folgende Steuerklasse auf die Versandkosten anwenden:', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Grundlage der Steuern', 'MODULE_SHIPPING_TABLE_TAX_CLASS', '43', 'Möglichkeiten sind:<br />Lieferadresse = Steuern der Versandkosten richten sich nach der Lieferadresse des Kunden<br />Rechnungsadresse = Steuern der Versandkosten richten sich nach der Rechnungsadresse des Kunden<br />Shopadresse = Steuern der Versandkosten richten sich nach der Adresse des Shops', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Versandzone', 'MODULE_SHIPPING_TABLE_TAX_BASIS', '43', 'Für welche Länder soll diese Versandart angeboten werden?<br />Die auswählbaren Versandzonen entsprechen den angelegten Steuerzonen und den dort hinterlegten Ländern.', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Sortierreihenfolge', 'MODULE_SHIPPING_TABLE_ZONE', '43', 'Anzeigereigenfolge für dieses Modul. Der niedrigste Wert wird zuerst angezeigt.', now())");
  }
  /**
   * Enter description here...
   *
