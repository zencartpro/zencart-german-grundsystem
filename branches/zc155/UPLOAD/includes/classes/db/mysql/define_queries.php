 ...
 * @version $Id: define_queries.php 730 2015-12-21 19:49:16Z webchills $
 */
...
DEFINE('SQL_ALSO_PURCHASED', "SELECT p.products_id, p.products_image
                     ...
                     GROUP BY p.products_id, p.products_image desc
                     ORDER BY o.date_purchased desc, p.products_id
                     LIMIT 50");
