...
# * @version $Id: mysql_zencart.sql 19456 2016-03-03 20:49:16Z webchills $
#
...
INSERT INTO google_analytics_languages VALUES (3,'Danish - DÃ¤nisch','da',3);
INSERT INTO google_analytics_languages VALUES (4,'Dutch - HollÃ¤ndisch','nl',4);
...
INSERT INTO google_analytics_languages VALUES (9,'French - FranzC6sisch','fr',9);
INSERT INTO google_analytics_languages VALUES (10,'German - Deutsch','de',10);
INSERT INTO google_analytics_languages VALUES (11,'Hebrew - HebrÃ¤isch','iw',11);
...
INSERT INTO google_analytics_languages VALUES (22,'Turkish - TÃ¼rkisch','tr',22);
...
(1, 43, 'Mein Shop', 'Generelle Informationen Ã¼ber den Shop', 1, 1),
(2, 43, 'Minimale Werte', 'Die minimale ZeichenlÃ¤nge fÃ¼r Funktionen / Daten', 2, 1),
(3, 43, 'Maximale Werte', 'Die maximale ZeichenlÃ¤nge fÃ¼r Funktionen / Daten', 3, 1),
(4, 43, 'Bilder', 'Einstellungen der Bildparameter', 4, 1),
(5, 43, 'Kundendetails', 'Konfiguration der Kundenkonten', 5, 1),
(6, 43, 'Moduloptionen', 'Vom KonfigurationsmenÃ¼ versteckt', 6, 0),
(7, 43, 'Versandoptionen', 'Im Shop verÃ¼gbare Versandoptionen', 7, 1),
...
(11, 43, 'AGB und Datenschutz', 'Konfiguration fÃ¼r die AGB', 16, 1),
(12, 43, 'E-Mail Optionen', 'Generelle Einstellungen fÃ¼r den E-Mail Transport (SMTP) und die HTML Optionen', 12, 1),
(13, 43, 'Attributeinstellungen', 'Konfiguration fÃ¼r die Einstellungen der Artikeloptionen', 13, 1),
...
(18, 43, 'Artikeldetails', 'Konfiguration fÃ¼r die Anzeige von Artikeldetails', 18, 1),
(19, 43, 'Layouteinstellungen', 'Layouteinstellungen', 19, 1),
(20, 43, 'Shopwartung', 'Konfiguration der Shopwartung', 20, 1),
(21, 43, 'Liste - Neue Artikel', 'Listenansicht fÃ¼r neue Artikel', 21, 1),
(22, 43, 'Liste - Empfohlene Artikel', 'Listenansicht fÃ¼r Empfohlene Artikel', 22, 1),
(23, 43, 'Liste - Alle Artikel', 'Listenansicht fÃ¼r alle Artikel', 23, 1),
(24, 43, 'Liste - Artikelindex', 'Listenansicht fÃ¼r Artikelindex', 24, 1),
(25, 43, 'Eigene Seiten', 'Eigene Seiten, die Ã¼ber den im Seiteneditor eingegebenen Texte festgelegt werden', 25, 1),
...
# AdminmenÃ¼ ID 1
('Shopname', 'STORE_NAME', 43, 'Geben Sie hier einen Namen fÃ¼r Ihren Shop ein', now(), now()),
('Shopinhaber', 'STORE_OWNER', 43, 'Geben Sie hier einen Namen des Shopinhabers ein', now(), now()),
('Telefonnummer des Kundenservice', 'STORE_TELEPHONE_CUSTSERVICE', 43, 'Geben Sie hier die Telefonnumer an, unter der Kunden Ihren Kundenservice erreichen kC6nnen.', now(), now()),
...
('Automatisch zur StandardwÃ¤hrung der Sprache wechseln', 'USE_DEFAULT_LANGUAGE_CURRENCY', 43, 'Soll automatisch zu der zur Sprache passenden WÃ¤hrung gewechselt werden?', now(), now()),
...
('Suchmaschinenfeste (Kurz-)URLs verwenden (noch in der Entwicklung)', 'SEARCH_ENGINE_FRIENDLY_URLS', 43, 'Suchmaschinenfeste URLs (KurzURL) fÃ¼r alle Links im Shop verwenden', now(), now()),
('Warenkorb nach HinzufÃ¼gen eines Artikels anzeigen', 'DISPLAY_CART', 43, 'Soll der Warenkorb nach dem HinzufÃ¼gen eines Artikels angezeigt werden? (HINWEIS: false= nein, zurÃ¼ck zum Artikel)', now(), now()),
('Standard Suchoperator', 'ADVANCED_SEARCH_DEFAULT_OPERATOR', 43, 'Standard Suchoperator<br />"AND": WÃ¶rter, die vorkommen mÃ¼ssen<br />"OR": WÃ¶rter, die vorkommen kC6nnen<br />"NOT": WÃ¶rter, die nicht vorkommen sollen', now(), now()),
...
('ZÃ¤hler hinter Kategorienamen anzeigen', 'SHOW_COUNTS', 43, 'Soll der ZÃ¤hler, der die Anzahl von Artikel in der jeweiligen Kategorie anzeigt, hinter dem Kategorienamen sichtbar sein?', now(), now()),
...
('Gesplittete Steueranzeige', 'SHOW_SPLIT_TAX_CHECKOUT', 43, 'Wenn Artikel mit verschiedenen SteuersÃ¤tzen bestellt werden, soll dann im Bestellvorgang jeder Steuersatz in einer eigenen Zeile ausgewiesen werden?', now(), now()),
('Timeout der Admin-Sitzungen (in Sekunden)', 'SESSION_TIMEOUT_ADMIN', 43, 'Geben Sie die Zeit in Sekunden an. Standard=900<br /> Beispiel: 900= 15 Minuten<br /><b>WICHTIGER HINWEIS: Wenn Sie diesen Wert auf Ã¼ber 900 erHÃ¶hen, dann erfÃ¼llt Ihr Shop die Richtlinien der PA-DSS Zertifizierung nicht mehr!</b><br/><br/>Eine zu geringe Zeitangabe kann zu Problemen bei der Bearbeitung von Artikeln fÃ¼hren.', now(), now()),
('Maximale Zeit fÃ¼r die AusfÃ¼hrung von Prozessen', 'GLOBAL_SET_TIME_LIMIT', 43, 'Geben Sie die Zeit in Sekunden an. Standard=60<br />Beispiel: 60= 1 Minute<br /><br />HINWEIS: Diesen Wert sollte nur geÃ¤ndert werden, wenn es Probleme bei der AusfÃ¼hrung von Prozessen gibt.', now(), now()),
('Auf neue Version von Zen Cart prÃ¼fen', 'SHOW_VERSION_UPDATE_IN_HEADER', 43, 'Automatische ÃœberprÃ¼fung auf eine neuere Version von Zen Cart bei der Anmeldung im Admin-Bereich. Zeigt dies dann im Header des Admin Bereichs an. Wenn dieses Feature aktiviert ist, kann es manchmal zu GeschwindigkeitseinbuCen im Admin Bereich kommen.', now(), now()),
('Art des Shops', 'STORE_STATUS', 43, 'Welcher Art ist Ihr Shop:<br />0= Normaler Shop<br />1= Showroom ohne Preise<br />2= Showroom mit Preisen<br> Showroom = Artikel werden angezeigt, kC6nnen aber nicht gekauft werden!', now(), now()),
('Server Onlinestatus anzeigen', 'DISPLAY_SERVER_UPTIME', 43, 'Zeigt die Onlinezeit des Servers an.<br />HINWEIS: Das Aktivieren diese Einstellung kann bei einigen Server EintrÃ¤ge in den Fehlerprotokollen verursachen.  (true = anzeigen, false = nicht anzeigen)', now(), now()),
('ÃœberprÃ¼fung auf fehlende Seiten', 'MISSING_PAGE_CHECK', 43, 'Zen Cart kann das Fehlen von Seiten in einer URL erkennen und leitet dann bei Bedarf auf die Startseite weiter.<br />fÃ¼r ein Debugging kann diese Funktion deaktiviert werden. (true = Auf fehlende Seiten prÃ¼fen, false = Keine ÃœberprÃ¼fung auf fehlende Seiten)', now(), now()),
('cURL Proxy Status', 'CURL_PROXY_REQUIRED', 43, 'Verwenden Sie einen Web-Provider, der fÃ¼r die Kommunikation mit externen Seiten cURL via Proxy verwendet?', now(), now()),
('cURL Proxy Adresse', 'CURL_PROXY_SERVER_DETAILS', 43, 'Wenn Sie einen Provider einsetzen, der cURL verwendet (wie z.B. <em>GoDaddy</em> oder <em>Dreamhost</em>), welcher Ã¼ber einen Proxy via cURL mit externen Seiten kommuniziert, dann geben Sie hier die Adresse des Proxy Servers ein.<br />Format: adresse:port<br />z.B.: fÃ¼r GoDaddy geben Sie folgendes ein: 64.202.165.130:3128', now(), now()),
...
('KategoriezÃ¤hler im Adminbereich anzeigen', 'SHOW_COUNTS_ADMIN', 43, 'Soll der KategoriezÃ¤hler im Adminbereich angezeigt werden?', now(), now()),
('Multiplikator fÃ¼r FremdwÃ¤hrungen', 'CURRENCY_UPLIFT_RATIO', 43, 'Wie hoch soll der Faktor fÃ¼r den Aufschlag von FremdwÃ¤hrungen in Ihrem Shop bei der Aktualisierung der WÃ¤hrungskurse sein?<br /><br />BESCHREIBUNG:<br />Der Umrechnungskurs wird vom externen Wechselkurs-Server wÃ¤hrend der Abfrage festgestellt und mit Ihrem Shop abgeglichen.<br />Wird als Faktor z.B. der Wert <em>2.00</em> verwendet, werden FremdwÃ¤hrungen mit diesem Wert multipliziert.<br /><br />BEISPIEL:<br />Die WÃ¤hrung <em>EURO</em> ist als <em>Standard</em> definiert:<br />Kurs: EURO = 1.00000000; USD = 1.40000000<br />Als Faktor wird <em>2.00</em> verwendet.<br />Ergebnis: Euro = 1.00000000; USD = 2.80000000<br /><br /><br />Standard: 1.05', now(), now()),
('EU LÃ¤nder', 'EU_COUNTRIES_FOR_LAST_STEP', 43, 'Tragen Sie hier die Mitgliedsstaaten der EuropÃ¤ischen Union ein. Wenn an LÃ¤nder geliefert wird, die nicht in dieser Liste stehen, dann erscheint im letzten Schritt des Bestellvorgangs ein Hinweis auf mC6gliche ZollGebÃ¼hren. Zweistellige ISO Codes mit Komma getrennt.<br/><br/>Falls Sie Ihren Shop in der Schweiz betreiben, dann tragen Sie hier nur CH ein, so dass der Hinweis dann bei Lieferungen ausserhalb der Schweiz angezeigt wird!', now(), now()),
('Admin Timeout gemÃ¤ss PA-DSS Zertifizierung?', 'PADSS_ADMIN_SESSION_TIMEOUT_ENFORCED', 43, 'Der Shop erfÃ¼llt nur dann die Richtlinien einer PA-DSS Zertifizierung, wenn die Adminsitzung nach 15 Minuten InaktivitÃ¤t beendet wird. Nach 15 Minuten InaktivitÃ¤t werden Sie aus der Administration ausgeloggt. Wenn Sie das nicht wollen, dann deaktivieren Sie hier diese Einstellung.<br/><b>Achtung: Durch das Deaktivieren dieser Einstellung erfÃ¼llt Ihr Shop die PA-DSS Richtlinien nicht mehr und ist daher fÃ¼r eine Zertifizierung ungeeignet!</b>', now(), now()),
('Admin Passwortregeln gemÃ¤ss PA-DSS Zertifizierung?', 'PADSS_PWD_EXPIRY_ENFORCED', 43, 'Der Shop erfÃ¼llt nur dann die Richtlinien einer PA-DSS Zertifizierung, wenn die AdminpassWÃ¶rter alle 90 Tage geÃ¤ndert werden und dabei nicht die 4 letzten PassWÃ¶rter wiederverwendet werden dÃ¼rfen. Wenn Sie das nicht wollen, dann deaktivieren Sie hier diese Einstellung.<br/><b>Achtung: Durch das Deaktivieren dieser Einstellung erfÃ¼llt Ihr Shop die PA-DSS Richtlinien nicht mehr und ist daher fÃ¼r eine Zertifizierung ungeeignet!</b>', now(), now()),
...
('PA-DSS Ajax Checkout?', 'PADSS_AJAX_CHECKOUT', 43, 'PA-DSS Compliance erfordert, dass fÃ¼r manche integrierte Zahlungsmodule Ajax zum Laden der BestellbestÃ¤tigungsseite verwendet wird. Das wird zwar nur geschehen, falls solche speziellen Zahlungsmodule verwendet werden, dennoch bevorzugen Sie vielleicht den traditionellen Checkout. <strong>Wenn Die diese Einstellung deaktivieren, dann erfÃ¼llt Ihr Shop nicht mehr die PA-DSS Vorgaben.</strong>', now(), now()),

# AdminmenÃ¼ ID 2
('Vorname', 'ENTRY_FIRST_NAME_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r den Vornamen', now(), now()),
('Nachname', 'ENTRY_LAST_NAME_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r den Nachnamen', now(), now()),
('Geburtsdatum', 'ENTRY_DOB_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r das Geburtsdatum', now(), now()),
('E-Mail Adresse', 'ENTRY_EMAIL_ADDRESS_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r die E-Mail Adresse', now(), now()),
('Strasse', 'ENTRY_STREET_ADDRESS_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r die Strasse', now(), now()),
('Firma', 'ENTRY_COMPANY_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge der Firma', now(), now()),
('Postleitzahl', 'ENTRY_POSTCODE_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge der Postleitzahl', now(), now()),
('Stadt', 'ENTRY_CITY_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge der Stadt', now(), now()),
('Bundesland', 'ENTRY_STATE_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r das Bundesland', now(), now()),
('Telefonnummer', 'ENTRY_TELEPHONE_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r die Telefonnummer', now(), now()),
('Passwort', 'ENTRY_PASSWORD_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r das Passwort', now(), now()),
('Kreditkarteninhaber', 'CC_OWNER_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r den Namen des Kreditkarteninhabers', now(), now()),
('Kreditkartennummer', 'CC_NUMBER_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r die Kreditkartennummer', now(), now()),
('Kreditkarten PrÃ¼fziffer (CVV)', 'CC_CVV_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r den Kreditkarten PrÃ¼fziffer (CVV)', now(), now()),
('ZeichenlÃ¤nge fÃ¼r Bewertungstexte', 'REVIEW_TEXT_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r den Text einer Bewertung', now(), now()),
...
('Nickname', 'ENTRY_NICK_MIN_LENGTH', 43, 'Minimale ZeichenlÃ¤nge fÃ¼r Nicknamen', now(), now()),

# AdminmenÃ¼ ID 3
('AdresseintrÃ¤ge im Adressbuch', 'MAX_ADDRESS_BOOK_ENTRIES', 43, 'Wieviele AdresseintrÃ¤ge dÃ¼rfen Kunden in Ihrem Adressbuch haben?', now(), now()),
...
('"Vorherige - NÃ¤chste" Navigation: Seitenlinks', 'MAX_DISPLAY_PAGE_LINKS', 43, 'Anzahl der Seitenlinks in der "Vorherige - NÃ¤chste" Navigation', now(), now()),
...
('Hersteller - Listenfeld GrÃ¶ÃŸe/Stil', 'MAX_MANUFACTURERS_LIST', 43, 'Anzahl der Hersteller, die im Listenfeld angezeigt werden sollen. Bei einer Eingabe von 0 oder 1 wird eine Dropdown Liste angezeigt.', now(), now()),
('Hersteller Liste - ProduktÃ¼berprÃ¼fung', 'PRODUCTS_MANUFACTURERS_STATUS', 43, 'Hersteller wird nur dann in der Liste angezeigt wenn mindestens 1 Produkt von Ihm VerfÃ¼gbar ist.<br/>0=AUS<br/>1=EIN<br/>Anmerkung: Ein Aktivieren dieser Einstellung kann bei Shops mit vielen Artikeln zu Performance-EinbuCen fÃ¼hren.', now(), now()),
('Musik Genre - Listenfeld GrÃ¶ÃŸe/Stil', 'MAX_MUSIC_GENRES_LIST', 43, 'Anzahl der Musik Genres, die im Listenfeld angezeigt werden sollen. Bei einer Eingabe von 0 oder 1 wird eine Dropdown Liste angezeigt.', now(), now()),
('Plattenfirma - Listenfeld GrÃ¶ÃŸe/Stil', 'MAX_RECORD_COMPANY_LIST', 43, 'Anzahl der Plattenfirmen, die im Listenfeld angezeigt werden sollen. Bei einer Eingabe von 0 oder 1 wird eine Dropdown Liste angezeigt.', now(), now()),
('LÃ¤nge der Namen von Plattenfirmen', 'MAX_DISPLAY_RECORD_COMPANY_NAME_LEN', 43, 'Wird in der Box "Plattenfirma" verwendet; Maximale LÃ¤nge der anzuzeigenden Namen von Plattenfirmen. LÃ¤ngere Namen werden abgeschnitten.', now(), now()),
('LÃ¤nge der Namen von Musik Genres', 'MAX_DISPLAY_MUSIC_GENRES_NAME_LEN', 43, 'Wird in der Box "Musik Genre" verwendet; Maximale LÃ¤nge der anzuzeigenden Namen von Musik Genres. LÃ¤ngere Namen werden abgeschnitten.', now(), now()),
('LÃ¤nge der Namen von Herstellern', 'MAX_DISPLAY_MANUFACTURER_NAME_LEN', 43, 'Wird in der Box "Hersteller" verwendet; Maximale LÃ¤nge der anzuzeigenden Namen von Herstellern. LÃ¤ngere Namen werden abgeschnitten.', now(), now()),
('Neue Artikelbewertungen pro Seite', 'MAX_DISPLAY_NEW_REVIEWS', 43, 'Anzahl der Bewertungen auf jeder Seite', now(), now()),
('Box "Bewertungen": zufÃ¤llige Artikel', 'MAX_RANDOM_SELECT_REVIEWS', 43, 'Wieviele Bewertungen sollen zufÃ¤llig ausgewÃ¤hlt werden?<br/> UnabhÃ¤ngig davon wird immer nur EINE in der Box "Bewertungen" angezeigt.', now(), now()),
('Box "Neue Artikel": zufÃ¤llige Artikel', 'MAX_RANDOM_SELECT_NEW', 43, 'Wieviele neue Artikel sollen in der Box "Neue Artikel" zufÃ¤llig angezeigt werden?', now(), now()),
('Box "Sonderangebot": zufÃ¤llige Artikel', 'MAX_RANDOM_SELECT_SPECIALS', 43, 'Wieviele Sonderangebote sollen in der Box "Sonderangebote" zufÃ¤llig angezeigt werden?', now(), now()),
...
('Box "KÃ¼rzlich bestellte Artikel" HINWEIS: Diese Box ist deaktiviert', 'MAX_DISPLAY_PRODUCTS_IN_ORDER_HISTORY_BOX', 43, 'Wieviele Artikel sollen in der Box "KÃ¼rzlich bestellte Artikel" angezeigt werden?', now(), now()),
...
('Box "Empfohlene Artikel": Anzahl der Artikel', 'MAX_RANDOM_SELECT_FEATURED_PRODUCTS', 43, 'Anzahl der zufÃ¤llig angezeigten empfohlenen Artikel in der Box "Empfohlene Artikel"', now(), now()),
...
('GrÃ¶ÃŸe fÃ¼r Datei-Upload', 'MAX_FILE_UPLOAD_SIZE', 43, 'Wie lautet die maximale GrÃ¶ÃŸe einer Datei, die hochgeladen werden kann?<br />Standard= 2048000 (2MB)', now(), now()),
('Erlaubte Dateierweiterungen fÃ¼r Datei-Upload', 'UPLOAD_FILENAME_EXTENSIONS', 43, 'Durch Komma getrennte Liste von Dateierweiterungen (ohne Punkt) welche fÃ¼r einen Datei-Upload zulÃ¤ssig sind. z.B. jpg,jpeg,gif,png,eps,cdr,ai,pdf,tif,tiff,bmp,zip', now(), now()),
...
('Kleine Bilder: HÃ¶he', 'SMALL_IMAGE_HEIGHT', 43, 'Die HÃ¶he (in Pixel) der kleinen Bilder', now(), now()),
('Ãœberschriftsbild im Adminbereich: Breite', 'HEADING_IMAGE_WIDTH', 43, 'Die Breite (in Pixel) der Bilder in der Ãœberschrift im Adminbereich<br>HINWEIS: Momentan regelt dieser Wert nur die AbstÃ¤nde zwischen den EintrÃ¤gen im Adminbereich. Er kann aber auch dazu benutzt werden, eigene Ãœberschriftsbilder im Adminbereich hinzuzufÃ¼gen', now(), now()),
('Ãœberschriftsbild im Adminbereich: HÃ¶he', 'HEADING_IMAGE_HEIGHT', 43, 'Die HÃ¶he (in Pixel) der Bilder in der Ãœberschrift im Adminbereich<br>HINWEIS: Momentan regelt dieser Wert nur die AbstÃ¤nde zwischen den EintrÃ¤gen im Adminbereich. Er kann aber auch dazu benutzt werden, eigene Ãœberschriftsbilder im Adminbereich hinzuzufÃ¼gen', now(), now()),
('Unterkategorien: Breite der Bilder', 'SUBCATEGORY_IMAGE_WIDTH', 43, 'Die Breite (in Pixel) der Bilder fÃ¼r die Unterkategorien', now(), now()),
('Unterkategorien: HÃ¶he der Bilder', 'SUBCATEGORY_IMAGE_HEIGHT', 43, 'Die HÃ¶he (in Pixel) der Bilder fÃ¼r die Unterkategorien', now(), now()),
('BildGrÃ¶ÃŸe berechnen', 'CONFIG_CALCULATE_IMAGE_SIZE', 43, 'Soll die GrÃ¶ÃŸe der Bilder berechnet werden?', now(), now()),
('Platzhalter fÃ¼r fehlende Bilder anzeigen', 'IMAGE_REQUIRED', 43, 'Sollen fehlende Bilder "angezeigt" werden? (Hilfreich in der Entwicklungsphase)', now(), now()),
...
('Warenkorb: HÃ¶he der Artikelbilder', 'IMAGE_SHOPPING_CART_HEIGHT', 43, 'Standard = 40', now(), now()),
('Kategorie: Bildbreite - Artikeldetails', 'CATEGORY_ICON_IMAGE_WIDTH', 43, 'Breite in Pixel fÃ¼r das Kategoriebild auf der Artikeldetailseite', now(), now()),
('Kategorie: BildHÃ¶he - Artikeldetails', 'CATEGORY_ICON_IMAGE_HEIGHT', 43, 'HÃ¶he in Pixel fÃ¼r das Kategoriebild auf der Artikeldetailseite', now(), now()),
('Bild Kategorie mit Unterkategorien: Bildbreite', 'SUBCATEGORY_IMAGE_TOP_WIDTH', 43, 'Die Breite in Pixel<br />Dieses Bild wird beim Klicken auf eine Kategorie oben angezeigt, wenn diese Unterkategorien enthÃ¤lt', now(), now()),
('Bild Kategorie mit Unterkategorien: BildHÃ¶he', 'SUBCATEGORY_IMAGE_TOP_HEIGHT', 43, 'Die HÃ¶he in Pixel<br />Dieses Bild wird beim Klicken auf eine Kategorie oben angezeigt, wenn diese Unterkategorien enthÃ¤lt', now(), now()),
...
('Artikelbeschreibung: HÃ¶he der Artikelbilder', 'MEDIUM_IMAGE_HEIGHT', 43, 'Die HÃ¶he (in Pixel) der Artikelbilder in der Produktbeschreibung', now(), now()),
('Artikelbeschreibung: Suffix der Bildmedien', 'IMAGE_SUFFIX_MEDIUM', 43, 'Dateizusatz fÃ¼r Bildmedien der zusÃ¤tzlichen Bilder in der Artikelbeschreibung<br />Standard = _MED', now(), now()),
('Artikelbeschreibung: Suffix der Bildmedien fÃ¼r GrÃ¶ÃŸere Bilder', 'IMAGE_SUFFIX_LARGE', 43, 'Dateizusatz fÃ¼r Bildmedien der grÃ¶ÃŸeren Bilder in der Artikelbeschreibung<br />Standard = _LRG', now(), now()),
('Artikelbeschreibung: Anzahl der zusÃ¤tzlichen Bilder pro Reihe', 'IMAGES_AUTO_ADDED', 43, 'Tragen Sie hier die Anzahl der pro Reihe anzuzeigenden zusÃ¤tzlichen Bilder ein<br />Standard = 3', now(), now()),
('Artikelliste: HÃ¶he der Artikelbilder', 'IMAGE_PRODUCT_LISTING_HEIGHT', 43, 'Standard = 80', now(), now()),
...
('Liste "Neue Artikel": HÃ¶he der Artikelbilder in der Liste', 'IMAGE_PRODUCT_NEW_LISTING_HEIGHT', 43, 'Standard = 80', now(), now()),
('Neue Artikel: Breite der Artikelbilder', 'IMAGE_PRODUCT_NEW_WIDTH', 43, 'Standard = 100', now(), now()),
('Neue Artikel: HÃ¶he der Artikelbilder', 'IMAGE_PRODUCT_NEW_HEIGHT', 43, 'Standard = 80', now(), now()),
('Liste "Empfohlene Artikel": Breite der Artikelbilder', 'IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH', 43, 'Standard = 100', now(), now()),
('Liste "Empfohlene Artikel": HÃ¶he der Artikelbilder', 'IMAGE_FEATURED_PRODUCTS_LISTING_HEIGHT', 43, 'Standard = 80', now(), now()),
('Liste "Alle Artikel": Breite der Artikelbilder', 'IMAGE_PRODUCT_ALL_LISTING_WIDTH', 43, 'Standard = 100', now(), now()),
('Liste "Alle Artikel": HÃ¶he der Artikelbilder', 'IMAGE_PRODUCT_ALL_LISTING_HEIGHT', 43, 'Standard = 80', now(), now()),
('Artikelbild: Status automatisch auf "kein Bild vorhanden"', 'PRODUCTS_IMAGE_NO_IMAGE_STATUS', 43, 'Soll der Status bei Artikelbildern automatisch auf "kein Bild vorhanden" gesetzt werden, wenn kein Bild dem Artikel hinzugefÃ¼gt wurde? <br />0= nein<br />1= ja', now(), now()),
('Artikelbild: "Kein Bild vorhanden" Bild', 'PRODUCTS_IMAGE_NO_IMAGE', 43, 'Welches Bild soll als Eratzbild verwendet werden, wenn kein Bild dem Artikel hinzugefÃ¼gt wurde?<br />Standard = no_picture.gif', now(), now()),
('Proportionale Bilder fÃ¼r Artikel & Kategorien verwenden', 'PROPORTIONAL_IMAGES_STATUS', 43, 'Artikel und Kategoriebilder werden proportional verkleinert, falls die vorgegebenen Werte fÃ¼r HÃ¶he / Breite Ã¼berschritten werden. Anmerkung: Nicht verwenden wenn fÃ¼r HÃ¶he  bzw. Breite 0 verwendet wird.', now(), now()),
# Image Handler new since 1.5.3
('IH - BildgrÃ¶ÃŸe Ã¤ndern und Caching verwenden', 'IH_RESIZE', 43, 'Entweder ''No'' fÃ¼r normales Zen-Cart Verhalten oder ''Yes'' um die automatische grÃ¶ÃŸenÃ¤nderung und das Caching von Bildern zu aktivieren. Wenn Sie ImageMagick verwenden wollen, mÃ¼ssen Sie den Pfad zur convert binary in <em>includes/extra_configures/bmz_image_handler_conf.php</em> angeben.', now(), now()),
('IH - Kleine Bilder - Dateityp', 'SMALL_IMAGE_FILETYPE', 43, 'WÃ¤hlen Sie ''jpg'', ''gif'' oder ''png''. Internet Explorer hat noch immer Probleme transparente png darzustellen. Nehmen Sie besser ''gif'' fÃ¼r die Transparenz oder ''jpg'' fÃ¼r GrÃ¶ÃŸere Bilder. ''no_change'' bedeutet normales Zen-Cart Verhalten. Es wird derselbe Dateityp fÃ¼r kleine Bilder wie fÃ¼r hochgeladene Bilder verwendet.', now(), now()),
...
('IH - Kleine Bilder - QualitÃ¤t', 'SMALL_IMAGE_QUALITY', 43, 'Geben Sie die gewÃ¼nschte QualitÃ¤t fÃ¼r die kleinen jpg Bilder an. Dezimalwerte von 0 bis 100. Je HÃ¶her desto bessere QualitÃ¤t und desto HÃ¶here DateigrC6CFCB8e. Voreingestellt ist 85.', now(), now()),
...
('IH - Kleine Bilder - Zoom', 'ZOOM_SMALL_IMAGES', 43, 'Stellen Sie auf ''yes'', falls Sie den Zoom-Effekt bei Mouseover fÃ¼r die kleinen Bilder aktivieren wollen.', now(), now()),
('IH - Kleine Bilder - BildgrÃ¶ÃŸe bei Hover', 'ZOOM_IMAGE_SIZE', 43, 'Stellen Sie auf Medium wenn Sie beim Hover die grÃ¶ÃŸe der mittleren Bilder haben wollen und auf Large, wenn Sie die GrÃ¶ÃŸe der grossen Bilder verwenden wollen.', now(), now()),
('IH - Mittlere Bilder - Dateityp', 'MEDIUM_IMAGE_FILETYPE', 43, 'WÃ¤hlen Sie ''jpg'', ''gif'' oder ''png''. Der Internet Explorer stellt transparente png-Dateien noch immer nicht korrekt dar. Bei transparenten Bildern verwenden Sie daher besser ''gif'' oder ''jpg'' fÃ¼r grosse Bilder. ''no_change'' bedeutet normales Zen-Cart-Verhalten und fÃ¼r die mittleren Bilder wird derselbe Dateityp wie bei den hochgeladenen Bildern verwendet.', now(), now()),
...
('IH - Mittlere Bilder - QualitÃ¤t', 'MEDIUM_IMAGE_QUALITY', 43, 'Geben Sie die gewÃ¼nschte QualitÃ¤t fÃ¼r die kleinen jpg Bilder an. Dezimalwerte von 0 bis 100. Je HÃ¶her desto bessere QualitÃ¤t und desto HÃ¶here DateigrÃ¶ÃŸe. Voreingestellt ist 85.', now(), now()),
...
('IH - Grosse Bilder - Dateityp', 'LARGE_IMAGE_FILETYPE', 43, 'WÃ¤hlen Sie ''jpg'', ''gif'' oder ''png''. Der Internet Explorer stellt transparente png-Dateien noch immer nicht korrekt dar. Bei transparenten Bildern verwenden Sie daher besser ''gif'' oder ''jpg'' fÃ¼r grosse Bilder. ''no_change'' bedeutet normales Zen-Cart-Verhalten und fÃ¼r die grossen Bilder wird derselbe Dateityp wie bei den hochgeladenen Bildern verwendet.', now(), now()),
...
('IH - Grosse Bilder - QualitÃ¤t', 'LARGE_IMAGE_QUALITY', 43, 'Geben Sie die gewÃ¼nschte BildqualitÃ¤t fÃ¼r grosse jpg Bilder an. Verwenden Sie Zehnerschritte von 0 bis 100. HÃ¶here Werte bedeuten mehr QualitÃ¤t und mehr DateigrÃ¶ÃŸe und damit Speicherplatz. Voreingestellt ist 85, was ein guter Wert ist, ausser Sie haben besondere WÃ¼nsche.', now(), now()),
...
('IH - Grosse Bilder - Maximale Breite', 'LARGE_IMAGE_MAX_WIDTH', 43, 'Geben Sie eine maximale Breite fÃ¼r Ihre grossen Bilder an. Wenn Breite und HÃ¶he leer gelassen oder auf 0 gesetzt werden, werden die grossen Bilder in ihrer grÃ¶ÃŸe nicht verÃ¤ndert.', now(), now()),
('IH - Wasserzeichen - Position', 'WATERMARK_GRAVITY', 43, 'WÃ¤hlen Sie die Position fÃ¼r das Wasserzeichen. Voreingestellt ist <strong>Center (Zentriert)</strong>.', now(), now()),
('IH - Grosse Bilder - Maximale HÃ¶he', 'LARGE_IMAGE_MAX_HEIGHT', 43, 'Geben Sie eine maximale HÃ¶he fÃ¼r Ihre grossen Bilder an. Wenn Breite und HÃ¶he leer gelassen oder auf 0 gesetzt werden, werden die grossen Bilder in ihrer grÃ¶ÃŸe nicht verÃ¤ndert.', now(), now()),
...
('BundeslÃ¤nderliste - als PulldownmenÃ¼ anzeigen?', 'ACCOUNT_STATE_DRAW_INITIAL_DROPDOWN', 43, 'Soll die Eingabe des Bundeslandes durch eine Auswahlliste dargestellt werden?', now(), now()),
...
('Checkbox fÃ¼r Newsletter anzeigen', 'ACCOUNT_NEWSLETTER_STATUS', 43, 'Soll die Checkbox fÃ¼r Newsletter angezeigt werden?<br />0= nein<br />1= unmarkiert anzeigen<br />2= markiert anzeigen<br /><strong>HINWEIS: In einigen LÃ¤ndern steht die Standardanzeige auf "markiert" im Konflikt mit den gesetzlichen Bestimmungen</strong>', now(), now()),
('E-Mail an Kunden im HTML Format senden', 'ACCOUNT_EMAIL_PREFERENCE', 43, 'Standard Einstellung fÃ¼r E-Mails an Kunden<br/>0=Text<br/>1=HTML', now(), now()),
('Artikelbenachrichtigung nach Bestellung abfragen', 'CUSTOMERS_PRODUCTS_NOTIFICATION_STATUS', 43, 'Sollen Kunden nach ihrer Bestellung Ã¼ber Artikelbenachrichtigungen gefragt werden?<br />0= nie nachfragen<br />1= Immer nachfragen, auCer wenn die Abfrage Global gesetzt wurde<br /><br />HINWEIS: Die Sidebox muss separat ausgeschaltet werden', now(), now()),
('Kunden Shopstatus - Ansicht Shop und Preise', 'CUSTOMERS_APPROVAL', 43, 'benÃ¶tigen Kunden eine Berechtigung, um im Shop einkaufen zu kC6nnen?<br />0= Nein - normaler Shop<br />1= Artikelansicht erst nach Anmeldung<br />2= Artikelansicht ohne Preise, Preise werden erst nach Anmeldung sichtbar<br />3= Nur Showroom (Generell keine Preise sichtbar)<br /><br />Die Option 2 ist empfohlen, wenn Kunden Preise erst nach Anmeldung sehen sollen, aber der Zugriff fÃ¼r Webcrawler zugelassen werden soll.', now(), now()),
('Kunden Freigabestatus -  auf Freigabe warten', 'CUSTOMERS_APPROVAL_AUTHORIZATION', 43, 'benÃ¶tigen Kunden eine gesonderte Freigabe, um im Shop einkaufen zu kC6nnen?<br />0= Nein (normaler Shop)<br />1= Artikelansicht erst nach Freigabe<br />2= Artikelansicht ohne Preise, Preise werden erst nach Freigabe sichtbar<br />3= Artikelansicht mit Preise, einkaufen erst nach Freigabe<br /><br />Die Option 2 oder 3 ist empfohlen, wenn der Zugriff fÃ¼r Webcrawler zugelassen werden soll.', now(), now()),
...
('Kunden Autorisierung: Ãœberschrift ausblenden', 'CUSTOMERS_AUTHORIZATION_HEADER_OFF', 43, 'Kunden Autorisierung: Ãœberschrift ausblenden <br />(true= ausblenden<br />false= anzeigen)', now(), now()),
...
('Kunden Autorisierung: FuÃŸzeile ausblenden', 'CUSTOMERS_AUTHORIZATION_FOOTER_OFF', 43, 'Kunden Autorisierung: FuÃŸzeile ausblenden<br />(true= ausblenden<br />false= anzeigen)', now(), now()),
...
('Kundenempfehlung', 'CUSTOMERS_REFERRAL_STATUS', 43, 'Kunden Referer - Status<br /><br />0= AUS - Kundenempfehlung deaktiviert<br />1= Durch die erste Verwendung eines Aktionskupons<br />2= Kunde kann wÃ¤hrend der Erstellung des Kundenkontos die Empfehlung eintragen, falls diese leer ist<br /><br />HINWEIS: Wurde die Kundenempfehlung einmal erstellt, kann diese nur noch im Adminbereich geÃ¤ndert werden', now(), now()),

# AdminmenÃ¼ ID 6 - Wird nicht im Adminbereich angezeigt, dient meist fÃ¼r die Module
...
('BearbeitungsGebÃ¼hr', 'MODULE_SHIPPING_FREESHIPPER_HANDLING', 43, 'BearbeitungsGebÃ¼hr fÃ¼r diese Versandart:', now(), now()),
...
('Versandzone', 'MODULE_SHIPPING_FREESHIPPER_ZONE', 43, 'fÃ¼r welche LÃ¤nder soll diese Versandart angeboten werden?<br/>Die auswÃ¤hlbaren Versandzonen entsprechen den angelegten Steuerzonen und den dort hinterlegten LÃ¤ndern.', now(), now()),
...
('Orte fÃ¼r die Abholung', 'MODULE_SHIPPING_STOREPICKUP_LOCATIONS_LIST', 43, 'Hier kC6nnen Sie verschiedene Orte fÃ¼r die Selbstabholung eintragen. Trennen Sie die Orte mit einem Strichpunkt (Semikolon).<br/>Optional kC6nnen Sie je nach Abholort auch eine GebÃ¼hr verrechnen. Wird keine spezielle GebÃ¼hr definiert, dann gelten die normalen Kosten aus der nÃ¤cjsten Einstellung.<br/><br/>Hier einige Beispiele:<br/><br/>Demogasse 17 - 1010 Wien;Beispielweg 15 - 8020 Graz<br/>Demogasse 17 - 1010 Wien,4.00;Beispielweg 15 - 8020 Graz,5.00<br/>Demogasse 17 - 1010 Wien,4.00;Beispielweg 15 - 8020 Graz,0.00<br/><br/>Wenn Sie in Ihrem Shop mehrere Sprachen aktiv haben und diese Ortsangaben je nach Sprache anders angeben wollen, dann beachten Sie bitte die Hinweise in der entsprechenden Sprachdatei (z.B. includes/languages/german/modules/shipping/storepickup.php)<br/>', now(), now()),
...
('Basis der Steuern', 'MODULE_SHIPPING_STOREPICKUP_TAX_BASIS', 43, 'Auf welcher Basis sollen Steuern berechnet werden? MC6gliche Optionen:<br />Versand (Shipping) - auf Basis der Versandadresse des Kunden<br />Rechnung (Billing) - auf Basis der Rechnungsadresse des Kunden<br />Shop (Store) - auf Basis der Shopadresse, wenn die Rechnungs-/Versandadresse des Kunden innerhalb der Zone der Shopadresse liegt', now(), now()),
('Versandzone', 'MODULE_SHIPPING_STOREPICKUP_ZONE', 43, 'fÃ¼r welche LÃ¤nder soll diese Versandart angeboten werden?<br/>Die auswÃ¤hlbaren Versandzonen entsprechen den angelegten Steuerzonen und den dort hinterlegten LÃ¤ndern.', now(), now()),
('Sortierung', 'MODULE_SHIPPING_STOREPICKUP_SORT_ORDER', 43, 'Bestimmt die Sortierung der angezeigten Versandarten.', now(), now()),
('Versandkosten pro stÃ¼ck aktivieren', 'MODULE_SHIPPING_ITEM_STATUS', 43, 'Bieten Sie die Versandart Versandkosten pro stÃ¼ck an?', now(), now()),
...
('BearbeitungsGebÃ¼hr', 'MODULE_SHIPPING_ITEM_HANDLING', 43, 'BearbeitungsGebÃ¼hr fÃ¼r diese Versandart:', now(), now()),
...
('Versandzone', 'MODULE_SHIPPING_ITEM_ZONE', 43, 'fÃ¼r welche LÃ¤nder soll diese Versandart angeboten werden?<br/>Die auswÃ¤hlbaren Versandzonen entsprechen den angelegten Steuerzonen und den dort hinterlegten LÃ¤ndern.', now(), now()),
...
('Zahlungszone', 'MODULE_PAYMENT_FREECHARGER_ZONE', 43, 'fÃ¼r welche LÃ¤nder soll diese Zahlungsart angeboten werden?<br/>Die auswÃ¤hlbaren Zahlungszonen entsprechen den angelegten Steuerzonen und den dort hinterlegten LÃ¤ndern.', now(), now()),
('Bestellstatus', 'MODULE_PAYMENT_FREECHARGER_ORDER_STATUS_ID', 43, 'Legt den Bestellstatus fÃ¼r diese Zahlungsart fest.', now(), now()),
('Vorkasse/Ãœberweisung aktivieren', 'MODULE_PAYMENT_EUTRANSFER_STATUS', 43, 'Akzeptieren Sie Zahlungen per Vorkasse/Cberrweisung?', now(), now()),
...
('Sortierung', 'MODULE_PAYMENT_EUTRANSFER_SORT_ORDER', 43, 'Anzeigereigenfolge fÃ¼r dieses Modul. Der niedrigste Wert wird zuerst angezeigt.', now(), now()),
('Zahlungszone', 'MODULE_PAYMENT_EUTRANSFER_ZONE', 43, 'Wenn Sie hier eine Zone angeben, ist BankÃ¼berweisung nur fÃ¼r Kunden mit Rechnungsadresse in dieser Zone mC6glich. Es empfiehlt sich dafÃ¼r eine Zone anzulegen, die nur die LÃ¤nder mit EURO enthÃ¤lt.', now(), now()),
('Bestellstatus', 'MODULE_PAYMENT_EUTRANSFER_ORDER_STATUS_ID', 43, 'Welchen Bestellstatus sollen Bestellungen bekommen, die mit BankÃ¼berweisung bezahlt werden?', now(), now()),
('LÃ¤nder', 'MODULE_PAYMENT_EUTRANSFER_COUNTRIES', 43, 'Geben Sie hier die LÃ¤nder an, fÃ¼r die BankÃ¼berweisung mC6glich sein soll. Es empfiehlt sich hier nur LÃ¤nder einzutragen, die den EURO haben, so dass eine EU-StandardÃ¼berweisung mC6glich ist. Zweistellige ISO-Codes durch Komma getrennt!', now(), now()),
('Inklusive MwSt.', 'MODULE_ORDER_TOTAL_GROUP_PRICING_INC_TAX', 43, 'Der Rabattbetrag enthÃ¤lt die MwSt.', now(), now()),
('GruppenermÃ¤ÃŸigung aktivieren', 'MODULE_ORDER_TOTAL_GROUP_PRICING_STATUS', 43, 'Bieten Sie eine ErmÃ¤ÃŸigung fÃ¼r bestimmte Kundengruppen an?', now(), now()),
('Sortierung', 'MODULE_ORDER_TOTAL_GROUP_PRICING_SORT_ORDER', 43, 'Bestimmt die Sortierung in der Bestellzusammenfassung', now(), now()),
('Inklusive Versandkosten', 'MODULE_ORDER_TOTAL_GROUP_PRICING_INC_SHIPPING', 43, 'Die GruppenermÃ¤ÃŸigung wird auf den Rechnungsbeitrag inkl. der Versandkosten gewÃ¤hrt?', now(), now()),
('MwSt. Betrag neu berechnen', 'MODULE_ORDER_TOTAL_GROUP_PRICING_CALC_TAX', 43, 'Soll der MwSt. Betrag neu berechnet werden?<br/> Dieses ist nur notwendig, wenn die GruppenErmÃ¤ÃŸigung inkl. MwSt. angezeigt werden soll', now(), now()),
...
('Einheitliche Versandkosten', 'MODULE_SHIPPING_FLAT_COST', 43, 'Die Versandkosten fÃ¼r alle Bestellungen, die mit dieser Versandmethode getÃ¤tigt werden.', now(), now()),
('Steuerklasse', 'MODULE_SHIPPING_FLAT_TAX_CLASS', 43, 'Folgende Steuerklasse fÃ¼r diese Versandmethode verwenden:', now(), now()),
('Basis der Steuern', 'MODULE_SHIPPING_FLAT_TAX_BASIS', 43, 'Auf welcher Basis sollen Steuern berechnet werden? MC6gliche Optionen:<br />Versand (Shipping) - auf Basis der Versandadresse des Kunden<br />Rechnung (Billing) - auf Basis der Rechnungsadresse des Kunden<br />Shop (Store) - auf Basis der Shopadresse, wenn die Rechnungs-/Versandadresse des Kunden innerhalb der Zone der Shopadresse liegt', now(), now()),
('Versandzone', 'MODULE_SHIPPING_FLAT_ZONE', 43, 'Wenn eine Zone ausgewÃ¤hlt wird, ist diese Versandmethode nur fÃ¼r diese Zone aktiviert.', now(), now()),
...
('StandardwÃ¤hrung', 'DEFAULT_CURRENCY', 43, 'StandardwÃ¤hrung', now(), now()),
('Standardsprache', 'DEFAULT_LANGUAGE', 43, 'Standardsprache', now(), now()),
('Bestellstatus fÃ¼r neue Bestellungen', 'DEFAULT_ORDERS_STATUS_ID', 43, 'Wenn eine neue Bestellung getÃ¤tigt wird, ist dies der Status dem sie zugewiesen wird.', now(), now()),
...
# AdminmenÃ¼ ID 7
('Ursprungsland', 'SHIPPING_ORIGIN_COUNTRY', 43, 'WÃ¤hlen Sie das Land, von dem aus die Versandkosten berechnet werden sollen.', now(), now()),
...
('Maximales Versandgewicht', 'SHIPPING_MAX_WEIGHT', 43, 'Paketdienste haben im Allgemeinen eine Grenze fÃ¼r das Maximagewicht eines Paketes.<br />Tragen Sie dieses Gewicht stellvertretend fÃ¼r alle ein.', now(), now()),
...
('GrÃ¶ÃŸere Pakete: prozentuelle Gewichtszunahme', 'SHIPPING_BOX_PADDING', 43, 'Wie hoch ist die Zunahme des Gewichtes bei einem typischen grÃ¶ÃŸeren Paket?<br />Beispiel: 10% + 1kg 10:1<br />10% + 0kg 10:0<br />0% + 5kg 0:5<br />0% + 0kg 0:0', now(), now()),
...
('Einstellungen fÃ¼r Versandberechnung im Warenkorb anzeigen', 'SHOW_SHIPPING_ESTIMATOR_BUTTON', 43, '<br />0= AUS<br />1= Als Button im Warenkorb zeigen<br />2= Die voraussichtlichen Versandkosten werden unterhalb des Warenkorb angezeigt. Als Basis fÃ¼r die Berechnung wird die Hauptadresse des Kunden genommen.', now(), now()),
...
('ArtikelstÃ¼ckzahl anzeigen', 'PRODUCT_LIST_QUANTITY', 43, 'Wollen Sie die vorhandene ArtikelstÃ¼ckzahl in der Artikelliste anzeigen?<br>0= wird nicht angezeigt, 1-7 Spaltennummer in der die VerfÃ¼gbare ArtikelstÃ¼ckzahl angezeigt wird', now(), now()),
...
('Kategorien-/Herstellerfilter anzeigen (0=nein; 1=ja)', 'PRODUCT_LIST_FILTER', 43, 'Wollen Sie den Filter fÃ¼r Kategorien-/Hersteller im Shop anzeigen?', now(), now()),
('"Vorheriger/NÃ¤chster" Navigation: Ansicht', 'PREV_NEXT_BAR_LOCATION', 43, 'Wo soll die "Vorheriger / NÃ¤chster" Navigation angezeigt werden?<br />(1= oben, 2= unten, 3= oben und unten)', now(), now()),
('Standardsortierung', 'PRODUCT_LISTING_DEFAULT_SORT_ORDER', 43, 'Standard Sortierung fÃ¼r Artikellisten<br />HINWEIS: fÃ¼r eine Sortierung nach Artikel bitte leer lassen.<br />Sortiert die Artikelliste in der gewÃ¼nschten Reihenfolge mit der Sie beginnen mC6chten.<br>Wenn Sie z.B. nach Artikelnummer sortieren wollen, geben Sie die Nummer ein, die Sie oben bei Artikelnummer vergeben haben. Direkt dahinter geben Sie ein a fÃ¼r aufsteigende Sortierung oder ein d fÃ¼r absteigende Sortierung ein', now(), now()),
('Button "In den Warenkorb" anzeigen (0=nein; 1=ja; 2=Ja mit stÃ¼ckzahlfeld pro Artikel)', 'PRODUCT_LIST_PRICE_BUY_NOW', 43, 'Wollen Sie den Button "In den Warenkorb" anzeigen?<br /><br /><strong>HINWEIS:</strong> Um die pro Artikel ein stÃ¼ckzahlfeld angezeigt zu bekommen (Auswahl 2), setzen Sie bitte die Einstellung "Button "AusgewÃ¤hlte Artikel in den Warenkorb" anzeigen" auf 0', now(), now()),
('Button "AusgewÃ¤hlte Artikel in den Warenkorb" anzeigen', 'PRODUCT_LISTING_MULTIPLE_ADD_TO_CART', 43, 'Eingabefelder und SchaltflÃ¤che anzeigen, um mehrere ausgewÃ¤hlte Artikel mit einem Klick in den Warenkorb zu Ã¼bernehmen?<br/><br/>0= NEIN<br/>1= Oben<br/>2= Unten<br/>3= Oben und Unten', now(), now()),
...
('Zeichen fÃ¼r absteigende Sortierung', 'PRODUCT_LIST_SORT_ORDER_DESCENDING', 43, 'Welches Zeichen soll eine ansteigende Sortierung anzeigen?<br />Default = -', now(), now()),
('Zeichen fÃ¼r aufsteigende Sortierung', 'PRODUCT_LIST_SORT_ORDER_ASCENDING', 43, 'Welches Zeichen soll eine aufsteigende Sortierung anzeigen?<br />Default = +', now(), now()),
('Artikelfilter fÃ¼r Artikelnamen nach Alphabet anzeigen', 'PRODUCT_LIST_ALPHA_SORTER', 43, 'Soll der Filter fÃ¼r Artikel nach Alphabet in der Artikelliste angezeigt werden?', now(), now()),
('Bild fÃ¼r Unterkategorien anzeigen', 'PRODUCT_LIST_CATEGORIES_IMAGE_STATUS', 43, 'Wollen Sie die Bilder der Unterkategorien in der Artikelliste anzeigen?', now(), now()),
('Bild fÃ¼r ausgewÃ¤hlte Kategorie anzeigen', 'PRODUCT_LIST_CATEGORIES_IMAGE_STATUS_TOP', 43, 'Wollen Sie das Bild fÃ¼r die aktuell ausgewÃ¤hlte Kategorie oben in der Artikelliste anzeigen?', now(), now()),
...
('Artikelliste - Layout Stil', 'PRODUCT_LISTING_LAYOUT_STYLE', 43, 'WÃ¤hlen Sie das Layout Ihrer Artikelliste:<br/>Jeder Artikel kann in einer eigenen Zeile angezeigt werden (rows) oder die Artikel kC6nnen nebeneinander in mehreren Spalten pro Reihe angezeigt werden (columns)', now(), now()),
...
# AdminmenÃ¼ ID 9
('Lagerbestand prÃ¼fen', 'STOCK_CHECK', 43, 'ÃœberprÃ¼fen, ob der bestellte Artikel auch lagernd ist', now(), now()),
...
('Bestellung erlauben, wenn Lagerbestand unterschritten wird', 'STOCK_ALLOW_CHECKOUT', 43, 'Soll Kunden bei Unterschreitung des Lagerbestandes eine Bestellung ermC6glicht werden?', now(), now()),
('Markierung fÃ¼r nicht lagernde Artikel', 'STOCK_MARK_PRODUCT_OUT_OF_STOCK', 43, 'Nicht lagernde Artikel werden bei der Bestellung markiert mit diesen Zeichen markiert<br>Standard: ***', now(), now()),
('Lagermindestbestand fÃ¼r Nachbestellungen', 'STOCK_REORDER_LEVEL', 43, 'Legen Sie hier fest, ab welcher Lagermenge ein Artikel nachbestellt werden muss<br>HINWEIS: Diese Einstellung gilt fÃ¼r alle Artikel, es kann keine Unterscheidung pro Artikel vorgenommen werden.', now(), now()),
...
('Artikel ist ausverkauft: Bild "Ausverkauft" anstelle von "in den Warenkorb" anzeigen', 'SHOW_PRODUCTS_SOLD_OUT_IMAGE', 43, 'Zeige fÃ¼r ausverkaufte Artikel das Bild "Ausverkauft" anstelle von "in den Warenkorb"<br /><br />0= nein<br />1= ja', now(), now()),
('Dezimalstellen der ArtikelstÃ¼ckzahlen', 'QUANTITY_DECIMALS', 43, 'Wieviele Dezimalstellen sollen in der ArtikelstÃ¼ckzahl angezeigt werden?<br /><br />0= keine', now(), now()),
('Warenkorb: Checkboxen und/oder Buttons zum LÃ¶schen anzeigen', 'SHOW_SHOPPING_CART_DELETE', 43, 'Zeigt im Warenkorb Buttons und/oder Checkboxen zum LÃ¶schen von Artikel an<br /><br />1= Nur Buttons<br />2= Nur Checkboxen<br />3= Buttons und Checkboxen', now(), now()),
('Warenkorb: Aktualisieren SchaltflÃ¤che anzeigen', 'SHOW_SHOPPING_CART_UPDATE', 43, 'Wo soll die Aktualisieren SchaltflÃ¤che im Warenkorb angezeigt werden?<br/><br/>1= Neben jedem Mengeneingabefeld<br/>2= Einmal unterhalb des Warenkorbes<br/>3= Neben jedem Mengeneingabefeld und unterhalb des Warenkorbes', now(), now()),
...
('Leerer Warenkorb: "ArtikelankÃ¼ndigungen" anzeigen', 'SHOW_SHOPPING_CART_EMPTY_UPCOMING', 43, 'Sollen "ArtikelankÃ¼ndigungen" in der Ansicht "leerer Warenkorb" angezeigt werden?<br />0= Nein (oder Sortierung einstellen)', now(), now()),
('Zeige Hinweis beim Login Ã¼ber den zusammengelegten Warenkorb an', 'SHOW_SHOPPING_CART_COMBINED', 43, 'Sobald ein Kunde sich anmeldet und von der letzten Anmeldung noch Artikel im Warenkorb hat, werden die aktuell im Warenkorb vorhandenen Artikel mit dem Warenkorb der letzten Anmeldung kombiniert.<br /><br />Soll der Kunde auf diesen Vorgang hingewiesen werden?<br /><br />0= NEIN, zeige keinen Hinweis an<br />1= JA, und gehe automatisch zum Warenkorb<br />2= JA, aber gehe nicht automatisch zum Warenkorb', now(), now()),

# AdminmenÃ¼ ID 10
('Speichern der Zeit fÃ¼r Seitenaufbau', 'STORE_PAGE_PARSE_TIME', 43, 'Sollen die Zeiten fÃ¼r den Seitenaufbau einer Seite gespeichert werden?', now(), now()),
('Protokolldatei fÃ¼r Seitenaufbau: Speicherort', 'STORE_PAGE_PARSE_TIME_LOG', 43, 'Verzeichnis und Dateiname der Protokolldatei fÃ¼r Seitenaufbau', now(), now()),
('Protokolldatei fÃ¼r Seitenaufbau: Datumsformat', 'STORE_PARSE_DATE_TIME_FORMAT', 43, 'Datumsformat fÃ¼r die Protokolldatei', now(), now()),
('Zeit fÃ¼r Seitenaufbau im Shop anzeigen', 'DISPLAY_PAGE_PARSE_TIME', 43, 'Soll die Zeit fÃ¼r den Seitenaufbau im Shop unten angezeigt werden?<br />HINWEIS: Es ist nicht notwendig, die Protokolldatei fÃ¼r Seitenaufbau zu speichern, um sie im Shop anzeigen zu lassen.', now(), now()),
('Datenbankabfragen in Protokolldatei speichern', 'STORE_DB_TRANSACTIONS', 43, 'Sollen Datenbankabfragen in der Protokolldatei fÃ¼r Seitenabfragen gespeichert werden?<br />VORSICHT: Das Aktivieren dieser Einstellung kann Ihren Shop stark verlangsamen und unzÃ¤hlige Logfiles reduzieren Ihren Speicherplatz auf Ihrem Server! Nur fÃ¼r Troubleshooting aktivieren!', now(), now()),

# AdminmenÃ¼ ID 12
('E-Mail Transportmethode', 'EMAIL_TRANSPORT', 43, 'Legt fest, ob dieser Server eine lokale Verbindung zu ''sendmail'' oder einen SMTP - Server Ã¼ber TCP/IP Verbindung verwendet.<br />HINWEIS: fÃ¼r Server, die unter Windows oder MacOS betrieben werden, sollten Sie die Einstellung ''SMTP'' verwenden.', now(), now()),
('SMTP E-Mail - Mailbox Benutzer', 'EMAIL_SMTPAUTH_MAILBOX', 43, 'Wenn Sie fÃ¼r den Versand von E-Mails SMTP Authentifizierung verwenden mÃ¼ssen, dann geben Sie hier den Namen Ihres SMTP Benutzerkontos ein z.B. ich@domain.com ', now(), now()),
('SMTP E-Mail - Mailbox Passwort', 'EMAIL_SMTPAUTH_PASSWORD', 43, 'Passwort fÃ¼ SMTP Authentifizierung', now(), now()),
('SMTP E-Mail - Mailserver Name', 'EMAIL_SMTPAUTH_MAIL_SERVER', 43, 'SMTP Mailserver fÃ¼r Authentifizierung z.B. smtp.domain.com', now(), now()),
('SMTP E-Mail - Mailserver Port', 'EMAIL_SMTPAUTH_MAIL_SERVER_PORT', 43, 'SMTP Mailserver Port', now(), now()),
('WÃ¤hrungssymbole fÃ¼r Text-Emails', 'CURRENCIES_TRANSLATIONS', 43, 'Welche WÃ¤hrungssymbole sollen fÃ¼r Text-Emails konvertiert werden?<br />Default = &pound;,CB#:&euro;,C"b B,:&reg;,CB.:&trade;,C"b B"', now(), now()),
...
('E-Mail als MIME HTML versenden', 'EMAIL_USE_HTML', 43, 'Wollen Sie e-Mails im HTML Format versenden falls der EmpÃ¤nger in seinen Einstellungen HTML statt Text angekreuzt hat?<br/>HINWEIS: Dies ist der generelle Hauptschalter. Wenn Sie hier auf false stellen, dann wird der Shop keinerlei HTML Emails versenden.', now(), now()),
('E-Mail durch DNS-Server verifizieren', 'ENTRY_EMAIL_ADDRESS_CHECK', 43, 'Soll die GÃ¼ltigkeit von e-Mails durch DNS-Server verifiziert werden?', now(), now()),
...
('E-Mail Fehlermeldungen', 'EMAIL_FRIENDLY_ERRORS', 43, 'Gibt lesbare Fehlermeldungen aus falls der E-Mail Versand scheitert (true). Bei (false) werden auch PHP Fehler angezeigt . Diese Einstellung ist nur fÃ¼r die Fehlersuche gedacht!', now(), now()),
...
('E-Mail Absenderdomain verwenden?', 'EMAIL_SEND_MUST_BE_STORE', 43, 'Alle vom Mailserver verschickten E-Mails mÃ¼ssen eine Absenderadresse "FROM" haben?<br /><br />Dies wird oft verwendet um das verschicken von SPAM mails zu verhindern. Bei JA wird der Wert der Einstellung "E-Mail Absender" als "FROM" Adresse fÃ¼r alle ausgehenden Mails verwendet.', now(), now()),
('E-Mail an Admin: Format', 'ADMIN_EXTRA_EMAIL_FORMAT', 43, 'WÃ¤hlen Sie das Format fÃ¼r e-Mails, die zusÃ¤tzlich an den Administrator versendet werden.<br/>HINWEIS: Wenn Sie hier HTML auswÃ¤hlen, dann muss auch der generelle Hauptschalter HTML Emails versenden auf treu gestellt sein, sonst werden nur Text Emails versandt.', now(), now()),
('E-Mail Kopie bei Bestellungen versenden', 'SEND_EXTRA_ORDER_EMAILS_TO', 43, 'Versendet zusÃ¤tzlich ein E-Mail bei Bestellungen an die unten angegebene(n) Adresse(n).<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden:<br/>Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
...
('"Neues Konto erstellt": Kopie an diese E-Mail Adresse(n) versenden', 'SEND_EXTRA_CREATE_ACCOUNT_EMAILS_TO', 43, 'Eine Kopie an diese E-Mail Adresse(n) versenden, wenn ein neues Konto erstellt wurde?<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
...
('"Gutschein versendet": Kopie an diese E-Mail Adresse(n) versenden', 'SEND_EXTRA_GV_CUSTOMER_EMAILS_TO', 43, 'Eine Kopie bei "Gutschein versendet" an diese E-Mail Adresse(n) versenden.<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
...
('"Admin Gutschein versendet": Kopie an diese E-Mail Adresse(n) versenden', 'SEND_EXTRA_GV_ADMIN_EMAILS_TO', 43, 'Eine Kopie bei "Admin Gutschein versendet" an diese E-Mail Adresse(n) versenden.<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
...
('"Admin Bestellung": Kopie an diese E-Mail Adresse(n) versenden', 'SEND_EXTRA_ORDERS_STATUS_ADMIN_EMAILS_TO', 43, 'Eine Kopie bei "Admin Bestellung versendet" an diese E-Mail Adresse(n) versenden.<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
('"Kunden Bewertung" : Benachrichtigung versenden', 'SEND_EXTRA_REVIEW_NOTIFICATION_EMAILS_TO_STATUS', 43, '0= Nein<br/>1= Ja', now(), now()),
('"Kunden Bewertung" : Kopie an diese E-Mail Adresse(n) versenden', 'SEND_EXTRA_REVIEW_NOTIFICATION_EMAILS_TO', 43, 'Eine Kopie an diese E-Mail Adresse(n) versenden, wenn eine Bewertung abgegeben wurde?<br/>Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;\r\n', now(), now()),
('E-Mail Adressen fÃ¼r die "Schreiben Sie uns" Dropdown Liste', 'CONTACT_US_LIST', 43, 'Lassen Sie dieses Feld leer, wenn Sie kein Dropdown mit unterschiedlichen Kontaktadressen verwenden wollen, es wird dann automatisch die Shop Kontakadresse verwendet!<br/><br/>Geben Sie hier die fÃ¼r die "Schreiben Sie uns" E-Mail Dropdown Liste gewÃ¼nschte(n) E-Mail Adresse(n) ein.<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
...
('"Lagermindestbestand unterschritten": an diese E-Mail Adresse(n) versenden', 'SEND_EXTRA_LOW_STOCK_EMAILS_TO', 43, 'Wenn der Lagermindestbestand erreicht oder unterschritten wurde, soll an diese E-Mail Adresse(n) eine Benachrichtigung versendet werden.<br />Die Adressen mÃ¼ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;', now(), now()),
('Link "Newsletter abbestellen" anzeigen?', 'SHOW_NEWSLETTER_UNSUBSCRIBE_LINK', 43, 'Soll in der Info Box ein Link fÃ¼r "Newsletter abbestellen" angezeigt werden?', now(), now()),
('EmpfÃ¤ngerliste -  ZÃ¤hleranzeige', 'AUDIENCE_SELECT_DISPLAY_COUNTS', 43, 'Wenn die Liste der VerfÃ¼gbaren EmpfÃ¤nger angezeigt wird, soll der EmpfÃ¤ngerzÃ¤hler inkludiert werden? <br /><em>(HINWEIS: Es kC6nnen GeschwindigkeitseinbuCen auftreten, wenn Sie viele Kunden oder komplexe EmpfÃ¤ngerabfragen haben)</em>', now(), now()),
...
('Downloads Ã¼ber Weiterleitung', 'DOWNLOAD_BY_REDIRECT', 43, 'Wollen Sie Browser-Weiterleitung fÃ¼r Download-Artikel aktivieren? (Ist auf nicht-UNIX Systemen deaktiviert).<br /><br />HINWEIS: Setzten Sie /pub auf CHMOD 777 bei aktivierter Weiterleitung', now(), now()),
('Streaming Download', 'DOWNLOAD_IN_CHUNKS', 43, 'Wenn Download via redirect gesperrt ist und ihr PHP Speicherlimit < 8 MB ist, sollten Sie diese Einstellung verwenden, da die Daten in kleineren BlC6cken an den Browser Ã¼bermittelt werden.<br /><br />Hat keine Bedeutung wenn Download via Redirect freigegeben ist.', now(), now()),
('Ablaufdatum fÃ¼r Downloads (Anzahl in Tagen)', 'DOWNLOAD_MAX_DAYS', 43, 'Geben Sie hier die Anzahl der Tagen ein, fÃ¼r wie lange ein Download-Artikel gÃ¼ltig sein soll. (0= Unlimitiert)', now(), now()),
...
('Downloadmanager: Wert fÃ¼r Aktualisierungsstatus', 'DOWNLOADS_ORDERS_STATUS_UPDATED_VALUE', 43, 'Welcher Bestellstatus soll die Tage der GÃ¼ltigkeitsdauer und die maximal erlaubte Downloadanzahl fÃ¼r Download-Artikel zurÃ¼cksetzen? (Standard = 4)', now(), now()),
('Downloadmanager: Wert fÃ¼r Bestellstatus', 'DOWNLOADS_CONTROLLER_ORDERS_STATUS', 43, 'Nur wenn der Auftragsstatus GrÃ¶ÃŸer/gleich dem eingegebenen Wert ist, kC6nnen Download-Artikel heruntergeladen werden. Standard: 2', now(), now()),
('Max. Auftragsstatus fÃ¼r Download-Artikel', 'DOWNLOADS_CONTROLLER_ORDERS_STATUS_END', 43, 'Nur wenn der Auftragsstatus kleiner/gleich dem eingegebenen Wert ist, kC6nnen Download-Artikel heruntergeladen werden. Standard: 4', now(), now()),
('Preis durch Attribute', 'ATTRIBUTES_ENABLED_PRICE_FACTOR', 43, 'Preise durch Attribute aktivieren?', now(), now()),
('Mengenrabatt aktivieren', 'ATTRIBUTES_ENABLED_QTY_PRICES', 43, 'Mengenrabatte ermC6glichen?', now(), now()),
...
('Artikel mit Read-Only Attributen - HinzufÃ¼gen zum Warenkorb', 'PRODUCTS_OPTIONS_TYPE_READONLY_IGNORED', 43, 'KC6nnen Artikel mit nur Read-Only Attributen in den Warenkorb gelegt werden?<br/>0=NEIN<br/>1=JA', now(), now()),

# AdminmenÃ¼ ID 14
('GZip Komprimierung aktivieren', 'GZIP_LEVEL', 43, '0= nein 1= ja', now(), now()),

# AdminmenÃ¼ ID 15
('Verzeichnis fÃ¼r Sitzungen', 'SESSION_WRITE_DIRECTORY', 43, 'Wenn das Speichern von Sitzungen sateibasierend ist, werden sie in dieses Verzeichnis gespeichert. Hier sollte dasselbe Verzeichnis angegeben werden wie in der Einstellun fÃ¼r DIR_FS_SQL_CACHE in Ihren beiden configure.php Dateien!', now(), now()),
('Cookies - DomÃ¤nenname', 'SESSION_USE_FQDN', 43, 'Wenn fÃ¼r den Shop Cookies verwendet werden, benÃ¶tigen Sie einen DomÃ¤nennamen (z.B. www.meinedomain.at). Wenn nicht, wird nur ein teilweiser DomÃ¤nenname benÃ¶tigt (z.B. meinedomain.at) Wenn Sie sich nicht sicher sind, lassen Sie diese Option auf "true".', now(), now()),
...
('ÃœberprÃ¼fung der SSL Sitzungs- ID', 'SESSION_CHECK_SSL_SESSION_ID', 43, 'ÃœberprÃ¼ft die Sitzungs-ID bei jeder gesicherten HTTPS Seitenanfrage.', now(), now()),
('Browser des Kunden prÃ¼fen', 'SESSION_CHECK_USER_AGENT', 43, 'ÃœberprÃ¼ft den Browser des Kunden bei jeder Seitenanfrage.', now(), now()),
('IP Adresse Ã¼berprÃ¼fen', 'SESSION_CHECK_IP_ADDRESS', 43, 'ÃœberprÃ¼ft die IP Adresse des Benutzers bei jeder Seitenanfrage.', now(), now()),
('Spider Sitzungen verhindern', 'SESSION_BLOCK_SPIDERS', 43, 'Verhindert das Starten von Sitzungen bei bekannten Spidern.', now(), now()),
('Sitzungen wiederherstellen', 'SESSION_RECREATE', 43, 'Sollen Sitzungen wiederhergestellt werden, um eine neue Sitzungs-ID zu erstellen, wenn ein Kunde sich anmeldet oder ein neues Konto erstellt? (benÃ¶tigt PHP >=4.1).', now(), now()),
('Umwandlung IP Adresse zu Hostname', 'SESSION_IP_TO_HOST_ADDRESS', 43, 'Soll die IP-Adresse auf einen Hostnamen umgewandelt werden?<br/><br/>Anmerkung: Auf manchen Systemen kann dies zu einem langsameren Session Start und E-Mailversand fÃ¼hren. ', now(), now()),

# AdminmenÃ¼ ID 16
('LÃ¤nge der Aktionskupon-/Gutscheinnummer', 'SECURITY_CODE_LENGTH', 43, 'Tragen Sie hier die LÃ¤nge der Aktionskupon-/Gutscheinnummer ein<br />Tipp: Je lÃ¤nger um so sicherer.', now(), now()),
...
('Neuregistrierung: Aktionskupon ID#', 'NEW_SIGNUP_DISCOUNT_COUPON', 43, 'WÃ¤hlen Sie einen Aktionskupon<br />(none= keine Aktiosnkupons bei Neuregistrierungen senden)', now(), now()),
('Neuregistrierung: ErmÃ¤ÃŸigungsbetrag', 'NEW_SIGNUP_GIFT_VOUCHER_AMOUNT', 43, 'Bitte leer lassen, falls Sie keine "Willkommensgeschenke" in Form eines Aktionskupons an Neukunden versenden wollen,<br />oder geben Sie den Betrag an (z.B. 10 fÃ¼r &euro;10.00)', now(), now()),
...
('Akzeptierte Kreditkarten in der Seite fÃ¼r Bezahlung anzeigen', 'SHOW_ACCEPTED_CREDIT_CARDS', 43, 'Sollen die akzeptierten Kreditkarten in der Seite fÃ¼r die Bezahlung angezeigt werden?<br />0= nicht anzeigen<br />1= als Text anzeigen<br />2= als Bild anzeigen<br /><br />HINWEIS: Die Bilder und Texte mÃ¼ssen sowohl in der Datenbank als auch in den Sprachfiles fÃ¼r die jeweilige Kreditkarte definiert sein.', now(), now()),

# AdminmenÃ¼ ID 6 - Wird nicht angezeigt, dient meist fÃ¼r die Module
...
('Warteschlange fÃ¼r Gutscheinbestellungen aktivieren', 'MODULE_ORDER_TOTAL_GV_QUEUE', 43, 'Wollen Sie die Warteschlange fÃ¼r Gutscheinbestellungen aktivieren?', now(), now()),
...
('Steuerklasse fÃ¼r Gutscheine', 'MODULE_ORDER_TOTAL_GV_TAX_CLASS', 43, 'Folgende Steuerklasse wird bei Gutscheinen und im Kreditguthaben verwendet:', now(), now()),
...
('Bestellstatus', 'MODULE_ORDER_TOTAL_GV_ORDER_STATUS_ID', 43, 'Legt den Bestellstatus fest, wenn der komplette Auftrag mit einem Gutschein vollstÃ¤ndig bezahlt wurde.', now(), now()),
...
('GebÃ¼hr fÃ¼r Mindestbestellmenge', 'MODULE_ORDER_TOTAL_LOWORDERFEE_LOW_ORDER_FEE', 43, 'Wollen Sie einen Mindestbestellzuschlag aktivieren?', now(), now()),
('GebÃ¼hr bei Unterschreitung der Mindestbestellmenge', 'MODULE_ORDER_TOTAL_LOWORDERFEE_ORDER_UNDER', 43, 'Wie hoch ist GebÃ¼hr bei Unterschreitung der Mindestbestellmenge?', now(), now()),
('GebÃ¼hr fÃ¼r Mindestbestellmenge - Betrag', 'MODULE_ORDER_TOTAL_LOWORDERFEE_FEE', 43, 'fÃ¼r eine prozentuelle Kalkulation fÃ¼gen Sie ein "%" Zeichen an. Beispiel: 10%<br />fÃ¼r eine pauschale GebÃ¼hr geben Sie den Betrag an. Beispiel: 5 fÃ¼r &euro;5.00', now(), now()),
('GebÃ¼hr fÃ¼r Mindestbestellmenge - nur bestimmte Bestellungen', 'MODULE_ORDER_TOTAL_LOWORDERFEE_DESTINATION', 43, 'GebÃ¼hren fÃ¼r Mindestbestellmengen werden nur fÃ¼r Bestellungen angewendet, die zum hier eingestellten Ziel gesendet werden.', now(), now()),
('GebÃ¼hr fÃ¼r Mindestbestellmenge - Steuerklasse', 'MODULE_ORDER_TOTAL_LOWORDERFEE_TAX_CLASS', 43, 'Folgende Steuerklasse bei GebÃ¼hren fÃ¼r Mindestbestellmengen verwenden.', now(), now()),
('Virtuelle Artikel - keine GebÃ¼hr fÃ¼r Mindestbestellmenge', 'MODULE_ORDER_TOTAL_LOWORDERFEE_VIRTUAL', 43, 'Soll bei Bestellungen, die nur virtuellen Artikel beinhalten, keine GebÃ¼hr fÃ¼r Mindestbestellmenge gerechnet werden?', now(), now()),
('Geschenkgutscheine - keine GebÃ¼hr fÃ¼r Mindestbestellmenge', 'MODULE_ORDER_TOTAL_LOWORDERFEE_GV', 43, 'Soll bei Bestellungen, die nur Geschenkgutscheine beinhalten, keine GebÃ¼hr fÃ¼r Mindestbestellmenge gerechnet werden?', now(), now()),
...
('Versandkostenfreie Lieferung Ã¼ber', 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER', 43, 'Versandkostenfreie Lieferung Ã¼ber dem hier eingegebenen Bestellwert.', now(), now()),
('Versandkostenfreie Lieferung fÃ¼r diese Bestellung erlauben', 'MODULE_ORDER_TOTAL_SHIPPING_DESTINATION', 43, 'Versandkostenfreie Lieferung fÃ¼r Bestellungen erlauben, die zum hier eingestellten Ziel gesendet werden.', now(), now()),
...
('Steuerklasse fÃ¼r das EinlC6sen von Aktionskupons', 'MODULE_ORDER_TOTAL_COUPON_TAX_CLASS', 43, 'Diese Steuerklasse beim EinlC6sen von Aktionskupons verwenden', now(), now()),
...
('Artikeloptionstyp: Auswahltyp', 'PRODUCTS_OPTIONS_TYPE_SELECT', 43, 'Die Zahl reprÃ¤sentiert den Auswahltyp der Artikeloptionen', now(), now()),
...
('ID fÃ¼r Text und Datei des Artikeloption Wertes', 'PRODUCTS_OPTIONS_VALUES_TEXT_ID', 43, 'Numerischer Wert der Artikeloptionswert ID (products_options_values_id), die vom Text- und Dateiattribute verwendet wird', now(), now()),
('Upload PrÃ¤fix', 'UPLOAD_PREFIX', 43, 'PrÃ¤fix zu Unterscheidung zwischen Uploadoptionen und anderen Optionen', now(), now()),
('Text PrÃ¤fix', 'TEXT_PREFIX', 43, 'PrÃ¤fix zu Unterscheidung zwischen Textoptionen und anderen Optionen', now(), now()),
...
('Artikelbeschreibung: Anzeige der Preisreduktion in WÃ¤hrung oder Prozent', 'SHOW_SALE_DISCOUNT', 43, 'Zeige den Preisreduktion an in:<br />1= %<br />2= Betrag', now(), now()),
...
('Artikelbeschreibung: "fÃ¼r Preis bitte anrufen" als Bild oder Text darstellen', 'PRODUCTS_PRICE_IS_CALL_IMAGE_ON', 43, 'Soll "fÃ¼r Preis bitte anrufen" als Bild oder Text dargestellt werden?<br />0= Text<br />1= Bild', now(), now()),
('Artikelanzahl: Bei neuen Artikel aktiviert', 'PRODUCTS_QTY_BOX_STATUS', 43, 'Wie soll die Box der Artikelanzahl fÃ¼r den Warenkorb bei neuen Artikel standardmÃ¤ÃŸig eingestellt sein?<br /><br />0= aus<br />1= ein<br /><br />Hinweis:<br />EIN<br />Diese Option zeigt eine Box, die dem Kunden die MC6glichkeit zur Eingabe der Artikelanzahl im Warenkorb anzeigt<br />AUS<br />Die Artikelanzahl wird auf nur "1" gesetzt, ohne der MC6glichkeit zur Ã„ndern nderung der Artikelanzahl im Warenkorb', now(), now()),
('Artikelbewertungen benÃ¶tigen ÃœberprÃ¼fung', 'REVIEWS_APPROVAL', 43, 'Sollen Artikelbewertungen erst nach einer ÃœberprÃ¼fung freigegeben werden?<br /><br />HINWEIS: Wenn der Bewertungsstatus deaktiviert ist, wird diese Option nicht aktiv<br /><br />0= nein 1= ja', now(), now()),
...
('Max. Anzahl WÃ¶rter fÃ¼r Metatag "description"', 'MAX_META_TAG_DESCRIPTION_LENGTH', 43, 'Max. Anzahl WÃ¶rter fÃ¼r description Metatag. Default 50:', now(), now()),
...
('"Vorheriger - NÃ¤chster" Navigation: Position der Navigationsleite', 'PRODUCT_INFO_PREVIOUS_NEXT', 43, 'Geben Sie hier an, wo die "Vorheriger - NÃ¤chster" Navigation angezeigt werden soll<br />0= nicht anzeigen<br />1= oben auf der Seite anzeigen<br />2= unten auf der Seite anzeigen<br />3= oben und unten auf der Seite anzeigen', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: Sortierung der Artikel', 'PRODUCT_INFO_PREVIOUS_NEXT_SORT', 43, 'Geben Sie hier an, wie die Artikel in der "Vorheriger - NÃ¤chster" Navigation sortiert werden sollen<br />0= Artikel ID<br />1= Artikelname<br />2= Artikelnummer<br />3= Preis, Artikelname<br />4= Preis, Artikelnummer<br />5= Artikelname, Artikelnummer<br />6= ArtikelSortierung', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: Button und Artikelbilder', 'SHOW_PREVIOUS_NEXT_STATUS', 43, 'Sollen Buttons und Artikelbilder angezeigt werden?<br />0= nein<br />1= ja', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: Button und Artikelbilder - Einstellungen', 'SHOW_PREVIOUS_NEXT_IMAGES', 43, 'Wie sollen Buttons und Artikelbilder angezeigt werden?<br />0= nur Buttons<br />1= Buttons und Artikelbilder<br />2= nur Artikelbilder', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: Breite der Bilder', 'PREVIOUS_NEXT_IMAGE_WIDTH', 43, 'Geben Sie die Breite der Artikelbilder (in Pixel) an', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: HÃ¶he der Bilder', 'PREVIOUS_NEXT_IMAGE_HEIGHT', 43, 'Geben Sie die HÃ¶he der Artikelbilder (in Pixel) an', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: Kategorien anzeigen', 'PRODUCT_INFO_CATEGORIES', 43, 'Wie sollen Artikelkategorien, Kategoriebilder und Kategorienamen oberhalb der "Vorheriger - NÃ¤chster" Navigation angezeigt werden?<br />0= nicht anzeigen<br />1= Linksausrichtung<br />2= Zentriert<br />3= Rechtsausrichtung', now(), now()),
('"Vorheriger - NÃ¤chster" Navigation: Kategoriebezeichnung und -Bild anzeigen', 'PRODUCT_INFO_CATEGORIES_IMAGE_STATUS', 43, 'Wie sollen Kategoriename und Kategoriebild angezeigt werden?<br />0= Kategoriename und -Bild immer anzeigen<br />1= Nur Kategoriename<br />2= Kategoriename und -Bild falls vorhanden', now(), now()),
...
('"BrotkrÃ¼mel" Navigation (Bread Crumbs): Separator', 'BREAD_CRUMBS_SEPARATOR', 43, 'Geben Sie hier das Symbol fÃ¼r den Separator fÃ¼r die sog. BrotkrÃ¼mel Navigation ein<br />HINWEIS: Leerzeichen mÃ¼ssen mit "& " angegeben.<br />Standard = & ::& ', now(), now()),
('"BrotkrÃ¼mel" Navigationpfad anzeigen', 'DEFINE_BREADCRUMB_STATUS', 43, 'Soll ein Navigationspfad angezeigt werden?<br />0= AUS<br />1= EIN<br/>2= EIN aber nicht auf der Startseite', now(), now()),
('Bestseller: EinrÃ¼cken der Zahlen', 'BEST_SELLERS_FILLER', 43, 'Wie wollen Sie die Zahlen fÃ¼r Bestseller einrÃ¼cken?<br />Standard = & ', now(), now()),
('Bestseller: Artikelnamen kÃ¼rzen', 'BEST_SELLERS_TRUNCATE', 43, 'Ab wie vielen Zeichen sollen Artikelnamen gekÃ¼rzt werden?<br />Standard = 35', now(), now()),
('Bestseller: KÃ¼rze Artikelnamen ab dem folgenden...', 'BEST_SELLERS_TRUNCATE_MORE', 43, 'Artikelnamen werden gekÃ¼rzt, gefolgt von...<br />Standard = true', now(), now()),
('Kategoriebox: Link fÃ¼r Sonderangebote anzeigen', 'SHOW_CATEGORIES_BOX_SPECIALS', 43, 'Soll der Link "Sonderangebote" in der Kategoriebox angezeigt werden?', now(), now()),
('Kategoriebox: Link fÃ¼r Neue Artikel anzeigen', 'SHOW_CATEGORIES_BOX_PRODUCTS_NEW', 43, 'Soll der Link "Neue Artikel" in der Kategoriebox angezeigt werden?', now(), now()),
...
('Kategorie Box - Zeige Link fÃ¼r "Empfohlene Artikel"', 'SHOW_CATEGORIES_BOX_FEATURED_PRODUCTS', 43, 'Soll der Link "Empfohlene Artikel" in der Kategoriebox angezeigt werden?', now(), now()),
('Kategorie Box - Zeige Link fÃ¼r "Alle Artikel"', 'SHOW_CATEGORIES_BOX_PRODUCTS_ALL', 43, 'Soll der Link "Alle Artikel" in der Kategoriebox angezeigt werden?', now(), now()),
...
('Kategorien: Trennzeichen zwischen Kategorienamen und -zÃ¤hler', 'CATEGORIES_SEPARATOR', 43, 'Welches Trennzeichen soll zwischen Kategorienamen und -zÃ¤hler verwendet werden?<br />Standard = -&gt;', now(), now()),
...
('KategoriezÃ¤hler PrÃ¤fix', 'CATEGORIES_COUNT_PREFIX', 43, 'Welches Symbol wollen Sie fÃ¼r den Prefix fÃ¼r KategoriezÃ¤hler verwenden?<br />Standard= (', now(), now()),
('KategoriezÃ¤hler Suffix', 'CATEGORIES_COUNT_SUFFIX', 43, 'Welches Symbol wollen Sie fÃ¼r den Suffix fÃ¼r KategoriezÃ¤hler verwenden?<br />Standard= )', now(), now()),
('Unterkategorie einrÃ¼cken mit', 'CATEGORIES_SUBCATEGORIES_INDENT', 43, 'Wie sollen Unterkategorien eingerÃ¼ckt werden?<br />Standard= & & ', now(), now()),
('KategoriezÃ¤hler fÃ¼r Kategorien mit 0 Artikel anzeigen', 'CATEGORIES_COUNT_ZERO', 43, 'Sollen KategoriezÃ¤hler fÃ¼r Kategorien, die keine Artikel enthalten, angezeigt werden?<br />0= nein<br />1= ja', now(), now()),
...
('Startseite erC6ffnet mit Kategorien', 'CATEGORIES_START_MAIN', 43, '0= Top Level Kategorien<br />oder geben Sie eine Kategorie ID# ein<br />HINWEIS: Unterkategorien kC6nnen ebenso verwendet werden. Beispiel: 3_10', now(), now()),
('Unterkategorien anzeigen?', 'SHOW_CATEGORIES_SUBCATEGORIES_ALWAYS', 43, 'Sollen Unterkategorien im NavigationsmenÃ¼ angezeigt werden, wenn die Hauptkategorie selektiert ist?<br/>0=AUS<br/>1=EIN', now(), now()),
('Bannergruppen: Ãœberschrift Position 1', 'SHOW_BANNERS_GROUP_SET1', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der Ãœberschrift 1 verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
('Bannergruppen: Ãœberschrift Position 3', 'SHOW_BANNERS_GROUP_SET3', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der Ãœberschrift 3 verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
('Bannergruppen: Ãœberschrift Position 2', 'SHOW_BANNERS_GROUP_SET2', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der Ãœberschrift 2 verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
('Bannergruppen: FuÃŸzeile Position 1', 'SHOW_BANNERS_GROUP_SET4', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der FuÃŸzeile 1 verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
('Bannergruppen: FuÃŸzeile Position 2', 'SHOW_BANNERS_GROUP_SET5', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der FuÃŸzeile 2 verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
('Bannergruppen: FuÃŸzeile Position 3', 'SHOW_BANNERS_GROUP_SET6', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br /><br />Standard Bannergruppe = Wide-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der FuÃŸzeile 3 verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
('Bannergruppen: Sidebox banner_box', 'SHOW_BANNERS_GROUP_SET7', 43, 'Die Bannergruppe kann aus einer oder aus mehreren Bannergruppen bestehen<br /><br />fÃ¼r mehrfache Bannergruppen geben Sie bitte die Namen der Bannergruppen getrennt durch <strong>:</strong> ein<br /><br />Beispiel: Wide-Banners:SideBox-Banners<br />Standard Bannergruppe = SideBox-Banners<br /><br />Welche Bannergruppe(n) wollen Sie in der Sidebox - banner_box verwenden?<br />Bitte leer lassen, wenn Sie keine Bannergruppe(n) verwenden wollen', now(), now()),
...
('Banner Anzeigengruppe - Sidebox banner_box_all', 'SHOW_BANNERS_GROUP_SET_ALL', 43, 'Welche Banneranzeigengruppe soll in der Sidebox "banner_box_all" angezeigt werden? fÃ¼r keine Gruppe Feld leer lassen!', now(), now()),
('IP Adresse in der FuÃŸzeile anzeigen', 'SHOW_FOOTER_IP', 43, 'Soll die IP Adresse des Kunden in der FuÃŸzeile angezeigt werden?<br />0= nein<br />1= ja', now(), now()),
('Mengenrabatt: Anzahl leerer Rabatte', 'DISCOUNT_QTY_ADD', 43, 'Wieviele leere Mengenrabatte sollen bei der Artikel Bepreisung hinzugefÃ¼gt werden?', now(), now()),
...
('Globale Attributfunktionen - HinzufÃ¼gen, Kopieren und LÃ¶schen   ', 'OPTION_NAMES_VALUES_GLOBAL_STATUS', 43, 'Globale Attributfunktionen (Attributname und Attributmerkmale) - HinzufÃ¼gen, Kopieren und LÃ¶schen<br/><br/>0= nicht VerfÃ¼gbar<br/>1= VerfÃ¼gbar<br/>2= Artikelnummer', now(), now()),
('Kategorie-Tabs MenÃ¼ EIN/AUS', 'CATEGORIES_TABS_STATUS', 43, 'Kategorie-Tabs<br />Zeigt die Toplevel Kategorien unterhalb des Banners an. <br />0= Kategorie Tabs AUS<br />1= Kategorie Tabs EIN', now(), now()),
('Sitemap - Link fÃ¼r "Mein Konto" inkludieren', 'SHOW_ACCOUNT_LINKS_ON_SITE_MAP', 43, 'Soll der Link fÃ¼r "Mein Konto" in der Sitemap inkludiert werden?<br /><br />Standard: false', now(), now()),
('Ãœberspringe Kategorien mit einem Artikel', 'SKIP_SINGLE_PRODUCT_CATEGORIES', 43, 'Ãœberspringe Kategorien mit einem Artikel<br />Wenn true dann wird bei Klick auf die Kategorie gleich direkt die Artikelansicht angezeigt.<br />Standard: True', now(), now()),
('Anmeldeseite geteilt anzeigen', 'USE_SPLIT_LOGIN_MODE', 43, 'Die Anmeldeseite kann in zwei Varianten angezeigt werden: Geteilt oder vertikal.<br />Die geteilte Variante zeigt neben der Felder fÃ¼r die Anmeldung einen Text und einen "Neues Konto erstellen" Button, der auf die Seite zur <em>Kontoerstellung</em> weiterleitet. In der vertikalen Variante werden alle Felder zur Kontoerstellung unterhalb der Felder fÃ¼r die Anmeldung angezeigt.<br />Standard: False', now(), now()),
('CSS SchaltflÃ¤chen', 'IMAGE_USE_CSS_BUTTONS', 43, 'CSS SchaltflÃ¤chen<br />CSS SchaltflÃ¤chen anstelle von Bildern verwenden (GIF/JPG)?<br />CSS SchaltflÃ¤chen-Stile mÃ¼ssen in den Stylesheets definiert werden.', now(), now()),
...
('Wegen Shopwartung geschlossen: Dateiname', 'DOWN_FOR_MAINTENANCE_FILENAME', 43, 'Welcher Dateinamen soll fÃ¼r den Status "Wegen Shopwartung geschlossen" verwendet werden?<br />HINWEIS: Bitte den Dateinamen ohne Dateierweiterung angeben<br />Standard= down_for_maintenance', now(), now()),
...
('Wegen Shopwartung geschlossen: FuÃŸzeile ausblenden', 'DOWN_FOR_MAINTENANCE_FOOTER_OFF', 43, 'Wegen Shopwartung geschlossen: FuÃŸzeile ausblenden<br>(true= ausblenden<br />false= anzeigen)', now(), now()),
...
('Wegen Shopwartung geschlossen: diese IP-Adresse(n) ausschlieÃŸen', 'EXCLUDE_ADMIN_IP_FOR_MAINTENANCE', 43, 'Diese IP Adresse(n) hat wÃ¤hrend der Shopwartung vollen Zugriff auf den Shop (z.B. Webmaster)<br />Bei Eingabe mehrerer IP Adressen werden diese mit einem Komma getrennt.<br /><br />TIP: Wenn Sie Ihre IP Adresse nicht kennen, finden Sie diese in der FuÃŸzeile des Shops.', now(), now()),
('Ihre Besucher vor Beginn der Shopwartung informieren:', 'WARN_BEFORE_DOWN_FOR_MAINTENANCE', 43, 'VerC6ffentlicht eine bestimmte Zeit vor der Shopwartung einen Hinweis, wann die Shopwartung starten wird<br>(true=ein false=aus)<br>IWenn Sie die Option ''Wegen Shopwartung geschlossen'' auf "true" setzen,wird diese Option automatisch auf "false" gesetzt.', now(), now()),
('Datum und Stunden fÃ¼r Hinweis vor Beginn der Shopwartung', 'PERIOD_BEFORE_DOWN_FOR_MAINTENANCE', 43, 'Datum und Stunden fÃ¼r den Hinweis vor der Shopwartung, geben Sie Datum und Stunden fÃ¼r die Zeit der Shopwartung ein', now(), now()),
...
# AdminmenÃ¼ ID 11
('AGB BestÃ¤tigungsfeld bei der Bestellung anzeigen', 'DISPLAY_CONDITIONS_ON_CHECKOUT', 43, 'Den Kunden wird wÃ¤hrend der Bestellung das AGB BestÃ¤tigungsfeld angezeigt und sie mÃ¼ssen den AGB zustimmen.', now(), now()),
('Datenschutzbestimmungen BestÃ¤tigungsfeld bei der Kontoerstellung anzeigen', 'DISPLAY_PRIVACY_CONDITIONS', 43, 'Den Kunden wird wÃ¤hrend der Kontoerstellung das Datenschutzbestimmungen BestÃ¤tigungsfeld angezeigt und sie mÃ¼ssen den Datenschutzbestimmungen zustimmen.', now(), now()),
('Checkbox fÃ¼r Widerrufsrecht bei digitalen Downloads', 'DISPLAY_WIDERRUF_DOWNLOADS_ON_CHECKOUT_CONFIRMATION', 43, 'Wollen Sie auf der BestellbestÃ¤tigungsseite eine zusÃ¤tzliche Checkbox fÃ¼r das Widerrufsrecht bei digitalen Downloads anzeigen? Der Kunde muss dann explizit zustimmen, dass sein Widerrufsrecht erlischt.<br/>Nur aktivieren, falls Sie digitale Downloads verkaufen!', now(), now()),
...
('stÃ¼ckzahl anzeigen', 'PRODUCT_NEW_LIST_QUANTITY', 43, 'Wollen Sie die ArtikelstÃ¼ckzahlen in der Liste anzeigen?<br /><br />0= nein<br /><br />1. Zahl = links oder rechts<br />2. und 3. Zahl = Sortierung<br />4. Zahl = Anzahl der Leerzeilen danach<br />', now(), now()),
...
('"HinzufÃ¼gt am" anzeigen', 'PRODUCT_NEW_LIST_DATE_ADDED', 43, 'Wollen Sie "HinzugefÃ¼gt am" in der Liste anzeigen?<br /><br />0= nein<br /><br />1. Zahl = links oder rechts<br />2. und 3. Zahl = Sortierung<br />4. Zahl = Anzahl der Leerzeilen danach<br />', now(), now()),
...
('Standardsortierung', 'PRODUCT_NEW_LIST_SORT_DEFAULT', 43, 'Wie sollen die Artikel in der Liste sortiert werden?<br />Standard= 6 (nach Datum, absteigend)<br /><br />1= nach Artikelname, aufsteigend<br />2= nach Artikelname, absteigend<br />3= nach Preis (aufsteigend), dann nach Artikelname<br />4= nach Preis absteigend, dann nach Artikelname<br />5= nach Artikelnummer<br />6= nach HinzufÃ¼gedatum, absteigend<br />7= nach HinzufÃ¼gedatum, aufsteigend<br />8= nach ArtikelSortierung', now(), now()),
('Gruppen ID fÃ¼r "neue Artikel"', 'PRODUCT_NEW_LIST_GROUP_ID', 43, 'WARNUNG: Ã„ndern Sie diesen Wert erst, wenn die Gruppen ID vom Standardwert 21 geÃ¤ndert wurde<br />Wie lautet die configuration_group_id fÃ¼r die "neue Artikel" Liste?', now(), now()),
('Button "AusgewÃ¤hlte Artikel in den Warenkorb" anzeigen', 'PRODUCT_NEW_LISTING_MULTIPLE_ADD_TO_CART', 43, 'Eingabefelder und SchaltflÃ¤che anzeigen, um mehrere ausgewÃ¤hlte Artikel mit einem Klick in den Warenkorb zu Ã¼bernehmen?<br/><br/>0= NEIN<br/>1= Oben<br/>2= Unten<br/>3= Oben und Unten', now(), now()),
('ArtikelankÃ¼ndigungen als Neue Artikel anzeigen', 'SHOW_NEW_PRODUCTS_UPCOMING_MASKED', 43, 'Sollen ArtikelankÃ¼ndigungen in Artikellisten, Seitenboxen und Centerboxen als neue Artikel angezeigt werden?<br />0= Nein<br />1= Ja', now(), now()),
...
('stÃ¼ckzahl anzeigen', 'PRODUCT_FEATURED_LIST_QUANTITY', 43, 'Wollen Sie die ArtikelstÃ¼ckzahlen in der Liste anzeigen?<br /><br />0= nein<br /><br />1. Zahl = links oder rechts<br />2. und 3. Zahl = Sortierung<br />4. Zahl = Anzahl der Leerzeilen danach<br />', now(), now()),
...
('"HinzufÃ¼gt am" anzeigen', 'PRODUCT_FEATURED_LIST_DATE_ADDED', 43, 'Wollen Sie d"HinzugefÃ¼gt am" in der Liste anzeigen?<br /><br />0= nein<br /><br />1. Zahl = links oder rechts<br />2. und 3. Zahl = Sortierung<br />4. Zahl = Anzahl der Leerzeilen danach<br />', now(), now()),
...
('Gruppen ID fÃ¼r "Empfohlene Artikel"', 'PRODUCT_FEATURED_LIST_GROUP_ID', 43, 'WARNUNG: Ã„ndern Sie diesen Wert erst, wenn die Gruppen ID vom Standardwert 22 geÃ¤ndert wurde<br />Wie lautet die configuration_group_id fÃ¼r die "Empfohlenen Artikel" Liste?', now(), now()),
('Button "AusgewÃ¤hlte Artikel in den Warenkorb" anzeigen', 'PRODUCT_FEATURED_LISTING_MULTIPLE_ADD_TO_CART', 43, 'Eingabefelder und SchaltflÃ¤che anzeigen, um mehrere ausgewÃ¤hlte Artikel mit einem Klick in den Warenkorb zu Ã¼bernehmen?<br/><br/>0= NEIN<br/>1= Oben<br/>2= Unten<br/>3= Oben und Unten', now(), now()),
...
('stÃ¼ckzahl anzeigen', 'PRODUCT_ALL_LIST_QUANTITY', 43, 'Wollen Sie stÃ¼ckzahlen in der Liste anzeigen?<br /><br />0= nein<br /><br />1. Zahl = links oder rechts<br />2. und 3. Zahl = Sortierung<br />4. Zahl = Anzahl der Leerzeilen danach<br />', now(), now()),
...
('"HinzugefÃ¼gt am" Datum anzeigen', 'PRODUCT_ALL_LIST_DATE_ADDED', 43, 'Wollen Sie das "HinzugefÃ¼gt am" Datum in der Liste anzeigen?<br /><br />0= nein<br /><br />1. Zahl = links oder rechts<br />2. und 3. Zahl = Sortierung<br />4. Zahl = Anzahl der Leerzeilen danach<br />', now(), now()),
...
('Gruppen ID fÃ¼r "Alle Artikel"', 'PRODUCT_ALL_LIST_GROUP_ID', 43, 'WARNUNG: Ã„ndern Sie diesen Wert erst, wenn die Gruppen ID vom Standardwert 23 geÃ¤ndert wurde<br />Wie lautet die configuration_group_id fÃ¼r die "Alle Artikel" Liste?', now(), now()),
('Button "AusgewÃ¤hlte Artikel in den Warenkorb" anzeigen', 'PRODUCT_ALL_LISTING_MULTIPLE_ADD_TO_CART', 43, 'Eingabefelder und SchaltflÃ¤che anzeigen, um mehrere ausgewÃ¤hlte Artikel mit einem Klick in den Warenkorb zu Ã¼bernehmen?<br/><br/>0= NEIN<br/>1= Oben<br/>2= Unten<br/>3= Oben und Unten', now(), now()),
...
('Startseite: ArtikelankÃ¼ndigungen anzeigen', 'SHOW_PRODUCT_INFO_MAIN_UPCOMING', 43, 'Sollen kommende Artikel auf der Startseite angezeigt werden?<br />0= nein (oder legen Sie die Sortierung fest)', now(), now()),
...
('Kategorien mit Unterkategorien: "ArtikelankÃ¼ndigungen" anzeigen', 'SHOW_PRODUCT_INFO_CATEGORY_UPCOMING', 43, 'Sollen kommende Artikel in Kategorien mit Unterkategorien angezeigt werden?<br />0= nein (oder legen Sie die Sortierung fest)', now(), now()),
...
('Fehlerseiten: "ArtikelankÃ¼ndigungen" anzeigen', 'SHOW_PRODUCT_INFO_MISSING_UPCOMING', 43, 'Sollen kommende Artikel auf Fehlerseiten angezeigt werden?<br />0= nein (oder legen Sie die Sortierung fest)', now(), now()),
...
('Artikelliste: "ArtikelankÃ¼ndigungen" anzeigen', 'SHOW_PRODUCT_INFO_LISTING_BELOW_UPCOMING', 43, 'ArtikelankÃ¼ndigungen unter Artikelliste anzeigen<br />0= nein (oder legen Sie die Sortierung fest)', now(), now()),
...
('Artikelliste: Artikel in den Centerboxen filtern', 'SHOW_PRODUCT_INFO_ALL_PRODUCTS', 43, 'Filter fÃ¼r die Artikel in den Centerboxen "Neue Artikel", "Empfohlene Artikel", "Sonderangebot" und "ArtikelankÃ¼ndigungen".<br><br>1= Filter ein. es werden nur Artikel aus der jeweiligen Hauptkategorie inkl. deren Unterkategorien angezeigt.<br>0= Filter aus, es werden Artikel aus allen Kategorien angezeigt.', now(), now()),

# AdminmenÃ¼ ID 25
('Startseite', 'DEFINE_MAIN_PAGE_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_main_page.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Schreiben Sie uns', 'DEFINE_CONTACT_US_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_contact_us.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Datenschutz', 'DEFINE_PRIVACY_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_privacy.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Versandbedingungen', 'DEFINE_SHIPPINGINFO_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_shippinginfo.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('AGB', 'DEFINE_CONDITIONS_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_conditions.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Bestellung erfolgreich', 'DEFINE_CHECKOUT_SUCCESS_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_checkout_success.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Aktionskupons', 'DEFINE_DISCOUNT_COUPON_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_discount_coupon.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Sitemap', 'DEFINE_SITE_MAP_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_site_map.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('404 ERROR - Seite nicht gefunden', 'DEFINE_PAGE_NOT_FOUND_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_page_not_found.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Seite 2', 'DEFINE_PAGE_2_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_page_2.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Seite 3', 'DEFINE_PAGE_3_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_page_3.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Seite 4', 'DEFINE_PAGE_4_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_page_4.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Widerrufsrecht', 'DEFINE_WIDERRUFSRECHT_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_widerrufsrecht.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Impressum', 'DEFINE_IMPRESSUM_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_impressum.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
('Zahlungsarten', 'DEFINE_ZAHLUNGSARTEN_STATUS', 43, 'Den Inhalt fÃ¼r diese Seite kC6nnen Sie Ã¼ber <em>Tools->Seiteneditor</em> bearbeiten.<br /><strong>ZustÃ¤ndige Datei: <em>define_zahlungsarten.php</em></strong><br /><br />BESCHREIBUNG:<br /><em>Link EIN</em> bedeutet, dass der Link in der Infobox sichtbar ist.<br /><em>Text AUS</em> bedeutet, dass der definierte Seitentext nicht eingeblendet wird.<br /><br />OPTIONEN:<br />0= Link EIN, Text AUS<br />1= Link EIN, Text EIN<br />2= Link AUS, Text EIN<br />3= Link AUS, Text AUS<br />', now(), now()),
...
('FuÃŸzeile anzeigen', 'EZPAGES_STATUS_FOOTER', 43, 'Sollen die EZ-Pages FuÃŸzeilen global angezeigt werden?<br />0= NEIN<br />1= JA<br />2= JA (Nur Admin-IP: siehe Shopwartung)<br />Anmerkung: Seite kann nur von Admin gesehen werden', now(), now()),
...
('Trennzeichen fÃ¼r Links in Kopfzeile', 'EZPAGES_SEPARATOR_HEADER', 43, 'Welche Trennzeichen sollen fÃ¼r Links in der EZ-Pages Kopfzeile angezeigt werden?<br />Standard = & ::& ', now(), now()),
('Trennzeichen fÃ¼r Links in FuÃŸzeile', 'EZPAGES_SEPARATOR_FOOTER', 43, 'Welche Trennzeichen sollen fÃ¼r Links in der EZ-Pages FuÃŸzeile angezeigt werden?<br />Standard = & ::& ', now(), now()),
('Vor/ZurÃ¼ck SchaltflÃ¤chen', 'EZPAGES_SHOW_PREV_NEXT_BUTTONS', 43, 'Sollen Vor/ZurÃ¼ck Schaltflachen fÃ¼r EZ-Pages angezeigt werden?<br />0=NEIN (keine SchaltflÃ¤chen)<br />1="Weiter"<br />2="ZurÃ¼ck/Weiter/Vor"<br /><br />Standard = 2', now(), now()),
('Inhaltsverzeichnis fÃ¼r Kapitel anzeigen', 'EZPAGES_SHOW_TABLE_CONTENTS', 43, 'Soll das EZ-Pages Inhaltsverzeichnis fÃ¼r Kapitel angezeigt werden?<br />0= NEIN<br />1= JA', now(), now()),
('In diesen Seiten keine Kopfzeile anzeigen', 'EZPAGES_DISABLE_HEADER_DISPLAY_LIST', 43, 'Geben Sie hier die "Seiten" der EZ-Pages an, in der keine Kopfzeile angezeigt werden sollen.<br />Seiten IDs durch Komma getrennt (ohne Leerzeichen) eingeben.<br />Seiten IDs kC6nnen in der EZ-Pages Ansicht Ã¼ber <em>Admin->Tools->EZ-Pages</em> ermittelt werden.<br />z.B. 3,7<br />oder leer lassen.', now(), now()),
('In diesen Seiten keine FuÃŸzeile anzeigen', 'EZPAGES_DISABLE_FOOTER_DISPLAY_LIST', 43, 'Geben Sie hier die "Seiten" der EZ-Pages an, in der keine FuÃŸzeile angezeigt werden sollen.<br />Seiten IDs durch Komma getrennt (ohne Leerzeichen) eingeben.<br />Seiten IDs kC6nnen in der EZ-Pages Ansicht Ã¼ber <em>Admin->Tools->EZ-Pages</em> ermittelt werden.<br />z.B. 3,7<br />oder leer lassen.', now(), now()),
('In diesen Seiten keine linke Spalte anzeigen', 'EZPAGES_DISABLE_LEFTCOLUMN_DISPLAY_LIST', 43, 'Geben Sie hier die "Seiten" der EZ-Pages an, in der keine linken Spalten (der Sideboxen) angezeigt werden sollen.<br />Seiten IDs durch Komma getrennt (ohne Leerzeichen) eingeben.<br />Seiten IDs kC6nnen in der EZ-Pages Ansicht Ã¼ber <em>Admin->Tools->EZ-Pages</em> ermittelt werden.<br />z.B. 3,7<br />oder leer lassen.', now(), now()),
('In diesen Seiten keine rechte Spalte anzeigen', 'EZPAGES_DISABLE_RIGHTCOLUMN_DISPLAY_LIST', 43, 'Geben Sie hier die "Seiten" der EZ-Pages an, in der keine rechten Spalten (der Sideboxen) angezeigt werden sollen.<br />Seiten IDs durch Komma getrennt (ohne Leerzeichen) eingeben.<br />Seiten IDs kC6nnen in der EZ-Pages Ansicht Ã¼ber <em>Admin->Tools->EZ-Pages</em> ermittelt werden.<br />z.B. 3,7<br />oder leer lassen.', now(), now()),

# AdminmenÃ¼ ID 31
('Minify fÃ¼r Javascripts aktivieren', 'MINIFY_STATUS_JS', 43, 'Minify erhC6ht die Ladegeschwindigkeit Ihrer Website. Javascripts werden kombiniert und komprimiert. Wollen Sie Minify fÃ¼r Javascripts aktivieren?', now(), now()),
('Minify fÃ¼r Stylesheets aktivieren', 'MINIFY_STATUS_CSS', 43, 'Minify erhC6ht die Ladegeschwindigkeit Ihrer Website. CSS Dateien werden kombiniert und komprimiert. Wollen Sie Minify fÃ¼r CSS Stylesheets aktivieren?', now(), now()),
('Maximale URL LÃ¤nge', 'MINIFY_MAX_URL_LENGHT', 43, 'Auf manchen Servern ist die LÃ¤nge von POST/GET URLs beschrÃ¤nkt. Falls das auf Ihren Server zutrifft, kC6nnen Sie hier den Wert verÃ¤ndern. Voreingestellt: 500', now(), now()),
('Minify Cache Zeit', 'MINIFY_CACHE_TIME_LENGHT', 43, 'Stellen Sie hier die Cache Zeit fÃ¼r Minify ein. Voreingestellt ist ein Jahr (31536000)', now(), now()),
('zuletzt gecached', 'MINIFY_CACHE_TIME_LATEST', 43, 'Hier mÃ¼ssen Sie normalerweise nichts einstellen. Falls Sie gerade Ã„nderungen an Ihren CSS und Javascripts vorgenommen haben und erzwingen wollen, dass diese Ã„nderungen sofort wirksam sind, stellen Sie auf 0.', now(), now()),
...
('GA - Google Adwords Sprache', 'GOOGLE_CONVERSION_LANG', 43, 'Google Analytics:<br/><br/>Spracheinstellung fÃ¼r Google Adwords. Voreingestellt ist: Deutsch<br/><br/><b>WÃ¤hlen Sie die gewÃ¼nschte Sprache aus:</b>', now(), now()),
('GA - Art des Tracking Codes', 'GOOGLE_ANALYTICS_TRACKING_TYPE', 43, 'Google Analytics:<br/><br/>Welchen Tracking Code Typ wollen Sie verwenden? Voreingestellt ist der neueste universal Typ. Sie kC6nnen das auf den veralteten ga.js oder auf den frÃ¼her von Google angebotenen Asynchronous Typ umstellen. Besuchen Sie die <a href="http://code.google.com/apis/analytics/docs/tracking/home.html" target="_blank">Google Analytics Website</a> fÃ¼r genauere Informationen zu den verschiedenen Varianten<br/><br/><b>WÃ¤hlen Sie Ihren Tracking Typ:</b>', now(), now()),
('GA - Benutzerdefinierten Tracking Code nach dem Hauptcode einfÃ¼gen?', 'GOOGLE_ANALYTICS_CUSTOM_CODE_ENABLED', 43, 'Google Analytics:<br/><br/>Wollen Sie einen weiteren benutzerdefinierten Trackingcode nach dem normalen Google Analytics Hauptcode einfÃ¼gen? Das kann genutzt werden, um den Code an Ihre ganz individuellen Erfordernisse anzupassen. FÃ¼gen Sie Tracking Objekte entsprechend der Dokumentation der <a href="http://code.google.com/apis/analytics/docs/tracking/gaTrackingCustomVariables.html" target="_blank">Google Analytics Website</a> ein.<br/><br/>Voreingestellt ist: Deaktiviert.', now(), now()),
('GA - Benutzerdefinierter Tracking Code', 'GOOGLE_ANALYTICS_CUSTOM_CODE', 43, 'Google Analytics:<br/><br/>Falls Sie benutzerdefinierten Tracking Code aktiviert haben, fÃ¼gen Sie diesen hier ein:', now(), now()),
...
('Open Graph - Objekt Typ', 'FACEBOOK_OPEN_GRAPH_TYPE', 43, 'Geben Sie hier einen Open Graph Object Type fÃ¼r Ihre Artikel ein. Beispiel: product<br/>Infos dazu:<br/><a href="https://developers.facebook.com/docs/reference/opengraph/" target="_blank">Open Graph Object Types</a>', now(), now()),
('Open Graph - Kategoriepfad in den URLs?', 'FACEBOOK_OPEN_GRAPH_CPATH', 43, 'Sollen Ihre URLs fÃ¼r Facebook den cPath enthalten?', now(), now()),
('Open Graph - Sprache in den Links?', 'FACEBOOK_OPEN_GRAPH_LANGUAGE', 43, 'Sollen Ihre URLs das AnhÃ¤ngsel fÃ¼r die Sprache enthalten?', now(), now()),
...
('Like Button - Layout Stil', 'FACEBOOK_LIKE_BUTTON_LAYOUT_STYLE', 43, 'WÃ¤hlen Sie das Grundlayout fÃ¼r den Button: Standard, Button mit Counter oder Box mit Counter', now(), now()),
('Like Button - Profilfotos?', 'FACEBOOK_LIKE_BUTTON_SHOW_FACES', 43, 'Sollen Profilfotos unter dem Button angezeigt werden (Falls ja setzen Sie die HÃ¶he auf 80 und mehr. Nur im Standardlayout mC6glich)', now(), now()),
('Like Button - Aktion', 'FACEBOOK_LIKE_BUTTON_ACTION', 43, 'Aktion fÃ¼r den Button: like oder recommend', now(), now()),
('Like Button - Schriftart', 'FACEBOOK_LIKE_BUTTON_FONT', 43, 'WÃ¤hlen Sie eine Schriftart aus:', now(), now()),
...
('RSS - LÃ¤nge der Beschreibung', 'RSS_ITEMS_DESCRIPTION_MAX_LENGTH', 43, 'Wollen Sie den Beschreibungstext auf eine bestimmte LÃ¤nge beschrÃ¤nken? (0 fÃ¼r kein Limit)', now(), now()),
...
('RSS - FÃ¼ge Artikelbild hinzu', 'RSS_PRODUCTS_DESCRIPTION_IMAGE', 43, 'Soll das Artikelbild im Feed erscheinen?', now(), now()),
('RSS - FÃ¼ge Jetzt kaufen Button hinzu', 'RSS_PRODUCTS_DESCRIPTION_BUYNOW', 43, 'Soll der Jetzt kaufen Button im Feed erscheinen?', now(), now()),
('RSS - Kategorien fÃ¼r Artikel', 'RSS_PRODUCTS_CATEGORIES', 43, 'Wenn ein cPath mit angegeben wird, sollen die Artikel, dann nur aus der Masterkategorie kommen oder aus allen Kategorien? (wichtig bei verlinkten Artikeln)', now(), now()),
...
# Deutsche EintrÃ¤ge fÃ¼r Versandmodul Versandkostenfrei mit Optionen
...
('BearbeitungsGebÃ¼hr', 'MODULE_SHIPPING_FREEOPTIONS_HANDLING', 43, 'Die BearbeitungsGebÃ¼hr betrÃ¤gt', now(), now()),
...
('Versandzone', 'MODULE_SHIPPING_FREEOPTIONS_ZONE', 43, 'fÃ¼r welche LÃ¤nder soll diese Versandart angeboten werden?<br/>Die auswÃ¤hlbaren Versandzonen entsprechen den angelegten Steuerzonen und den dort hinterlegten LÃ¤nder.', now(), now()),
('Sortierung', 'MODULE_SHIPPING_FREEOPTIONS_SORT_ORDER', 43, 'Bestimmt die Sortierung der angezeigten Versandarten.', now(), now()),

# Deutsche EintrÃ¤ge fÃ¼r Order Total Modul NachnameGebÃ¼hr
('NachnahmegebÃ¼hr anzeigen', 'MODULE_ORDER_TOTAL_COD_STATUS', 43, 'Wollen Sie die NachnahmegebÃ¼hr anzeigen?', now(), now()),
('Sort Order', 'MODULE_ORDER_TOTAL_COD_SORT_ORDER', 43, 'Sortierung', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r Versandkostenpauschale', 'MODULE_ORDER_TOTAL_COD_FEE_FLAT', 43, 'Versandkostenpauschale: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r standardmÃ¤ÃŸige Frei Haus Lieferung', 'MODULE_ORDER_TOTAL_COD_FEE_FREE', 43, 'StandardmÃ¤ÃŸige Frei Haus Lieferung: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r "Immer Versandkostenfrei"', 'MODULE_ORDER_TOTAL_COD_FEE_FREESHIPPER', 43, 'Immer Versandkostenfrei: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r Versandkosten mit Optionen', 'MODULE_ORDER_TOTAL_COD_FEE_FREEOPTIONS', 43, 'Versandkostenfrei mit Optionen: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r Versandkosten nach Gewicht', 'MODULE_ORDER_TOTAL_COD_FEE_PERWEIGHTUNIT', 43, 'Versandkosten nach Gewicht: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r Versandkosten pro stÃ¼ck', 'MODULE_ORDER_TOTAL_COD_FEE_ITEM', 43, 'Versandkosten pro stÃ¼ck: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r "Tabellarische Versandkosten"', 'MODULE_ORDER_TOTAL_COD_FEE_TABLE', 43, 'Tabellarische Versandkosten: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r UPS', 'MODULE_ORDER_TOTAL_COD_FEE_UPS', 43, 'UPS: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r USPS', 'MODULE_ORDER_TOTAL_COD_FEE_USPS', 43, 'USPS: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r Versandkosten nach Zonen', 'MODULE_ORDER_TOTAL_COD_FEE_ZONES', 43, 'Versandkosten nach Zonen: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r die Ã–sterreichische Post', 'MODULE_ORDER_TOTAL_COD_FEE_AP', 43, 'Ã–sterreichische Post: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r die deutsche Post', 'MODULE_ORDER_TOTAL_COD_FEE_DP', 43, 'Deutsche Post: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r Servicepakke', 'MODULE_ORDER_TOTAL_COD_FEE_SERVICEPAKKE', 43, 'Servicepakke: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('NachnahmegebÃ¼hr fÃ¼r FedEx', 'MODULE_ORDER_TOTAL_COD_FEE_FEDEX', 43, 'FedEx: &lt;LÃ¤ndercode&gt;:&lt;NachnahmegebÃ¼hr&gt;, .... 00 als LÃ¤ndercode sorgt dafÃ¼r, dass die NachnahmegebÃ¼hr fÃ¼r alle LÃ¤nder gÃ¼ltig ist. Wenn der LÃ¤ndercode 00 ist, muss es der letzte Eintrag sein. Wenn kein Eintrag 00:9.99 vorhanden ist, wird die NachnahmegebÃ¼hr in fremde LÃ¤nder nicht berechnet (unmC6glich).', now(), now()),
('Steuerklasse', 'MODULE_ORDER_TOTAL_COD_TAX_CLASS', 43, 'Welche Steuerklasse soll angewendet werden?', now(), now()),

# Vataddon
('Anzeige incl. Mwst. zzgl. Versandkosten', 'DISPLAY_VATADDON_WHERE', 43, 'Wollen Sie unterhalb der Preise den Zusatz incl. bzw. excl. Mwst. zzgl. Versandkosten anzeigen?<br/>O=Nein, Anzeige komplett deaktiviert<br/>ALL = Anzeige Ã¼berall im Shop aktiv<br/>product_info = Anzeige nur auf der Artikeldetailseite<br/><br/>Hinweis: Den Text dieser Anzeige kC6nnen Sie in folgender Datei Ã¤ndern: includes/languages/german/extra_definitions/rl.vat_info.php', now(), now());
#####################################################################################################
...
#
# Daten fÃ¼r Tabelle product_type_layout_language
#
...
('"VerfÃ¼gbar am" anzeigen', 'SHOW_PRODUCT_INFO_DATE_AVAILABLE', 43, 'Soll auf der Produktinfoseite "VerfÃ¼gbar am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
('"HinzugefÃ¼gt am" anzeigen', 'SHOW_PRODUCT_INFO_DATE_ADDED', 43, 'Soll auf der Produktinfoseite "HinzugefÃ¼gt am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('ZusÃ¤tzliche Artikelbilder anzeigen', 'SHOW_PRODUCT_INFO_ADDITIONAL_IMAGES', 43, 'Sollen auf der Produktinfoseite zusÃ¤tzliche Artikelbilder angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('Bild "Versandkostenfreie Lieferung" anzeigen', 'SHOW_PRODUCT_INFO_ALWAYS_FREE_SHIPPING_IMAGE_SWITCH', 43, 'Soll das Bild bzw. der Text fÃ¼r "Versandkostenfreie Lieferung" im Shop angezeigt werden?', now(), now()),
...
('KÃ¼nstler anzeigen', 'SHOW_PRODUCT_MUSIC_INFO_ARTIST', 43, 'Soll der KÃ¼nstler auf der Produktinfoseite angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('"VerfÃ¼gbar am" anzeigen', 'SHOW_PRODUCT_MUSIC_INFO_DATE_AVAILABLE', 43, 'Soll auf der Produktinfoseite "VerfÃ¼gbar am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
('"HinzugefÃ¼gt am" anzeigen', 'SHOW_PRODUCT_MUSIC_INFO_DATE_ADDED', 43, 'Soll auf der Produktinfoseite "HinzugefÃ¼gt am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('ZusÃ¤tzliche Artikelbilder anzeigen', 'SHOW_PRODUCT_MUSIC_INFO_ADDITIONAL_IMAGES', 43, 'Sollen auf der Produktinfoseite zusÃ¤tzliche Artikelbilder angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
('Bild "Versandkostenfreie Lieferung" anzeigen', 'SHOW_PRODUCT_MUSIC_INFO_ALWAYS_FREE_SHIPPING_IMAGE_SWITCH', 43, 'Soll das Bild bzw. der Text fÃ¼r "Versandkostenfreie Lieferung" im Shop angezeigt werden?', now(), now()),
...
('"VerfÃ¼gbar am" anzeigen', 'SHOW_DOCUMENT_GENERAL_INFO_DATE_AVAILABLE', 43, 'Soll auf der Produktinfoseite "VerfÃ¼gbar am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
('"HinzugefÃ¼gt am" anzeigen', 'SHOW_DOCUMENT_GENERAL_INFO_DATE_ADDED', 43, 'Soll auf der Produktinfoseite "HinzugefÃ¼gt am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('ZusÃ¤tzliche Artikelbilder anzeigen', 'SHOW_DOCUMENT_GENERAL_INFO_ADDITIONAL_IMAGES', 43, 'Sollen auf der Produktinfoseite zusÃ¤tzliche Artikelbilder angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('"VerfÃ¼gbar am" anzeigen', 'SHOW_DOCUMENT_PRODUCT_INFO_DATE_AVAILABLE', 43, 'Soll auf der Produktinfoseite "VerfÃ¼gbar am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
('"HinzugefÃ¼gt am" anzeigen', 'SHOW_DOCUMENT_PRODUCT_INFO_DATE_ADDED', 43, 'Soll auf der Produktinfoseite "HinzugefÃ¼gt am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('ZusÃ¤tzliche Artikelbilder anzeigen', 'SHOW_DOCUMENT_PRODUCT_INFO_ADDITIONAL_IMAGES', 43, 'Sollen auf der Produktinfoseite zusÃ¤tzliche Artikelbilder angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('Bild "Versandkostenfreie Lieferung" anzeigen', 'SHOW_DOCUMENT_PRODUCT_INFO_ALWAYS_FREE_SHIPPING_IMAGE_SWITCH', 43, 'Soll das Bild bzw. der Text fÃ¼r "Versandkostenfreie Lieferung" im Shop angezeigt werden?', now(), now()),
...
('"VerfÃ¼gbar am" anzeigen', 'SHOW_PRODUCT_FREE_SHIPPING_INFO_DATE_AVAILABLE', 43, 'Soll auf der Produktinfoseite "VerfÃ¼gbar am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
('"HinzugefÃ¼gt am" anzeigen', 'SHOW_PRODUCT_FREE_SHIPPING_INFO_DATE_ADDED', 43, 'Soll auf der Produktinfoseite "HinzugefÃ¼gt am" angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('ZusÃ¤tzliche Artikelbilder anzeigen', 'SHOW_PRODUCT_FREE_SHIPPING_INFO_ADDITIONAL_IMAGES', 43, 'Sollen auf der Produktinfoseite zusÃ¤tzliche Artikelbilder angezeigt werden?<br/> 0= AUS 1= AN', now(), now()),
...
('Bild "Versandkostenfreie Lieferung" anzeigen', 'SHOW_PRODUCT_FREE_SHIPPING_INFO_ALWAYS_FREE_SHIPPING_IMAGE_SWITCH', 43, 'Soll das Bild bzw. der Text fÃ¼r "Versandkostenfreie Lieferung" im Shop angezeigt werden?', now(), now()),
...
('PRODUCT Attribut wird nur zur Darstellung benÃ¶tigt - Standardeinstellung', 'DEFAULT_PRODUCT_ATTRIBUTES_DISPLAY_ONLY', 43, 'PRODUCT Attribut wird nur zur Anzeige benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
...
('PRODUCT Attribut ist standardmÃ¤ÃŸig markiert - Standardeinstellung', 'DEFAULT_PRODUCT_ATTRIBUTES_DEFAULT', 43, 'PRODUCT Attribut ist standardmÃ¤ÃŸig markiert<br />0= NEIN 1= JA', now(), now()),
('PRODUCT Attribut ist preisreduziert - Standardeinstellung', 'DEFAULT_PRODUCT_ATTRIBUTES_DISCOUNTED', 43, 'PRODUCT Attribut ist preisreduziert<br />Angewendete Rabatte des Artikels (Sonderpreis/Abverkauf) werden auch fÃ¼r die Attribute verwendet<br />0= NEIN 1= JA', now(), now()),
...
('PRODUCT Attribut wird benÃ¶tigt - Standardeinstellung', 'DEFAULT_PRODUCT_ATTRIBUTES_REQUIRED', 43, 'PRODUCT Attribut wird benÃ¶tigt<br />Attribut wird fÃ¼r Text benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
('PRODUCT Attribut Preis PrÃ¤fix - Standardeinstellung', 'DEFAULT_PRODUCT_PRICE_PREFIX', 43, 'PRODUCT Attribut Preis PrÃ¤fix<br />Standard Preis PrÃ¤fix<br />Leer, + oder -', now(), now()),
('PRODUCT Attribut Gewicht PrÃ¤fix - Standardeinstellung', 'DEFAULT_PRODUCT_PRODUCTS_ATTRIBUTES_WEIGHT_PREFIX', 43, 'PRODUCT Attribut Gewicht PrÃ¤fix<br />Standard Gewicht PrÃ¤fix<br />Leer, + oder -', now(), now()),

('MUSIC Attribut wird nur zur Darstellung benÃ¶tigt - Standardeinstellung', 'DEFAULT_PRODUCT_MUSIC_ATTRIBUTES_DISPLAY_ONLY', 43, 'MUSIC Attribut wird nur zur Anzeige benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
...
('MUSIC Attribut ist standardmÃ¤ÃŸig markiert - Standardeinstellung', 'DEFAULT_PRODUCT_MUSIC_ATTRIBUTES_DEFAULT', 43, 'MUSIC Attribut ist standardmÃ¤ÃŸig markiert<br />0= NEIN 1= JA', now(), now()),
('MUSIC Attribut ist preisreduziert - Standardeinstellung', 'DEFAULT_PRODUCT_MUSIC_ATTRIBUTES_DISCOUNTED', 43, 'MUSIC Attribut ist preisreduziert<br />Angewendete Rabatte des Artikels (Sonderpreis/Abverkauf) werden auch fÃ¼r die Attribute verwendet<br />0= NEIN 1= JA', now(), now()),
...
('MUSIC Attribut wird benÃ¶tigt - Standardeinstellung', 'DEFAULT_PRODUCT_MUSIC_ATTRIBUTES_REQUIRED', 43, 'MUSIC Attribut wird benÃ¶tigt<br />Attribut wird fÃ¼r Text benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
('MUSIC Attribut Preis PrÃ¤fix - Standardeinstellung', 'DEFAULT_PRODUCT_MUSIC_PRICE_PREFIX', 43, 'MUSIC Attribut Preis PrÃ¤fix<br />Standard Preis PrÃ¤fix<br />Leer, + oder -', now(), now()),
('MUSIC Attribut Gewicht PrÃ¤fix - Standardeinstellung', 'DEFAULT_PRODUCT_MUSIC_PRODUCTS_ATTRIBUTES_WEIGHT_PREFIX', 43, 'MUSIC Attribut Gewicht PrÃ¤fix<br />Standard Gewicht PrÃ¤fix<br />Leer, + oder -', now(), now()),

('DOCUMENT GENERAL Attribut wird nur zur Darstellung benÃ¶tigt - Standardeinstellung', 'DEFAULT_DOCUMENT_GENERAL_ATTRIBUTES_DISPLAY_ONLY', 43, 'DOCUMENT GENERAL Attribut wird nur zur Anzeige benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
...
('DOCUMENT GENERAL Attribut ist standardmÃ¤ÃŸig markiert - Standardeinstellung', 'DEFAULT_DOCUMENT_GENERAL_ATTRIBUTES_DEFAULT', 43, 'DOCUMENT GENERAL Attribut ist standardmÃ¤ÃŸig markiert<br />0= NEIN 1= JA', now(), now()),
('DOCUMENT GENERAL Attribut ist preisreduziert - Standardeinstellung', 'DEFAULT_DOCUMENT_GENERAL_ATTRIBUTES_DISCOUNTED', 43, 'DOCUMENT GENERAL Attribut ist preisreduziert<br />Angewendete Rabatte des Artikels (Sonderpreis/Abverkauf) werden auch fÃ¼r die Attribute verwendet<br />0= NEIN 1= JA', now(), now()),
...
('DOCUMENT GENERAL Attribut wird benÃ¶tigt - Standardeinstellung', 'DEFAULT_DOCUMENT_GENERAL_ATTRIBUTES_REQUIRED', 43, 'DOCUMENT GENERAL Attribut wird benÃ¶tigt<br />Attribut wird fÃ¼r Text benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
('DOCUMENT GENERAL Attribut Preis PrÃ¤fix - Standardeinstellung', 'DEFAULT_DOCUMENT_GENERAL_PRICE_PREFIX', 43, 'DOCUMENT GENERAL Attribut Preis PrÃ¤fix<br />Standard Preis PrÃ¤fix<br />Leer, + oder -', now(), now()),
('DOCUMENT GENERAL Attribut Gewicht PrÃ¤fix - Standardeinstellung', 'DEFAULT_DOCUMENT_GENERAL_PRODUCTS_ATTRIBUTES_WEIGHT_PREFIX', 43, 'DOCUMENT GENERAL Attribut Gewicht PrÃ¤fix<br />Standard Gewicht PrÃ¤fix<br />Leer, + oder -', now(), now()),
('DOCUMENT PRODUCT Attribut wird nur zur Darstellung benÃ¶tigt - Standardeinstellung', 'DEFAULT_DOCUMENT_PRODUCT_ATTRIBUTES_DISPLAY_ONLY', 43, 'DOCUMENT PRODUCT Attribut wird nur zur Anzeige benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
...
('DOCUMENT PRODUCT Attribut ist standardmÃ¤ÃŸig markiert - Standardeinstellung', 'DEFAULT_DOCUMENT_PRODUCT_ATTRIBUTES_DEFAULT', 43, 'DOCUMENT PRODUCT Attribut ist standardmÃ¤ÃŸig markiert<br />0= NEIN 1= JA', now(), now()),
('DOCUMENT PRODUCT Attribut ist preisreduziert - Standardeinstellung', 'DEFAULT_DOCUMENT_PRODUCT_ATTRIBUTES_DISCOUNTED', 43, 'DOCUMENT PRODUCT Attribut ist preisreduziert<br />Angewendete Rabatte des Artikels (Sonderpreis/Abverkauf) werden auch fÃ¼r die Attribute verwendet<br />0= NEIN 1= JA', now(), now()),
...
('DOCUMENT PRODUCT Attribut wird benÃ¶tigt - Standardeinstellung', 'DEFAULT_DOCUMENT_PRODUCT_ATTRIBUTES_REQUIRED', 43, 'DOCUMENT PRODUCT Attribut wird benÃ¶tigt<br />Attribut wird fÃ¼r Text benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
('DOCUMENT PRODUCT Attribut Preis PrÃ¤fix - Standardeinstellung', 'DEFAULT_DOCUMENT_PRODUCT_PRICE_PREFIX', 43, 'DOCUMENT PRODUCT Attribut Preis PrÃ¤fix<br />Standard Preis PrÃ¤fix<br />Leer, + oder -', now(), now()),
('DOCUMENT PRODUCT Attribut Gewicht PrÃ¤fix - Standardeinstellung', 'DEFAULT_DOCUMENT_PRODUCT_PRODUCTS_ATTRIBUTES_WEIGHT_PREFIX', 43, 'DOCUMENT PRODUCT Attribut Gewicht PrÃ¤fix<br />Standard Gewicht PrÃ¤fix<br />Leer, + oder -', now(), now()),

('PRODUCT FREE SHIPPING Attribut wird nur zur Darstellung benÃ¶tigt - Standardeinstellung', 'DEFAULT_PRODUCT_FREE_SHIPPING_ATTRIBUTES_DISPLAY_ONLY', 43, 'PRODUCT FREE SHIPPING Attribut wird nur zur Anzeige benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
...
('PRODUCT FREE SHIPPING Attribut ist standardmÃ¤ÃŸig markiert - Standardeinstellung', 'DEFAULT_PRODUCT_FREE_SHIPPING_ATTRIBUTES_DEFAULT', 43, 'PRODUCT FREE SHIPPING Attribut ist standardmÃ¤ÃŸig markiert<br />0= NEIN 1= JA', now(), now()),
('PRODUCT FREE SHIPPING Attribut ist preisreduziert - Standardeinstellung', 'DEFAULT_PRODUCT_FREE_SHIPPING_ATTRIBUTES_DISCOUNTED', 43, 'PRODUCT FREE SHIPPING Attribut ist preisreduziert<br />Angewendete Rabatte des Artikels (Sonderpreis/Abverkauf) werden auch fÃ¼r die Attribute verwendet<br />0= NEIN 1= JA', now(), now()),
...
('PRODUCT FREE SHIPPING Attribut wird benÃ¶tigt - Standardeinstellung', 'DEFAULT_PRODUCT_FREE_SHIPPING_ATTRIBUTES_REQUIRED', 43, 'PRODUCT FREE SHIPPING Attribut wird benÃ¶tigt<br />Attribut wird fÃ¼r Text benÃ¶tigt<br />0= NEIN 1= JA', now(), now()),
('PRODUCT FREE SHIPPING Attribut Preis PrÃ¤fix - Standardeinstellung', 'DEFAULT_PRODUCT_FREE_SHIPPING_PRICE_PREFIX', 43, 'PRODUCT FREE SHIPPING Attribut Preis PrÃ¤fix<br />Standard Preis PrÃ¤fix<br />Leer, + oder -', now(), now()),
('PRODUCT FREE SHIPPING Attribut Gewicht PrÃ¤fix - Standardeinstellung', 'DEFAULT_PRODUCT_FREE_SHIPPING_PRODUCTS_ATTRIBUTES_WEIGHT_PREFIX', 43, 'PRODUCT FREE SHIPPING Attribut Gewicht PrÃ¤fix<br />Standard Gewicht PrÃ¤fix<br />Leer, + oder -', now(), now());

REPLACE INTO product_type_layout_language (configuration_title , configuration_key , languages_id, configuration_description)
VALUES ('LANGUAGE_VERSION 20151226', 'LANGUAGE_VERSION', '43', 'Deutsch');
