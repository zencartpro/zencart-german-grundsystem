...
define('TEXT_COPY_ATTRIBUTES_DELETE','<strong>L&ouml;schen</strong> Vorhandene Attribute werden gel&ouml;scht, danach werden die neuen Attribute kopiert');
define('TEXT_COPY_ATTRIBUTES_UPDATE','<strong>Aktualisieren</strong> Die vorhandenen Attribute werden mit den neuen Einstellungen/Preisen aktualisiert, neue Attribute werden hinzuf&uuml;gt');
define('TEXT_COPY_ATTRIBUTES_IGNORE','<strong>Ignorieren</strong> Die vorhandenen Attribute bleiben erhalten, es werden nur neue Attribute hinzuf&uuml;gt');
define('SUCCESS_PRODUCT_UPDATE_SORT','Attribut Sortierung wurde aktualisiert f&uuml;r ID#');
define('SUCCESS_PRODUCT_UPDATE_SORT_NONE','Keine Attribute zum Aktualisieren der Sortierung vorhanden f&uuml;r ID#');
...
define('TEXT_DELETE_ATTRIBUTES_OPTION_NAME_VALUES', 'Sollen wirklich ALLE Attributmerkmale des Attributnamens gel&ouml;scht werden ...');
...
define('SUCCESS_ATTRIBUTES_DELETED_OPTION_NAME_VALUES', 'ALLE Attrbutmerkmale f&uuml;r Attributnamen wurden gel&ouml;scht: ');
