...
define('TEXT_HEADER_SORT_ORDER_EXPLAIN', 'Die Header Sortierung muss gr&ouml;sser als 0 sein, damit die Seite angezeigt wird.');
define('TEXT_SIDEBOX_ORDER_EXPLAIN', 'Die Sidebox Sortierung sollte gr&ouml;sser als 0 sein damit die Seite angezeigt wird, ansonsten wird angenommen, dass es sich um einen HTML Inhalt f&uuml;r besondere Verwendungszwecke handelt.');
define('TEXT_FOOTER_ORDER_EXPLAIN', 'Die Footer Sortierung muss gr&ouml;sser als 0 sein, damit die Seite angezeigt wird.');
define('TEXT_TOC_SORT_ORDER_EXPLAIN', 'Die Inhaltsverzeichnis Sortierung muss gr&ouml;sser als 0 sein, damit die Seite angezeigt wird.');
