...
define('TEXT_ALT_URL_EXPLAIN', 'Wenn angegeben, wird der HTML Inhalt ignoriert und dieser Link verwendet<br />z.B. Reviews: index.php?main_page=reviews<br />Mein Konto: index.php?main_page=account zusätzlich SSL einschalten');
