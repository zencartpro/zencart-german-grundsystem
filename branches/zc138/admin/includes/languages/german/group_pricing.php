...
define('TEXT_DELETE_PRICING_GROUP', 'Löscht die Preisgruppe');
...
define('ERROR_GROUP_PRICING_CUSTOMERS_EXIST', 'FEHLER: Kunden bestehen in dieser Gruppe.  Bestätigen Sie bitte, da&szlig; Sie alle Mitglieder von der Gruppe entfernen und sie löschen möchten.');
define('ERROR_MODULE_NOT_CONFIGURED', 'Anmerkung: Sie verwenden Gruppenpreise, haben jedoch nicht das Gruppenermä&szlig;igunsmodul aktiviert.<br />Gehen Sie zu Admin->Module->Bestellarten->Gruppenermä&szlig;ig (ot_group_pricing) und installieren/konfigurieren das Modul.');
