...
define('HEADING_TITLE', 'Weiterempfehlung f&uuml;r %s');
...
define('TEXT_EMAIL_SUCCESSFUL_SENT','Ihre Weiterempfehlung f&uuml;r <strong>%s</strong> wurde erfolgreich an <strong>%s</strong> verschickt.');
...
define('EMAIL_TEXT_INTRO','<br /><br />Ihr Freund %s meint, dass Sie der Artikel <strong>%s</strong> bei %s interessieren k&ouml;nnte.');
...
define('EMAIL_TEXT_SIGNATURE', 'Mit freundlichen Gr&uuml;ssen,' . "\n\n" . '%s');
define('ERROR_TO_NAME','Achtung! Das Eingabefeld &quot;der Name Ihres Freundes&quot; darf nicht leer sein .');
define('ERROR_TO_ADDRESS','Achtung! Die E-Mail Adresse Ihres Freundes scheint ung&uuml;ltig zu sein.');
define('ERROR_FROM_NAME','Achtung! Das Eingabefeld &quot;Ihr Name&quot; darf nicht leer sein.');
define('ERROR_FROM_ADDRESS','Achtung! Ihre E-Mail Adresse scheint ung&uuml;ltig zu sein.');
?>
