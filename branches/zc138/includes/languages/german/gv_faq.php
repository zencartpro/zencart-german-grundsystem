...
define('SUB_HEADING_TEXT','Um einen ' . TEXT_GV_NAME . ' zu versenden, brauchen Sie nur auf unsere ' . TEXT_GV_NAME . ' - Versandseite zu gehen. Den Link hierf&uuml;r finden Sie in Ihrem pers&ouml;nlichen Warenkorb.
...
E-Mail beinhaltet auch noch den ' . TEXT_GV_NAME . ' mit dem ' . TEXT_GV_REDEEM . '. Wir empfehlen Ihnen, sich Ihren ' . TEXT_GV_NAME . ' f&uuml;r den sp&auml;teren Gebrauch auszudrucken.<br /><br /><u>Sie k&ouml;nnen Ihren ' . TEXT_GV_NAME . ' nun auf
  ...
  der Sie direkt auf die  ' . TEXT_GV_NAME . 'seite bringen wird. Damit dieser ' . TEXT_GV_NAME . ' g&uuml;ltig wird, m&uuml;ssen Sie - sofern Sie noch keines besitzen - ein Konto in unserem Shop erstellen.
  ...
  klicken Sie abschlie&szlig;end auf &quot;Einl&ouml;sen&quot;. Nach einer kurzen &Uuml;berpr&uuml;fung auf G&uuml;ltigkeit des einzul&ouml;senden ' . TEXT_GV_NAME . 's wird das Guthaben Ihrem pers&ouml;nlichen ' . TEXT_GV_NAME . 'konto gutgeschrieben.<br />Ab sofort k&ouml;nnen Sie nun den Betrag zu Ihrem Zweck verwenden.');
