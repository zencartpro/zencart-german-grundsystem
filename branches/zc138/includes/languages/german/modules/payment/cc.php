...
define('MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_CVV','Kreditkartenpr&uuml;fziffer (<a href="javascript:popupWindow(\'' . zen_href_link(FILENAME_POPUP_CVV_HELP) . '\')">' . 'More Info' . '</a>)');
...
define('MODULE_PAYMENT_CC_TEXT_JS_CC_CVV','* Die Pr&uuml;fziffer f&uuml;r Kreditkarten muss aus mindestens ' . CC_CVV_MIN_LENGTH . ' characters.\n . Zeichen bestehen!');
