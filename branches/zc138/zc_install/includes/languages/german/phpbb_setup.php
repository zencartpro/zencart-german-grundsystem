...
define('PHPBB_DATABASE_PREFIX', 'phpBB Datenbank Präfix');
define('PHPBB_DATABASE_PREFIX_INSTRUCTION', 'Welches Präfix wollen Sie für die phpBB Tabellen verwenden?  Lassen Sie dieses Feld leer, wenn Sie kein Präfix benötigt wird.');
