 ...
 * @version $Id: authorizenet.php 7507 2007-11-28 16:57:25Z drbyte $
 */
/**
 * authorize.net SIM payment method class
 *
...
//       && $this->authorize['x_description'] == $this->submit_data['x_description']
  ...
  function install() {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function) values ('MD5 Hash', 'MODULE_PAYMENT_AUTHORIZENET_MD5HASH', '*Set A Hash Value at AuthNet Admin*', 'Encryption key used for validating received transaction data', '6', '0', now(), 'zen_cfg_password_display')");
