 ...
 * @version $Id: system_setup_default.php 3178 2006-03-12 22:30:49Z drbyte $
 */
?>
...
?>
    ...
    <form method="post" action="index.php?main_page=system_setup<?php if (isset($_GET['language'])) { echo '&amp;language=' . $_GET['language']; } ?>&amp;sql_cache=<?php echo $_GET['sql_cache']; ?>&amp;is_upgrade=<?php echo $is_upgrade; ?>">
	  <fieldset>
