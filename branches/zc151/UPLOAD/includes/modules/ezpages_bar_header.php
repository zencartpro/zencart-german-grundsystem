 ...
 * @version $Id: ezpages_bar_header.php 872 2012-07-12 10:01:06Z webchills $
 */
...
if (EZPAGES_STATUS_HEADER == '1' or (EZPAGES_STATUS_HEADER == '2' and (strstr(EXCLUDE_ADMIN_IP_FOR_MAINTENANCE, $_SERVER['REMOTE_ADDR'])))) {
  ...
  $page_query = $db->Execute("select * from " . TABLE_EZPAGES . " where status_header = 1 and languages_id='$rl_language' order by header_sort_order, pages_title");
