 ...
 * @version $Id: tell_a_friend.php 627 2010-08-30 15:05:14Z webchills $
 */
...
define('FORM_FIELD_FRIEND_EMAIL','Die E-Mail Adresse Ihres Freundes:');

define('EMAIL_SEPARATOR','----------------------------------------------------------------------------------------');

define('TEXT_EMAIL_SUCCESSFUL_SENT','Ihre Weiterempfehlung für <strong>%s</strong> wurde erfolgreich an <strong>%s</strong> verschickt.');
