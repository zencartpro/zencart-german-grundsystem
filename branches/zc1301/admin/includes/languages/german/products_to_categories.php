...
// +----------------------------------------------------------------------+
//  $Id: products_to_categories.php 4 2006-03-31 16:38:40Z hugo13 $
//

define('HEADING_TITLE', 'Products to Multiple Categories Link Manager ...');
define('HEADING_TITLE2', 'Kategorien / Produkte'); // new 1.3.0  
...
define('TEXT_SET_MASTER_CATEGORIES_ID', '!!!TRANSLATE!!! <strong>WARNING:</strong> You must set the MASTER CATEGORIES ID before changing Linked Categories');
...
define('WARNING_PRODUCTS_LINK_TO_CATEGORY_REMOVED', 'WARNUNG: Produkt wurde zurückgesetzt und ist nicht mehr Teil dieser Kategorie  ...');
...
define('WARNING_NO_CATEGORIES_ID', 'Warnung: no categories were selected ... no changes were made'); // new 1.3.0  
