...
// +----------------------------------------------------------------------+
//  $Id: document_general.php 4 2006-03-31 16:38:40Z hugo13 $
//
...
define('ERROR_CANNOT_LINK_TO_SAME_CATEGORY', 'Fehler: Ein Artikel kann nicht in die selben Kategorie verlinkt werden.');
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Fehler: Das Verzeichnis für die Webshopbilder ist schreibgeschützt: ');
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Fehler: Das Verzeichnis für die Webshopbilder existiert nicht: ');
define('ERROR_CANNOT_MOVE_CATEGORY_TO_PARENT', 'Fehler: Eine Kategorie kann nicht in dessen Unterkategorie verschoben werden.');
...
define('TEXT_VIRTUAL_PREVIEW', 'Warnung: Dieser Artikel ist als "versandkostenfrei" markiert und überspringt die Versandadresse');
define('TEXT_VIRTUAL_EDIT', 'Warnung: Dieser Artikel ist als "versandkostenfrei" markiert und überspringt die Versandadresse');
define('TEXT_FREE_SHIPPING_PREVIEW', 'Warnung: Dieser Artikel ist als "versandkostenfrei" markiert und <strong>benötigt</strong> eine Versandadresse');
define('TEXT_FREE_SHIPPING_EDIT', 'Warnung: Mit "Ja" markieren Sie diesen Artikel als "versandkostenfrei, Versandadresse wird benötigt"');
