...
define('TEXT_PRODUCT_MORE_INFORMATION', 'Für weitere Informationen besuchen Sie bitte unsere  <a href="http://%s" target="blank">Homepage</a>.');
...
define('ERROR_CANNOT_ADD_PRODUCT_TYPE', 'Der gewählte Artikel kann dieser Kategorie nicht hinzugefügt werden. &Uuml;berprüfen Sie die Einschränkungen der Kategorie.');


define('ERROR_CANNOT_LINK_TO_SAME_CATEGORY', 'Fehler: Artikel in der selben Kategorie können nicht verlinkt werden.');
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Fehler: Das Verzeichnis ist nicht beschreibbar: ' . DIR_FS_CATALOG_IMAGES);
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Fehler: Das Verzeichnis existiert nicht: ' . DIR_FS_CATALOG_IMAGES);
define('ERROR_CANNOT_MOVE_CATEGORY_TO_PARENT', 'Fehler: Kategorien können nicht in das eigene Unterverzeichnis verschoben werden.');
define('ERROR_CANNOT_MOVE_PRODUCT_TO_CATEGORY_SELF', 'Fehler: Ein Artikel kann nicht zur selben oder in eine Kategorie verschoben werden, in der er bereits existiert.');
