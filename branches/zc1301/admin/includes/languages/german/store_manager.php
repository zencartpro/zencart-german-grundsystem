...
define('TABLE_CONFIGURATION_TABLE', 'Suche CONSTANTE Definitionen');
...
define('TEXT_CONFIGURATION_CONSTANT', '<strong>Suche CONSTANTE oder Sprachdateidefinitionen</strong>');
define('TEXT_CONFIGURATION_KEY', 'Schl&uuml;ssen oder Name:');
define('TEXT_INFO_CONFIGURATION_UPDATE', '<strong>HINWEIS:</strong> CONSTANTEN sind immer in Gro&szlig;buchstaben geschrieben.<br />Die Suche in Sprachdateien kann eine alternative sein, wenn in den Datenbanktabellen nichts gefunden wurde.');
