...
// +----------------------------------------------------------------------+
//  $Id: index.php 4 2006-03-31 16:38:40Z hugo13 $
//
...
define('BOX_ENTRY_CVS_REPOSITORY', 'CVS Quelle');
define('BOX_ENTRY_INFORMATION_PORTAL', 'Info Portal');

define('BOX_CONNECTION_PROTECTED', 'Sie werden durch eine %s gesicherte SSL Verbindung  gesch&uuml;tzt.');
define('BOX_CONNECTION_UNPROTECTED', 'Sie verwenden <font color="#ff0000">keine</font> gesch&uuml;tzte Verbindung.');
...
define('BOX_ENTRY_FEATURED_EXPIRED', 'abgelaufene &auml;hnliche Artikel');
define('BOX_ENTRY_SALEMAKER_EXPIRED', 'abgelaufene Abverk&auml;ufe');
...
define('LAST_10_DAYS', '!!!TRANSLATE!!! Counter History for last %s recorded days');  // new 1.3.0  
