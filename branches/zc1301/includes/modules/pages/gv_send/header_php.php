...
// verify no timeout has occured on the send or process
...
if ($_GET['action'] == 'process') {
  ...
  if ($new_amount < 0) {
    ...
    $gv_query = $db->bindVars($gv_query, ':customersID', $_SESSION['customer_id'], 'integer');                        
    $gv_query = $db->bindVars($gv_query, ':firstname', $gv_customer->fields['customers_firstname'], 'string');                        
    $gv_query = $db->bindVars($gv_query, ':lastname', $gv_customer->fields['customers_lastname'], 'string');                        
