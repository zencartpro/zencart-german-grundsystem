...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; 2003-2006 <a href="http://www.zen-cart.at" target="_blank">Zen Cart</a>. Powered by <a href="http://www.zen-cart.at" target="_blank">Zen Cart</a>');
...
define('TEXT_NO_FEATURED_PRODUCTS', 'Weitere &auml;hnliche Artikel erscheinen in K&uuml;rze. Bitte besuchen Sie uns regelm&auml;&szlig;ig wieder.');

define('TEXT_NO_ALL_PRODUCTS', 'Weitere Artikel erscheinen in K&uuml;rze. Bitte besuchen Sie uns regelm&auml;&szlig;ig wieder.');
...
define('BOX_INFORMATION_PRIVACY', 'Privatsph&auml;re');
define('BOX_INFORMATION_CONDITIONS', 'AGB');
define('BOX_INFORMATION_SHIPPING', 'Preise und Versand');
define('BOX_INFORMATION_CONTACT', 'Schreiben Sie uns');
...
define('TEXT_NO_NEW_PRODUCTS', 'Weitere neue Artikel erscheinen in K&uuml;rze. Bitte besuchen Sie uns regelm&auml;&szlig;ig wieder.');

define('TEXT_UNKNOWN_TAX_RATE', 'Unbekannter Steuersatz');

define('TEXT_REQUIRED', '<span class="errorText">ben&ouml;tigt</span>');

define('ERROR_zen_MAIL', '<font face="Verdana, Arial" size="2" color="#ff0000"><strong><small>ZEN FEHLER:</small> Das e-Mail kann nicht &uuml;ber den angegebenen SMTP Server versendet werden. Überpr&uuml;fen Sie die Eintr&auml;ge der php.ini und korrigieren Sie ggf. die Einstellungen f&uuml;r den SMTP Server.</strong></font>');
...
define('CART_COUPON_INFO', 'Gutscheininfos');
  define('TEXT_SEND_OR_SPEND','##TRANS##You have a balance available in your ' . TEXT_GV_NAME . ' account. You may spend it or send it to someone else. To send click the button below.');
  define('TEXT_BALANCE_IS', '##TRANS##Your ' . TEXT_GV_NAME . ' balance is: ');
  define('TEXT_AVAILABLE_BALANCE', '##TRANS##Your ' . TEXT_GV_NAME . ' Account');
...
require(DIR_WS_LANGUAGES . $_SESSION['language'] . '/' . FILENAME_CREDIT_CARDS);
