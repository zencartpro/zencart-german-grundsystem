...
// greeting salutation
define('EMAIL_SUBJECT_SUBJECT', 'Betreff:');
...
define('EMAIL_DISCLAIMER_NEW_CUSTOMER', 'Diese e-Mail Adresse haben wir von Ihnen oder einem unserer Kunden erhalten. Sollten Sie dieses Nachricht zu Unrecht erhalten zu haben, kontaktieren Sie uns bitte unter %s');
