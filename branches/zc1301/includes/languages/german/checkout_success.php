...
* @version $Id: checkout_success.php 2 2006-03-31 09:55:33Z rainer $
*/
...
define('TABLE_HEADING_DOWNLOAD_DATE','Link ist g&uuml;ltig bis:');
define('TABLE_HEADING_DOWNLOAD_COUNT','Verbleibende Downloads:');
define('HEADING_DOWNLOAD','Sie k&ouml;nnen Ihre Artikel hier downloaden:');
define('FOOTER_DOWNLOAD','Sie k&ouml;nnen Ihre Artikel auch zu einem sp&auml;teren Zeitpunkt unter \'%s\' downloaden.');

define('TABLE_HEADING_DOWNLOAD_FILENAME','Artikel-Download:');
