...
define('HEADING_TITLE', 'Schritt 2 - 3 , Zahlungsart');
...
define('TEXT_CONDITIONS_DESCRIPTION', 'Mit Fortfahren der Bestellung best&auml;tigen Sie unsere <a href="' . zen_href_link(FILENAME_CONDITIONS, '', 'SSL') . '"><u>here</u></a>.');
define('TEXT_CONDITIONS_CONFIRM', 'Ich habe die AGB gelesen und akzeptiert.');
define('TEXT_CHECKOUT_AMOUNT_DUE', 'Gesamt Menge Passend');
