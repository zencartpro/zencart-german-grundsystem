 ...
 * @version $Id: header_php.php 3323 2006-03-31 06:01:42Z drbyte $
 */
...
if (false) { // DISABLED THIS CODEBLOCK FOR NOW....
  ...
  if (phpversion()=="4.1.2") {
    ...
    $zc_install->setError($err_text, $err_code, true);
    $this_class = 'WARN';
  } elseif (phpversion() < "4.3.2" && phpversion() != "4.3.11" && phpversion() != "4.3.10") {
    $php_ver = "<span class='errors'>".phpversion().' {'. SHOULD_UPGRADE . '}</span>';  // was MUST_UPGRADE
  ...
  $status_check[] = array('Importance' => 'Recommended', 'Title' => LABEL_OPEN_BASEDIR, 'Status' => $open_basedir, 'Class' => $this_class, 'HelpURL' =>'', 'HelpLabel'=>'Could have problems uploading files or doing backups');
  ...
  $zc_install->test_php_version('<','4.3.2',ERROR_TEXT_PHP_VERSION, ERROR_CODE_PHP_VERSION, false);
  $zc_install->test_php_version('=','4.1.2',ERROR_TEXT_4_1_2, ERROR_CODE_4_1_2, true);
  $zc_install->test_php_version('<','4.0.6',ERROR_TEXT_PHP_OLD_VERSION, ERROR_CODE_PHP_OLD_VERSION, true);
