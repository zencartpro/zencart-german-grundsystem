 ...
 * @version $Id: english.php 3252 2006-03-24 05:55:07Z drbyte $
 */
/**
...
switch ($error_code) {
  ...
  case ('18'):
    ...
    define('POPUP_ERROR_TEXT', 'This is the name of the database that will be used for Zen Cart&trade;. If you are unsure as to what this should be, then you should contact your hosting provider for more information.');
  ...
  case ('25'):
    ...
    define('POPUP_ERROR_TEXT', 'The entry for DB name is empty. Please enter the name of the database you wish to use for Zen Cart&trade;.<br />This is the name of the database that will be used for Zen Cart&trade;. If you are unsure as to what this should be, then you should contact your hosting provider for more information.');
...
You may also have given the wrong database name (<strong>Does it exist?</strong> <strong>Did you create it?</strong> -- NOTE: Zen Cart&trade; does not create a database for you.).<br /><br />Please review all of the entries and ensure that they are correct.');
  ...
  case ('55'):
    ...
    define('POPUP_ERROR_TEXT', 'The PHP Version running on your webserver is not supported by Zen Cart&trade;. <br /><br />PHP 4.2.0 is the minimum requirement. <br />However, we recommend that you use at least PHP v4.3.11 if possible.<br /><br />PHP 5.0 is not fully tested with Zen Cart&trade; at the present time, and is not recommended. However, if you choose to use it, use at least 5.0.4 or greater.<br /><br />If you are trying to use older PHP versions, note that some releases of PHP Version 4.1.2 have a bug which affects Super-Globals. This may result in the admin section of Zen Cart&trade; not being accessible. You are advised to upgrade your PHP version if possible.');
