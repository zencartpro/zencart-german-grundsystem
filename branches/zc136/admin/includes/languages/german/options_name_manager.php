...
// +----------------------------------------------------------------------+
//  $Id: options_name_manager.php 4 2006-03-31 16:38:40Z hugo13 $
//
...
define('ATTRIBUTE_WARNING_DUPLICATE','Doppeltes Attribut - Attribut wurde nicht hinzugef&uuml;gt'); // attributes duplicate warning
define('ATTRIBUTE_WARNING_DUPLICATE_UPDATE','Doppeltes Attribut existiert - Attribut wurde nicht ge&auml;ndert'); // attributes duplicate warning
define('ATTRIBUTE_WARNING_INVALID_MATCH','Attributoption und Attributmerkmal stimmen NICHT &uuml;berein - Attribut wurde nicht hinzugef&uuml;gt'); // miss matched option and options value
define('ATTRIBUTE_WARNING_INVALID_MATCH_UPDATE','Attributoption und Attributmerkmal stimmen NICHT &uuml;berein - Attribut wurde nicht ge&auml;ndert'); // miss matched option and options value
define('ATTRIBUTE_POSSIBLE_OPTIONS_NAME_WARNING_DUPLICATE','M&ouml;glicherweise doppelter Attributname hinzugef&uuml;gt'); // Options Name Duplicate warning
...
define('TABLE_HEADING_OPT_TYPE', 'Attributtyp'); //CLR 031203 add option type column
