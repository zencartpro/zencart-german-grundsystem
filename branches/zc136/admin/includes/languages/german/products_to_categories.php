...
define('HEADING_TITLE2', 'Kategorien / Artikel'); // new 1.3.0  
...
define('WARNING_NO_CATEGORIES_ID', 'Warnung: Keine Kategorie ausgew&auml;hlt ... keine &Auml;nderung gemacht'); // new 1.3.0  
...
define('SUCCESS_REMOVE_LINKED', 'Erfolgrreich verlinkte Artikel entfernt ... ');
...
define('BUTTON_RESET_CATEGORY_MASTER', 'R&uuml;cksetzen Hauptkategorie-ID');
