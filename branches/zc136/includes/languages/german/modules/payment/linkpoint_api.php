...
define('MODULE_PAYMENT_LINKPOINT_API_TEXT_ERROR_CURL_NOT_FOUND', 'CURL Funktionen wurden nicht gefunden - diese werden zwingend ben&ouml;tigt für das Linkpoint API Zahlungsmodul');
define('MODULE_PAYMENT_LINKPOINT_API_TEXT_FAILURE_MESSAGE', 'Wir entschuldigigen uns für die Unannehmlichkeiten, aber es ist momentan nicht m&ouml;glich mit der Kreditkartengesellschaft Kontakt aufzunehmen um die G&uuml;ltigkeit der Kreditkarte zu &uuml;berpr&uuml;fen. Bitte nehmen Sie für alternative Zahlungsm&ouml;glichkeitenarten mit uns Kontakt auf.');
