...
// +----------------------------------------------------------------------+
//  $Id: media_manager.php 4 2006-03-31 16:38:40Z hugo13 $
//
...
define('TEXT_HEADING_DELETE_MEDIA_COLLECTION', 'Medienkollektion l&ouml;schen');
define('TEXT_DELETE_INTRO', 'Sind Sie sicher, dass Sie diese Medienkollektion l&ouml;schen wollen?');
define('TEXT_DISPLAY_NUMBER_OF_MEDIA', 'Zeige <strong>%d</strong> bis <strong>%d</strong> (von <strong>%d</strong> Medienkollektionen)');
define('TEXT_ADD_MEDIA_CLIP', 'Medien hinzuf&uuml;gen');
