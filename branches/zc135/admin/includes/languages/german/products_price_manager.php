...
// +----------------------------------------------------------------------+
//  $Id: products_price_manager.php 4 2006-03-31 16:38:40Z hugo13 $
//
...
define('TEXT_PRODUCTS_IS_FREE_EDIT','<br />*Artikel markiert als FREI');
...
define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_EDIT','<br />*Die Preisanzeige wird die niedrigsten Gruppenattributspreise plus Preis mit einschlie&szlig;en');
