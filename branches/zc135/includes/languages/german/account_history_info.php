...
* @version $Id: account_history_info.php 2 2006-03-31 09:55:33Z rainer $
*/

define('NAVBAR_TITLE','Mein Konto');
define('NAVBAR_TITLE_1','Mein Konto');
define('NAVBAR_TITLE_2','Legende');
...
define('HEADING_ORDER_HISTORY','Status Historie & Bemerkungen');
