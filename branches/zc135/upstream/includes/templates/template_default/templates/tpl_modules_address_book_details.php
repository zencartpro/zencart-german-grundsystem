 ...
 * @version $Id: tpl_modules_address_book_details.php 4369 2006-09-03 19:31:45Z drbyte $
 */
?>
<fieldset>
...
<?php
    echo zen_draw_input_field('state', zen_get_zone_name($entry->fields['entry_country_id'], $entry->fields['entry_zone_id'], $entry->fields['entry_state']), zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_state', '40') . ' id="state"' . $status_state_disabled);
