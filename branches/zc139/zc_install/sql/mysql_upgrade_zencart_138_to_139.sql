...
# * @version $Id: mysql_upgrade_zencart_138_to_139.sql 16273 2010-05-15 05:46:47Z drbyte $
#
...
UPDATE project_version SET project_version_major='1', project_version_minor='3.9c', project_version_patch1='', project_version_patch1_source='', project_version_patch2='', project_version_patch2_source='', project_version_comment='Version Update 1.3.8->1.3.9c', project_version_date_applied=now() WHERE project_version_key = 'Zen-Cart Main';
UPDATE project_version SET project_version_major='1', project_version_minor='3.9c', project_version_patch1='', project_version_patch1_source='', project_version_patch2='', project_version_patch2_source='', project_version_comment='Version Update 1.3.8->1.3.9c', project_version_date_applied=now() WHERE project_version_key = 'Zen-Cart Database';
