...
define('MODULE_PAYMENT_PAYPAL_TEXT_CATALOG_TITLE', 'Paypal');
  if (function_exists('zen_catalog_href_link')) {
    define('MODULE_PAYMENT_PAYPAL_TEXT_DESCRIPTION', '<strong>PayPal IPN</strong><br /><font color=green>Konfigurations Hinweis:</font><br />Auf www.paypal.com, unter "Profile",<ul><li>Unter <strong>Einstellungen für sofortige Zahlungsbest&auml;tigung</strong> folgende URL verwenden:<br />'.str_replace('index.php?main_page=index','ipn_main_handler.php',zen_catalog_href_link(FILENAME_DEFAULT, '', 'SSL')) . ' </li><li>unter <strong>Website-Zahlungsoptionen</strong> folgende <strong>Rückleitungs-URL</strong> verwenden:<br />'.zen_catalog_href_link(FILENAME_CHECKOUT_PROCESS, '', 'SSL',false).'</li>' . (defined('MODULE_PAYMENT_PAYPAL_STATUS') ? '' : '<li>... und danach installieren klicken ... und "edit" um die PayPal Einstellungen in ZenCart vorzunehmen.</li>') . '</ul><font color=green><hr /></font>' );
  } else {
