...
('W&auml;hrungssymbole f&uuml;r Text-Emails', 'CURRENCIES_TRANSLATIONS', 43, 'Welche W&auml;hrungssymbole sollen f&uuml;r Text-Emails konvertiert werden?<br />Default = &amp;pound;,GBP:&amp;euro;,EUR', NULL, '2006-07-14 00:00:00'),
...
('"Kunden Beurteilung" : Benachrichtigung versenden', 'SEND_EXTRA_REVIEW_NOTIFICATION_EMAILS_TO_STATUS', 43, '0= Nein<br/>1= Ja', NULL, '0001-01-01 00:00:00'),
...
('"Kunden Beurteilung" : Kopie an diese e-Mail Adresse(n) versenden', 'SEND_EXTRA_REVIEW_NOTIFICATION_EMAILS_TO', 43, 'Eine Kopie an diese e-Mail Adresse(n) versenden, wenn eine Beurteilung abgegeben wurde?<br/>Die Adressen m&uuml;ssen in diesem Format eingegeben werden: Name 1 &lt;email@adresse1&gt;, Name 2 &lt;email@adresse2&gt;\r\n', NULL, '0001-01-01 00:00:00'),
...
('Erlaubte Dateierweiterungen fÃ¼r Datei-Upload', 'UPLOAD_FILENAME_EXTENSIONS', 43, 'Durch Komma getrennte Liste von Dateierweiterungen (ohne Punkt) welche f&uuml;r einen Datei-Upload zul&auml;ssig sind. z.B. jpg,jpeg,gif,png,eps,cdr,ai,pdf,tif,tiff,bmp,zip', NULL, '0001-01-01 00:00:00'),
...
('Default e-Mail-Einstellung Kunde', 'ACCOUNT_EMAIL_PREFERENCE', 43, 'Standard Einstellung fÃ¼r e-Mails an Kunden<br/>0=Text<br/>1=HTML', NULL, '0001-01-01 00:00:00'),
...
('Ähnliche Artikel: Spalten pro Reihe', 'SHOW_PRODUCT_INFO_COLUMNS_FEATURED_PRODUCTS', 43, 'Wieviele Spalten wollen Sie pro Reihe anzeigen lassen?', NULL, '2004-11-20 11:14:04'),
...
('Ähnliche Artikel unter Artikelliste anzeigen', 'SHOW_PRODUCT_INFO_LISTING_BELOW_FEATURED_PRODUCTS', 43, 'Ähnliche Artikel unter Artikelliste anzeigen<br />0= nein (oder legen Sie die Sortierreihenfolge fest)', NULL, '2004-11-20 11:14:04'),
...
('Ähnliche Artikel auf der Startseite: Seite f&uuml;r Fehler und fehlende Artikel', 'SHOW_PRODUCT_INFO_MISSING_FEATURED_PRODUCTS', 43, 'Ähnliche Artikel auf der Startseite: Seite f&uuml;r Fehler und fehlende Artikel anzeigen<br />0= nein (oder legen Sie die Sortierreihenfolge fest)', NULL, '2004-11-20 11:14:04'),
...
('Ähnliche Artikel auf der Startseite: Kategorien mit Unterkategorien anzeigen', 'SHOW_PRODUCT_INFO_CATEGORY_FEATURED_PRODUCTS', 43, 'Wenn &auml;hnliche Artikel auf der Startseite angezeigt werden, sollen auch Kategorien und Unterkategorien angezeigt werden?<br />0= nein (oder legen Sie die Sortierreihenfolge fest)', NULL, '2004-11-20 11:14:04'),
...
('Gruppen ID f&uuml;r "Alle Artikel"', 'PRODUCT_ALL_LIST_GROUP_ID', 43, 'Warnung: Ändern Sie diesen Wert erst, wenn die Gruppen ID vom Standardwert 23 ge&auml;ndert wurde<br />Wie lautet die configuration_group_id f&uuml;r die "alle Artikel" Liste?', NULL, '2004-11-20 11:14:04'),
...
('Startseite: Ähnliche Artikel anzeigen', 'SHOW_PRODUCT_INFO_MAIN_FEATURED_PRODUCTS', 43, 'Sollen &auml;hnliche Artikel auf der Startseite angezeigt werden?<br />0= nein (oder legen Sie die Sortierreihenfolge fest)', NULL, '2004-11-20 11:14:04'),
...
('Gruppen ID f&uuml;r "&auml;hnliche Artikel"', 'PRODUCT_FEATURED_LIST_GROUP_ID', 43, 'Warnung: Ändern Sie diesen Wert erst, wenn die Gruppen ID vom Standardwert 23 ge&auml;ndert wurde<br />Wie lautet die configuration_group_id f&uuml;r die "&auml;hnliche Artikel" Liste?', NULL, '2004-11-20 11:14:04'),
...
('Gruppen ID f&uuml;r "neue Artikel"', 'PRODUCT_NEW_LIST_GROUP_ID', 43, 'Warnung: Ändern Sie diesen Wert erst, wenn die Gruppen ID vom Standardwert 23 ge&auml;ndert wurde<br />Wie lautet die configuration_group_id f&uuml;r die "neue Artikel" Liste?', NULL, '2004-11-20 11:14:04'),
...
('Kategorie Box - Zeige Link f&uuml;r "Ähnliche Artikel"', 'SHOW_CATEGORIES_BOX_FEATURED_PRODUCTS', 43, 'Soll der Link "&auml;hnliche Artikel" in der Kategoriebox angezeigt werden?', '2003-03-21 13:08:25', '2003-03-21 11:42:47'),
...
('Artikelberichte ben&ouml;tigen Überpr&uuml;fung', 'REVIEWS_APPROVAL', 43, 'Sollen Artikelberichte erst nach einer Überpr&uuml;fung freigegeben werden?<br /><br />Hinweis: Wenn der Bewertungsstatus deaktiviert ist, wird diese Option nicht aktiv<br /><br />0= nein 1= ja', NULL, '2004-11-20 11:14:04'),
...
('Überpr&uuml;fung der SSL Sitzungs- ID', 'SESSION_CHECK_SSL_SESSION_ID', 43, 'Überpr&uuml;ft die Sitzungs- ID bei jeder gesicherten HTTPS Seitenanfrage.', NULL, '2004-11-20 11:14:04'),
('Browser des Kunden pr&uuml;fen', 'SESSION_CHECK_USER_AGENT', 43, 'Überpr&uuml;ft den Browser des Kunden bei jeder Seitenanfrage.', NULL, '2004-11-20 11:14:04'),
('IP Adresse &uuml;berpr&uuml;fen', 'SESSION_CHECK_IP_ADDRESS', 43, 'Überpr&uuml;ft die IP Adresse des Benutzers bei jeder Seitenanfrage.', NULL, '2004-11-20 11:14:04'),
...
('Lagerbestand pr&uuml;fen', 'STOCK_CHECK', 43, 'Überpr&uuml;fen, ob der bestellte Artikel auch lagernd ist', NULL, '2004-11-20 11:14:04'),
...
('Kunden Autorisierung: Überschrift verstecken', 'CUSTOMERS_AUTHORIZATION_HEADER_OFF', 43, 'Kunden Autorisierung: Überschrift verstecken <br />(true= verstecken<br />false= anzeigen)', NULL, '2004-11-20 11:14:04'),
...
('Ähnliche Artikel: H&ouml;he der Artikelbilder in der Liste', 'IMAGE_FEATURED_PRODUCTS_LISTING_HEIGHT', 43, 'Standard = 80', NULL, '2004-11-20 11:14:04'),
...
('Ähnliche Artikel: Breite der Artikelbilder in der Liste', 'IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH', 43, 'Standard = 100', NULL, '2004-11-20 11:14:04'),
...
('Überschriftbild: H&ouml;he', 'HEADING_IMAGE_HEIGHT', 43, 'Die H&ouml;he (in Pixel) der Bilder in der Überschrift', NULL, '2004-11-20 11:14:04'),
...
('Ähnliche Artikel - zuf&auml;llige Ansicht in der Box "&auml;hnliche Artikel"', 'MAX_RANDOM_SELECT_FEATURED_PRODUCTS', 43, 'Anzahl der zuf&auml;llig angezeigten &auml;hnlichen Artikel in der Box "&auml;hnliche Artikel"', NULL, '2004-11-20 11:14:04'),
('Ähnliche Artikel im Admin Bereich', 'MAX_DISPLAY_SEARCH_RESULTS_FEATURED_ADMIN', 43, 'Anzahl &auml;hnlicher Artikel pro Seite im Admin Bereich', NULL, '2004-11-20 11:14:04'),
('Ähnliche Artikel auf der Startseite', 'MAX_DISPLAY_SEARCH_RESULTS_FEATURED', 43, 'Anzahl &auml;hnlicher Artikel auf der Startseite', NULL, '2004-11-20 11:14:04'),
('Ähnliche Artikel pro Seite', 'MAX_DISPLAY_PRODUCTS_FEATURED_PRODUCTS', 43, 'Anzahl &auml;hnlicher Artikel pro Seite', NULL, '2004-11-20 11:14:04'),
...
('Überpr&uuml;fung auf fehlende Seiten', 'MISSING_PAGE_CHECK', 43, 'Zen Cart kann das Fehlen von Seiten in einer URL erkennen und leitet dann bei Bedarf auf die Indexseite weiter.<br />F&uuml;r ein Debugging kann diese Funktion deaktiviert werden. (true = Auf fehlende Seiten pr&uuml;fen, false = Keine Überpr&uuml;fung auf fehlende Seiten)', '2003-11-08 20:24:47', '0001-01-01 00:00:00'),
...
('Zen Cart Update - Check', 'SHOW_VERSION_UPDATE_IN_HEADER', 43, 'Automatische Überpr&uuml;fung auf eine neuere Version von Zen Cart und zeigt dies dann im Header des Admin Bereichs an. Wenn dieses Feature aktiviert ist, kann es manchmal zu Geschwindigkeitseinbu&szlig;en im Admin Bereich kommen.', NULL, '2004-11-20 11:14:04'),
