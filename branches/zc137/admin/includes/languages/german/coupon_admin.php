...
define('TEXT_TO_REDEEM','Sie k&ouml;nnen diesen Aktionskupon w&auml;hrend des Bestellvorgangs einl&ouml;sen. Sie brauchen nur den Aktionskupon Code in das entsprechende Eingabefeld eingeben und abschlie&szlig;end auf &quot;Einl&ouml;sen&quot; klicken.');
define('TEXT_IN_CASE','falls Sie irgendeine Probleme haben.');
define('TEXT_VOUCHER_IS','Der Aktionskupon Code lautet');
define('TEXT_REMEMBER','Bewahren Sie den Aktionskupon Code sicher auf, damit Sie von diesem Sonderangebot profitieren k&ouml;nnen.');
define('TEXT_VISIT','Besuchen Sie uns auf ' . HTTP_SERVER . DIR_WS_CATALOG);
define('TEXT_ENTER_CODE', ' und geben Sie Ihre Aktionskupon Code ein');
...
define('COUPON_CODE','Aktionskupon Code');
...
define('TEXT_COUPON_NEW', 'Verwenden Sie folgenden Aktionskupon Code:');
