...
define('TEXT_BANNERS_EXPIRCY_NOTE', '<b>&quot;Banner wird angezeigt bis&quot; Hinweis:</b><ul><li>Nur eines der beiden Felder sollte ausgef&uuml;llt werden werden</li><li>Wenn der Banner zeitlich nicht automatisch enden soll, lassen Sie diese Felder leer</li></ul>');
...
define('TEXT_INFO_BANNER_STATUS', '<strong>Hinweis:</strong> Der Bannerstatus wird basierend auf den vorhandenen Einstellungen f&uuml;r Zeitplan und Einblendungen aktualisiert');
...
define('SUCCESS_BANNER_OPEN_NEW_WINDOW_UPDATED', 'Erfolg: Der Status des Banners zum &Ouml;ffnen in einem neuen Fenster ist aktualisiert worden .');
