 ...
 * @version $Id: tpl_zc_phpupgrade_default.php  2024-04-22 17:11:17 webchills $
 */
  ...
  <div class="container">
    ...
    <div>
      <h2>Wir würden uns sehr freuen, wenn Sie die deutsche Zen Cart Version einsetzen, allerdings ist Ihr Server nicht mit unserer Software kompatibel.</h2>
        ...
        <p>Geeignete PHP Versionen für diese Zen Cart Version sind PHP 8.2.x, PHP 8.1.x oder PHP 8.0.x</p>
        <p>Um Zen Cart auf diesem Server weiterverwenden zu können, müssen Sie Ihre PHP Version aktualisieren.</p>
        <p>Wir empfehlen PHP 8.2.x zu verwenden. Die PHP Version können Sie normalerweise in der Serveradministration Ihres Providers umstellen.</p>
        <p>Bei den meisten Providern ist es auch möglich, für bestimmte Unterverzeichnisse bestimmte PHP Versionen zu aktivieren.</p>
        <p>Wenn Ihre Haupt PHP Version z.B. PHP 7.4 ist und die aus irgendeinem Grund für eine bestehende Applikation auch unbedingt erforderlich ist, dann laden Sie die deutsche Zen Cart Version in ein Unterverzeichnis und stellen nur für dieses Unterverzeichnis PHP 8.2.x ein.</p>
