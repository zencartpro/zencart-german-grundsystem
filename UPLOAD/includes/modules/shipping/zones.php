 ...
 * @version $Id: zones.php 734 2019-06-25 08:49:16Z webchills $
 */
/*

  USAGE
  By default, the module comes with support for 7 zones.  This can be
...
// shipping adjustment
    ...
    function install() {
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Versandkosten nach Zonen aktivieren?', 'MODULE_SHIPPING_ZONES_STATUS', '43', 'Wollen Sie Versandkosten nach Zonen aktivieren?', now())");
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Basis der Steuern', 'MODULE_SHIPPING_ZONES_TAX_BASIS', '43', 'Auf welcher Basis soll die Steuer für die Versandkosten berechnet werden. Mögliche Optionen:<br/>Shipping - basiert auf der Versandadresse des Kunden<br/>Billing - basiert auf der Rechnungsadresse des Kunden<br/>Store - basiert auf der Adresse des Shops falls Zone für Rechnung/Versand gleich der Zone des Shops ist.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Sortierreihenfolge', 'MODULE_SHIPPING_ZONES_SORT_ORDER', '43', 'Anzeigereihenfolge. Niedrigste Werte werden zuerst angezeigt.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Länder ausschliessen', 'MODULE_SHIPPING_ZONES_SKIPPED', '43', 'Tragen Sie hier nur die Länder ein, für die Sie Versandkosten nach Zonen NICHT anbieten wollen. Einzugeben mit den zweistelligen ISO Ländercodes durch Komma getrennt. z.B. US,DE,CH<br/>Wenn Sie keine bestimmten Länder ausschliessen wollen, lassen Sie dieses Feld leer!', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 1 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_1', '43', 'Tragen Sie hier die Länder für Ihre Zone 1 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 2 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_2', '43', 'Tragen Sie hier die Länder für Ihre Zone 2 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 3 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_3', '43', 'Tragen Sie hier die Länder für Ihre Zone 3 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 4 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_4', '43', 'Tragen Sie hier die Länder für Ihre Zone 4 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 5 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_5', '43', 'Tragen Sie hier die Länder für Ihre Zone 5 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 6 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_6', '43', 'Tragen Sie hier die Länder für Ihre Zone 6 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 7 Länder', 'MODULE_SHIPPING_ZONES_COUNTRIES_7', '43', 'Tragen Sie hier die Länder für Ihre Zone 7 ein. Einzugeben sind die zweistelligen ISO Ländercodes durch Komma getrennt, z.B. DE,CH,AT<br/>Tragen Sie 00 ein, wenn die Zone für alle ISO Ländercodes gelten soll', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 1 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_1', '43', 'Versandkosten für die Länder der Zone 1<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 2 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_2', '43', 'Versandkosten für die Länder der Zone 2<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 3 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_3', '43', 'Versandkosten für die Länder der Zone 3<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 4 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_4', '43', 'Versandkosten für die Länder der Zone 4<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 5 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_5', '43', 'Versandkosten für die Länder der Zone 5<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 6 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_6', '43', 'Versandkosten für die Länder der Zone 6<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 7 Versandkosten', 'MODULE_SHIPPING_ZONES_COST_7', '43', 'Versandkosten für die Länder der Zone 7<br/>Beispiel: 3:8.50,7:10.50,99:20.00<br/>Bedeutet: Gewicht/Preis kleiner oder gleich 3 kostet 8.50. Zwischen 3 und 7 kostet der Versand 10.50 usw.<br/>Sie können auch einen Prozentsatz der Bestellsumme als Versandkosten verwenden und z.B. definieren:<br/>25:8.50,35:5%,40:9.50,10000:7%', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 1 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_1', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 2 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_2', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 3 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_3', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 4 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_4', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 5 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_5', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 6 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_6', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone 7 Bearbeitungsgebühr', 'MODULE_SHIPPING_ZONES_HANDLING_7', '43', 'Wenn Sie in dieser Zone eine Bearbeitungsgebühr verrechnen wollen, hier eintragen. Falls nicht, die Null lassen.', now())");
