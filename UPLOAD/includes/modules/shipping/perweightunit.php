 ...
 * @version $Id: perweightunit.php 731 2016-03-09 11:49:16Z webchills $
 */
/**
...
class perweightunit extends base {
  ...
  function install() {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Grundlage der Steuern', 'MODULE_SHIPPING_PERWEIGHTUNIT_TAX_BASIS', '43', 'Möglichkeiten sind:<br />Lieferadresse = Steuern der Versandkosten richten sich nach der Lieferadresse des Kunden<br />Rechnungsadresse = Steuern der Versandkosten richten sich nach der Rechnungsadresse des Kunden<br />Shopadresse = Steuern der Versandkosten richten sich nach der Adresse des Shops', now())");
