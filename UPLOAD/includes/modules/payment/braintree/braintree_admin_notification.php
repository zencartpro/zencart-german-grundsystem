...
* @version $Id: braintree_admin_notification.php 2022-03-05 16:31:14 webchills $
*/
...
$outputStartBlock .= '<tr style="background-color : #cccccc; border: 1px solid black;">'."\n";
$outputEndBlock .= '</tr>'."\n";
...
$output = '<!-- BOF: braintree transaction processing tools -->';
...
$output .= $outputEndBlock;
$output .= $outputEndBlock;
$output .= '<!-- EOF: braintree transaction processing tools -->';
