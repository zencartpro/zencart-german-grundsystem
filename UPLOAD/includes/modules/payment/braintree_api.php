 ...
 * based on braintree_web 3.85.2 and braintree_php 6.7.0 (March 2022)
 * @copyright Copyright 2018-2021 Numinix
 * @copyright Copyright 2003-2022 Zen Cart Development Team
 * Zen Cart German Version - www.zen-cart-pro.at
 * @copyright Portions Copyright 2003 osCommerce
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: braintree_api.php 2022-03-05 16:31:14 webchills $
*/
...
//                                      'border' : '3px solid #ccc',
  ...
  function alterShippingEditButton() {
    ...
    function install() {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Version', 'MODULE_PAYMENT_BRAINTREE_VERSION', '2.3.0', 'Version installed', '6', '2', 'zen_cfg_select_option(array(\'2.2.0\'), ', now())");
