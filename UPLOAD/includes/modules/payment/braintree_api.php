 ...
 * @version $Id: braintree_api.php 2022-04-16 09:38:14 webchills $
*/
...
//                                      'border' : '3px solid #ccc',
  ...
  function alterShippingEditButton() {
    ...
    function install() {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) values ('Version', 'MODULE_PAYMENT_BRAINTREE_VERSION', '2.3.0', 'Version installed', '6', '2', now(), 'zen_cfg_read_only(')");
