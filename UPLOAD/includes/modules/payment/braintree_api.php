 ...
 * based on braintree_web 3.88.2 and braintree_php 6.9.1 (October 2022)
 * @copyright Copyright 2018-2021 Numinix
 * @copyright Copyright 2003-2022 Zen Cart Development Team
 * Zen Cart German Version - www.zen-cart-pro.at
 * @copyright Portions Copyright 2003 osCommerce
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: braintree_api.php 2022-10-30 16:46:14 webchills $
*/
    ...
    function selection() {
        ...
        $fieldsArray[] = [
            'field' => "
                ...
                <script src='https://js.braintreegateway.com/web/3.88.2/js/three-d-secure.min.js'></script>
