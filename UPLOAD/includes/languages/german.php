...
define('ARIA_DELETE_ITEM_FROM_CART','Diesen Artikel aus dem Warenkorn löschen');
define('ARIA_EDIT_QTY_IN_CART','Meneg im Warenkorb ändern');
...
define('ARIA_PAGINATION_ELLIPSIS_PREVIOUS','Nächste Gruppe von Seiten');
define('ARIA_PAGINATION_GOTO','Gehe zu ');
define('ARIA_PAGINATION_NEXT_PAGE','zur nächsten Seite');
define('ARIA_PAGINATION_PAGE_NUM','Seite %s');
define('ARIA_PAGINATION_PREVIOUS_PAGE','zur vorherigen Seite');
...
define('ASK_A_QUESTION','Frage zu diesem Artikel stellen');
...
define('BOX_HEADING_BRANDS','Nach HMarke einkaufen');
...
define('BOX_HEADING_MORE_INFORMATION','Weitere Information');
...
define('BOX_MANUFACTURER_INFO_OTHER_PRODUCTS','Andere Artikel');
define('BOX_NOTIFICATIONS_NOTIFY','Benachrichtigen Sie mich zu Updates zu <strong>%s</strong>');
define('BOX_NOTIFICATIONS_NOTIFY_REMOVE','Benachrichtigen Sie mich nicht zu Updates zu <strong>%s</strong>');
define('BOX_REVIEWS_NO_REVIEWS','Derzeit gibt es keine Bewertungen.');
...
define('CAPTION_UPCOMING_PRODUCTS','Diese Artikel werden bald wieder lagernd sein');
...
define('CART_SHIPPING_QUOTE_CRITERIA','Die Versandkosten basieren auf den von Ihnen ausgewählten Adressdaten:');
...
define('CATEGORIES_BOX_HEADING_SPECIALS','Sonderangebotes ...');
define('CATEGORIES_BOX_HEADING_WHATS_NEW','Neue Artikel ...');
define('CATEGORY_COMPANY','Firma Details');
define('CATEGORY_PERSONAL','Ihre persönlichen Daten');
define('CHARSET','utf-8');
define('DATE_FORMAT','d.m.Y');
define('DATE_FORMAT_LONG','%A %d %B, %Y');
define('DB_ERROR_NOT_CONNECTED','Fehler - keine Verbindung zur Datenbank');
define('DIVERS', 'Divers/keine Anrede'); 
define('DOB_FORMAT_STRING','dd.mm.yyyy');
define('DOWNLOADS_CONTROLLER_ON_HOLD_MSG','HINWEIS: Downloads sind nicht verfügbar bis die Zahlung bestätigt wurde');
...
define('ENTRY_EMAIL_ADDRESS_CONFIRM', 'E-Mail Adresse bestätigen:'); 
...
define('ERROR_CUSTOMERS_ID_INVALID','Kundeninformationen können nicht validiert werden!<br>Bitte melden Sie sich an oder erstellen Sie Ihr Konto neu ...');
...
define('ERROR_MAXIMUM_QTY','Die Ihrem Warenkorb hinzugefügte Menge wurde aufgrund einer Beschränkung der maximal zulässigen Menge angepasst. Siehe diesen Artikel:<br>');
define('ERROR_NO_PAYMENT_MODULE_SELECTED','Bitte wählen Sie eine Zahlungsmethode für Ihre Bestellung.');
...
define('ERROR_PRIVACY_STATEMENT_NOT_ACCEPTED','Bitte bestätigen Sie die Datenschutzerklärung, indem Sie das untenstehende Kästchen anklicken.');
...
define('ANDERE_BOX_NOTIFY_YES_ALT','Benachrichtigen Sie mich über Aktualisierungen zu diesem Produkt.');
...
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT','KUNDENZUSTIMMUNG IST ANHÄNGIG ...');
...
define('ANDERE_REVIEWS_BEWERTUNG_STARS_FOUR_ALT','Vier Sterne');
define('ANDERE_REVIEWS_BEWERTUNG_STARS_ONE_ALT','Ein Stern');
...
define('PAYMENT_JAVASCRIPT_DISABLED','Wir konnten nicht mit dem Checkout fortfahren, da Javascript deaktiviert ist. Sie müssen es aktivieren, um fortzufahren');
define('PAYMENT_METHOD_GV','Geschenkgutschein/Coupon');
define('PAYMENT_MODULE_GV','GV/DC');
define('PLEASE_SELECT','Bitte wählen Sie ...');
define('PREVNEXT_BUTTON_NEXT','[Weiter&nbsp;&raquo;]');
define('PREVNEXT_BUTTON_PREV','[&laquo;&nbsp;Prev]');
define('PREVNEXT_TITLE_NEXT_PAGE','Nächste Seite');
define('PREVNEXT_TITLE_NEXT_SET_OF_NO_PAGE','Nächster Satz von %d Seiten');
define('PREVNEXT_TITEL_PAGE_NO','Seite %d');
define('PREVNEXT_TITLE_PREVIOUS_PAGE','Vorherige Seite');
define('PREVNEXT_TITLE_PREV_SET_OF_NO_PAGE','Vorheriger Satz von %d Seiten');
...
define('PRODUKTE_QUANTITÄT_MIN_TEXT_LISTING','Min: ');
define('PRODUKTE_MENGE_EINHEIT_TEXT_LISTING','Einheiten: ');
...
define('PRODUCT_PRICE_SALE','Verkauf:&nbsp;');
...
define('SET_AS_PRIMARY','Als primäre Adresse festlegen');
define('SUCCESS_ADDED_TO_CART_PRODUCT','Produkt erfolgreich in den Warenkorb gelegt ...');
define('SUCCESS_ADDED_TO_CART_PRODUCTS','Ausgewählte(s) Produkt(e) erfolgreich in den Warenkorb gelegt ...');
...
define('TABLE_HEADING_CREDIT_PAYMENT','Verfügbare Credits');
...
define('TABLE_HEADING_FEATURED_PRODUCTS','Ausgewählte Produkte');
define('TABLE_HEADING_IMAGE','Produktbild');
define('TABLE_HEADING_LOGIN_DETAILS','Anmeldedetails');
...
define('TABLE_HEADING_PHONE_FAX_DETAILS','Zusätzliche Kontaktinformationen');
define('TABLE_HEADING_PRICE','Preis');
define('TABLE_HEADING_PRIVACY_CONDITIONS','Datenschutzbestimmungen');
define('TABLE_HEADING_PRODUCTS','Produktname');
define('TABLE_HEADING_PRODUCT_NAME','Artikelbezeichnung');
define('TABLE_HEADING_QUANTITY','Menge');
define('TABLE_HEADING_REFERRAL_DETAILS','Wurden Sie an uns verwiesen?');
define('TABLE_HEADING_SHIPPING_ADDRESS','Lieferadresse');
define('TABLE_HEADING_SPECIALS_INDEX','Monatliche Angebote für %s');
...
define('TABLE_HEADING_UPCOMING_PRODUCTS','Bevorstehende Produkte');
...
define('TEXT_ALSO_PURCHASED_PRODUCTS','Kunden, die dieses Produkt gekauft haben, kauften auch...');
...
define('TEXT_ATTRIBUTES_QTY_PRICES_ONETIME_HELP','Option Mengenrabatte Einmalige Kosten');
...
define('TEXT_AUTHORIZATION_PENDING_CHECKOUT','Kasse nicht verfügbar - Genehmigung ausstehend');
define('TEXT_AUTHORIZATION_PENDING_PRICE','Preis nicht verfügbar');
define('TEXT_BANNER_BOX','Bitte besuchen Sie unsere Sponsoren ...');
define('TEXT_BANNER_BOX2','Sehen Sie sich das noch heute an!');
...
define('TEXT_CHARGES_LETTERS','Berechnetes Entgelt:');
define('TEXT_CHARGES_WORD','Berechnetes Entgelt:');
define('TEXT_CLICK_TO_ENLARGE','größeres Bild');
define('TEXT_CLOSE_WINDOW_IMAGE',' - Bild zum Schließen anklicken');
...
define('TEXT_COUPON_LINK_TITLE','siehe die Coupon-Bedingungen');
define('TEXT_CURRENT_CLOSE_WINDOW','[ Fenster schließen ]');
define('TEXT_CURRENT_REVIEWS','Aktuelle Bewertungen:');
define('TEXT_DATE_ADDED','Dieses Produkt wurde am %s. in unseren Katalog aufgenommen.');
define('TEXT_DATE_ADDED_LISTING','Datum hinzugefügt:');
define('TEXT_DATE_AVAILABLE','Dieser Artikelt wird am %s. auf Lager sein.');
...
define('TEXT_FOOTER_DISCOUNT_QUANTITIES','* Rabatte können je nach den obigen Optionen variieren');
define('TEXT_GV_NAME','Geschenkgutschein');
define('TEXT_GV_NAMES','Geschenkgutscheine');
define('TEXT_GV_REDEEM','Einlösecode');
define('TEXT_HEADER_DISCOUNTS_OFF','Mengenrabatte nicht verfügbar ...');
define('TEXT_HEADER_DISCOUNT_PRICES_ACTUAL_PRICE','Mengenrabatte Neuer Preis');
define('TEXT_HEADER_DISCOUNT_PRICES_AMOUNT_OFF','Mengenrabatte Aus-Preis');
define('TEXT_HEADER_DISCOUNT_PRICES_PERCENTAGE','Mengenrabatte Aus Preis');
define('TEXT_INFO_SORT_BY','Sortieren nach: ');
define('TEXT_INFO_SORT_BY_PRODUCTS_DATE','Hinzufügedatum - Alt zu Neu');
define('TEXT_INFO_SORT_BY_PRODUCTS_DATE_DESC','Hinzufügedatum - Neu nach Alt');
...
define('TEXT_LOGIN_FOR_PRICE_BUTTON_REPLACE_SHOWROOM','Nur Shauraum');
...
define('TEXT_ONETIME_CHARGES','*Einmalige Kosten = ');
define('TEXT_ONETIME_CHARGES_EMAIL',"\t" . '*Zeitaufwand = ');
...
define('TEXT_PER_LETTER','<br>Preis pro Brief: ');
...
define('TEXT_PRODUCTS_LISTING_ALPHA_SORTER_NAMES','Artikel, die mit ... beginnen');
...
define('TEXT_PRODUCT_NEU_LISTING_MULTIPLE_ADD_TO_CART','Hinzufügen: ');
define('TEXT_PRODUCT_NOT_FOUND','Das Produkt wurde leider nicht gefunden.');
...
define('TEXT_REMOVE_REDEEM_COUPON_ZONE','Der Coupon "%s" ist für die von Ihnen gewählte Adresse nicht gültig.');
