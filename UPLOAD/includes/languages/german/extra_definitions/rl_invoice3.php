...
define('TABLE_HEADING_PRICE_EXCLUDING_TAX','Einzelpreis');
define('TABLE_HEADING_PRICE_EXCLUDING_TAX_AMAZON','Einzelpreis');
define('TABLE_HEADING_PRICE_INCLUDING_TAX','Einzelpreis');
define('TABLE_HEADING_TOTAL_EXCLUDING_TAX','Gesamtpreis');
define('TABLE_HEADING_TOTAL_EXCLUDING_TAX_AMAZON','Gesamtpreis');
