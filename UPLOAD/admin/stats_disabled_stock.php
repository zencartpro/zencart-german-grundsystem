 ...
 * @version $Id: stats_disabled_stock.php 1 2016-04-09 10:13:51Z webchills $
 */
...
<?php
  ...
  $products_query_raw = "select p.products_id, pd.products_name, p.products_quantity, p.products_type from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_id = pd.products_id and pd.language_id='" . $_SESSION['languages_id'] . "' and p.products_status = 0 order by p.products_quantity DESC, pd.products_name";
