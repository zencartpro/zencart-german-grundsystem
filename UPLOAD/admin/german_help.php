...
* @version $Id: german_help.php 2026-04-03 07:29:16Z webchills $
*/
...
<!-- header //-->
    ...
    <div class="container-fluid">
      <!-- body_text //-->
<h1 class="pageHeading">Hilfe zur deutschen Zen Cart Version 1.5.7k</h1>
<div class="card-text">
<span id="zencartprologo"><a href="https://www.zen-cart-pro.at" target="_blank"><img src="images/zencartpro-logo.jpg" alt="www.zen-cart-pro.at - Die deutsche Zen Cart Version" title="www.zen-cart-pro.at - Die deutsche Zen Cart Version"/></a><br><br>Ihre derzeit installierte Zen Cart Version:<br><b><?php echo  $current;?></b><br>Releasedatum: <b><?php echo $releasedate;?></b><br><br/><a class="versioncheck" href="https://ping.zen-cart-pro.at" target="_blank">auf Updates prüfen</a><br><br><?php echo 'Ihre derzeit aktive PHP Version:<b> ' . phpversion();?></b><br>Für diese Zen Cart Version empfohlen: <b>8.4.x</b></span><br><br><b>the art of e-commerce<br>übersetzt, angepasst und erweitert zur Verwendung im deutschsprachigen Raum</b><br><br>Die deutsche Zen-Cart Version 1.5.7k ist eine Modifikation der amerikanischen Version 1.5.7d/1.5.8/2.0.0/2.1.0 von <a href="https://www.zen-cart.com" target="_blank">zen-cart.com</a>.<br>
