 ...
 * @version $Id: languages.php 790 2019-06-15 16:13:51Z webchills $
 */
...
<html <?php echo HTML_PARAMS; ?>>
  ...
  <body onLoad="init()">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 configurationColumnRight">
            ...
            switch ($action) {
              case 'new':
                ...
                $contents[] = array('text' => '<br>' . zen_draw_label(TEXT_INFO_LANGUAGE_ID, 'languages_id', 'class="control-label"') . zen_draw_input_field('languages_id', '', 'class="form-control"'));
    ...
    case 'edit':
                ...
                $contents[] = array('text' => '<br>' . zen_draw_label(TEXT_INFO_LANGUAGE_ID, 'languages_id', 'class="control-label"') . zen_draw_input_field('languages_id', $lInfo->languages_id, 'maxlength="3" size="5" class="form-control"'));
