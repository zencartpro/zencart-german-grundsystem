...
define('TEXT_NOT_NEEDED', 'Nicht nötig');
define('TEXT_TABLE_CAPTION_INSTRUCTIONS', "<b>Hinweis:</b> Die zusätzlicen Artikelbilder zu einem Artikel werden <em>automatisch</em> <em>ausschliesslich</em>in ihren 'small' und 'large' Größen erzeugt und zeigen dann '" . TEXT_NOT_NEEDED . "' für ihr <b>mittelgrosses Bild</b>.  Falls Ihr Frontend andere Bildgrößen für diese Bilder oder das Hauptbild verwendet, werden diese Bilder bei Bedarf angelegt und gecached.");
...
define('TEXT_MSG_NOCREATE_MEDIUM_IMAGE_DIR', 'Fehler: Das Bildverzeichnis für mittlere Bilder konnte nicht erstellt werden.');
...
define('TEXT_MSG_NO_FILE_UPLOADED', 'Keine <b>Basis Bild Datei</b> ausgewählt; bitte nochmals probieren.');
