...
define('TEXT_UPGRADE_SUCCESS' , 'Plugin upgraded successfully');
...
define('ERROR_INVALID_SYNTAX', 'The table cannot be identified as syntax is invalid in: ');
define('ERROR_SQL_PATCH', 'Error while processing SQL install.');
