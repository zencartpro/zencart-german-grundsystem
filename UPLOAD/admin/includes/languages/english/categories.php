 ...
 * @version $Id: categories.php 2021-11-30 20:55:16Z webchills $
 */

define('HEADING_TITLE', 'Category');
define('TEXT_EDIT_INTRO', 'Please edit as required');
...
define('TEXT_EDIT_CATEGORIES_META_TAGS_TITLE', 'Page Title (browser tab):');
