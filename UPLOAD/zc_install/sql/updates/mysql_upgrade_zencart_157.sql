...
# * @version $Id: mysql_upgrade_zencart_157.sql 2022-10-10 17:03:59Z webchills $
#
...
# update Image Handler Version to 5.3.0
UPDATE configuration SET configuration_value = '5.3.0' WHERE configuration_key = 'IH_VERSION';
...
('20221010', 'LANGUAGE_VERSION', '43', 'Datum der deutschen Uebersetzungen', now(), now());
...
UPDATE project_version SET project_version_major='1', project_version_minor='5.7e', project_version_patch1='', project_version_patch1_source='', project_version_patch2='', project_version_patch2_source='', project_version_comment='Version Update 1.5.6->1.5.7e', project_version_date_applied=now() WHERE project_version_key = 'Zen-Cart Main';
UPDATE project_version SET project_version_major='1', project_version_minor='5.7e', project_version_patch1='', project_version_patch1_source='', project_version_patch2='', project_version_patch2_source='', project_version_comment='Version Update 1.5.6->1.5.7e', project_version_date_applied=now() WHERE project_version_key = 'Zen-Cart Database';
