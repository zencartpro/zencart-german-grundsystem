...
$min_cachePath = DIR_FS_CATALOG.'min/cache';
//$min_cachePath = 'C:\\Programming\\xampp\\htdocs\\fec\\min\\cache';
 ...
 */
if(DIR_WS_CATALOG != '/')
$min_documentRoot = str_replace(DIR_WS_CATALOG, '', DIR_FS_CATALOG);
else
$min_documentRoot = rtrim(DIR_FS_CATALOG, '/');
//$min_documentRoot = substr(__FILE__, 0, strlen(__FILE__) - 15);
//$min_documentRoot = $_SERVER['SUBDOMAIN_DOCUMENT_ROOT'];
//$serveOptions['minifierOptions'][Minify::TYPE_CSS]['prependRelativePath'] = '/fec/';
