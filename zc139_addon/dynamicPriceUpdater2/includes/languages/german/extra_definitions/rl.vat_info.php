...
// Für die meisten Templates
define('VAT_SHOW_TEXT','</span><br/><span class="taxAddon">zzgl. <a href="' . zen_href_link(FILENAME_SHIPPING) . '">Versandkosten</a></span>');

// Für ältere Templates
