 ...
 * @version $Id: ArraysLanguageLoader.php for newer plugins 2025-10-29 15:27:24Z webchills $
 */
...
class ArraysLanguageLoader extends BaseLanguageLoader
{
     ...
     * @since ZC v1.5.8
     */
    public function loadModuleDefinesFromArrayFile(string $language, string $fileName, string $module_type, string $templateDir = ''): array
    {
