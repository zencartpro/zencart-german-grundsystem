 ...
 * For the German Zen Cart Version we force at least PHP 8.0.x
 * @copyright Copyright 2003-2026 Zen Cart Development Team
 * Zen Cart German Version - www.zen-cart-pro.at
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: tpl_zc_phpupgrade_default.php  2026-05-02 07:39:17 webchills $
 */
  ...
  <div class="container">
    ...
    <div>
      <h2>Wir würden uns sehr freuen, wenn Sie die deutsche Zen Cart Version einsetzen, allerdings ist Ihr Server nicht mit unserer Software kompatibel.</h2>
        ...
        <p>Für die deutsche Zen Cart Version 1.5.7k ist mindestens PHP 8.0.x erforderlich.</p>
        <p>Geeignete PHP Versionen für diese Zen Cart Version sind PHP 8.4.x, 8.3.x, PHP 8.2.x oder PHP 8.0.x</p>
        <p>Um Zen Cart auf diesem Server weiterverwenden zu können, müssen Sie Ihre PHP Version aktualisieren.</p>
        <p>Wir empfehlen PHP 8.4.x zu verwenden. Die PHP Version können Sie normalerweise in der Serveradministration Ihres Providers umstellen.</p>
