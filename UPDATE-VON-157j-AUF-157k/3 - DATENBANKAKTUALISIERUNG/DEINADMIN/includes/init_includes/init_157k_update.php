...
// -----
// set Image Handler version to 5.3.6
// 
//
...
$db->Execute ("UPDATE ".TABLE_PROJECT_VERSION." SET project_version_major='1', project_version_minor='5.7k', project_version_patch1='', project_version_patch1_source='', project_version_patch2='', project_version_patch2_source='', project_version_comment='Version Update 1.5.7->1.5.7k', project_version_date_applied=now() WHERE project_version_key = 'Zen-Cart Main';");
...
//
$messageStack->add('Aktualisierung auf 1.5.7k deutsch erfolgreich abgeschlossen.<br/><b>WICHTIG:<br/>Bevor Sie nun irgendwohin clicken, löschen Sie erst folgende Dateien vom Server:<br/>DEINADMIN/includes/auto_loaders/config.157k_update.php<br/>DEINADMIN/includes/init_includes/init_157k_update.php', 'success'); 
}