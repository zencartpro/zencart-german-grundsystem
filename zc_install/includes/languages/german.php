...
define('ERROR_TEXT_DB_MYSQL5','MySQL 5 Support noch nicht vollständig getestet');
...
switch ($error_code) {
  ...
  case ('6'):
    ...
    define('POPUP_ERROR_TEXT', 'Das ist die Adresse zu Ihrem sicheren SSL Server. Diese Adresse hängt von auf Ihrem Webserver installierten SSL Modus ab. Sie können auf <a href="http://www.zen-cart.com/modules/xoopsfaq/index.php?cat_id=2#46" target="_blank">Zen Cart FAQ</a> mehr zum Thema SSL erfahren.');
  ...
  case ('21'):
    ...
    define('POPUP_ERROR_TEXT', 'Eine dauerhafte Verbindung ist eine Methode zur Reduzierung des Ladevorgangs der Datenbank. Sie sollten im Zweifelsfall Ihren Webhoster fragen, bevor Sie diese Einstellung aktivieren. Eine Aktivierung der Einstellung "dauerhafte Verbindung" kann zu Problemen in der Datenbank führen, wenn der Datenbankserver für diese Einstellung nicht konfiguriert wurde.<br /><br /> Daher noch einmal unser Rat: Sie sollten im Zweifelsfall Ihren Webhoster fragen, bevor Sie diese Einstellung aktivieren.');
    
  break;
  case ('22'):
    define('POPUP_ERROR_HEADING', 'Datenbanksitzung');
    define('POPUP_ERROR_TEXT', 'Diese Einstellung legt fest, ob Sitzungen (Sessions) in eine Datei oder in der Datenbank gespeichert werden sollen. Dateigespeicherte Sitzungen (Sessions) sind schneller, datenbankgespeicherte Sitzungen sind sicherer und empfiehlt sich bei Onlineshops mit sicherer SSL Verbindung.');
  ...
  case ('29'):
    ...
    define('POPUP_ERROR_TEXT', 'Eventuell haben Sie keine Berechtigung zum Erstellen einer leeren Datenbank. Setzen Sie sich bitte mit Ihrem Webhoster in Verbindung, um eventuell eine Datenbank für Sie zu erstellen zu lassen. Alternativ hält Ihr Webhoster cPanel oder phpMyAdmin zum Erstellen einer Datenbank für Sie bereit. Wenn Sie dann eine Datenbank erstellt haben, DEAKTIVIEREN Sie bitte die Option \'Datenbank erstellen\', um mit der Installation fortfahren zu können.');
