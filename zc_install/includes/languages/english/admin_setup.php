 ...
 */
  ...
  define('ADMIN_PASS_INSTRUCTION', 'Enter a <strong>TEMPORARY</strong> password to be used for your Zen Cart&trade; administrator account. You will be asked to change this password at first login.<br />Your password <strong>must contain both NUMBERS and LETTERS and minimum 7 characters.</strong>');
  ...
  define('ADMIN_EMAIL_INSTRUCTION', 'Enter the email address to be used for your Zen Cart&trade; administrator account. This will be used for testing newsletter emails and for sending password resets, etc.');
