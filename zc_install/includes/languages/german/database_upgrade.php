 ...
 * @version $Id: database_upgrade.php 75 2006-09-14 11:42:56Z wflohr $
 */
/**
...
define('TEXT_MAIN_2','<span class="emphasis">&Uuml;berpr&uuml;fen Sie sorgf&auml;ltig die nachstehenden Informationen, die aus der Datei "configure.php" ausgelesen wurden</span>.<br />' .
...
define('TEXT_DATABASE_PREFIX_CHANGE','Wenn Sie das Pr&auml;fix der Tabellen &auml;ndern wollen, geben Sie unten das neue Pr&auml;fix ein. <span class="emphasis"><br />HINWEIS: Bitte stellen Sie sicher, dass das neue Pr&auml;fix noch nicht in der Datenbank existiert</span>, da das Programm keine &Uuml;berpr&uuml;fung f&uuml;r doppelte Pr&auml;fixe durchf&uuml;hrt.');
define('TEXT_DATABASE_PREFIX_CHANGE_WARNING','<span class="errors"><strong>WARNUNG: &Auml;NDERN SIE DAS PR&Auml;FIX DER TABELLE ERST WENN SIE EINE SICHERUNG DER DATENBANK DURCHGEF&Uuml;HRT HABEN. Bei einem Fehler w&auml;hrend der &Auml;nderung m&uuml;ssen Sie ggf. eine Wiederherstellung der Datenbank durchf&uuml;hren.</strong></span>');
