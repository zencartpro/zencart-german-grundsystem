 ...
 * @version $Id: database_setup_default.php 729 2011-08-09 15:49:16Z hugo13 $
 */
...
?>
    ...
    <legend><?php echo DATABASE_INFORMATION; ?></legend>
      ...
      <?php echo DATABASE_CHARSET_INSTRUCTION . '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=14\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
       <br style="clear:both;" />
  <input type="hidden" id="db_type" name="db_type" value="mysql" />
   ...
   <label for="db_host"><?php echo DATABASE_HOST; ?></label>
     <?php echo DATABASE_HOST_INSTRUCTION. '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=15\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
   <br style="clear:both;" />
      <input type="text" id="db_host" name="db_host" tabindex="2" value="<?php echo DATABASE_HOST_VALUE; ?>" size="24" />
      <br style="clear:both;" /><hr/>
     <label for="db_username"><?php echo DATABASE_USERNAME; ?></label>
      <?php echo DATABASE_USERNAME_INSTRUCTION. '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=16\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
    <br style="clear:both;" />
      <input type="text" id="db_username" name="db_username" tabindex="3" value="<?php echo DATABASE_USERNAME_VALUE; ?>" size="24" />
      <br style="clear:both;" /><hr/>
    
     <label for="db_pass"><?php echo DATABASE_PASSWORD; ?></label>
     <?php echo DATABASE_PASSWORD_INSTRUCTION. '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=17\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
   <br style="clear:both;" />
      <input type="password" id="db_pass" name="db_pass" tabindex="4" size="24" />
      <br style="clear:both;" /><hr/>
     
    <label for="db_name"><?php echo DATABASE_NAME; ?></label>
     <?php echo DATABASE_NAME_INSTRUCTION. '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=18\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
       <br style="clear:both;" />
      <input type="text" id="db_name" name="db_name" tabindex="5" value="<?php echo DATABASE_NAME_VALUE; ?>" size="24" />
...
<?php if (!$is_upgrade || $zc_install->fatal_error) { //do not display prefix field if upgrading ... prefix can be edited on the database-upgrade page, next. ?>
     ...
     <label for="db_prefix"><?php echo DATABASE_PREFIX; ?></label>
      <?php echo DATABASE_PREFIX_INSTRUCTION. '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=19\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
   <br style="clear:both;" />
...
<br style="clear:both;" /><hr/>
 ...
 <label for="cache_type"><?php echo CACHE_TYPE; ?></label>
      <?php echo CACHE_TYPE_INSTRUCTION . '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=60\')"> ' . TEXT_HELP_LINK . '</a>'; ?>
     <br style="clear:both;" />
      <select id="cache_type" name="cache_type" tabindex="13">
        <option value="none"<?php echo setSelected('none', $_POST['cache_type']); ?>>Keine</option>
        <option value="file"<?php echo setSelected('file', $_POST['cache_type']); ?>>Datei</option>
        <option value="database"<?php echo setSelected('database', $_POST['cache_type']); ?>>Datenbank</option>
      </select>
       
    <br style="clear:both;" /><hr/>
          <label for="sql_cache_dir"><?php echo SQL_CACHE; ?></label>
     <?php echo SQL_CACHE_INSTRUCTION. '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=59\')"> ' . TEXT_HELP_LINK . '</a>'; ?>   
      <br style="clear:both;" />   
