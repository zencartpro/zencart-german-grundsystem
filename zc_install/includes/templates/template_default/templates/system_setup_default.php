 ...
 * @version $Id: system_setup_default.php 804 2011-11-23 08:28:24Z webchills $
 */
...
?>
    ...
    <div class="section">
      ...
      <p><?php echo NEWADMIN_PATH_INSTRUCTION . '<a href="javascript:popupWindow(\'popup_help_screen.php?error_code=96\')"> ' . TEXT_HELP_LINK . '</a>'; ?></p>
    </div>
    <div class="section">
