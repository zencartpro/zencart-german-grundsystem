...
('Verkaufsförderung (Kunden, die ... gekauft haben, haben auch ... gekauft)', 'MIN_DISPLAY_ALSO_PURCHASED', 43, 'Minimale Anzahl der anzuzeigenden Artikel in der Box "Kunden, die ... kauften, haben auch ... gekauft"', now(), now()),
...
('Einstellungen für Versandberechnung im Warenkorb anzeigen', 'SHOW_SHIPPING_ESTIMATOR_BUTTON', 43, '<br />0= AUS<br />1= Als Button im Warenkorb zeigen', now(), now()),
...
('Button "In den Warenkorb" anzeigen (0=nein; 1=ja)', 'PRODUCT_LIST_PRICE_BUY_NOW', 43, 'Wollen Sie den Button "In den Warenkorb" anzeigen?', now(), now()),
...
('Bild für Hauptkategorien anzeigen', 'PRODUCT_LIST_CATEGORIES_IMAGE_STATUS_TOP', 43, 'Wollen Sie die Bilder der Hauptkategorien in der Artikelliste anzeigen?', now(), now()),
...
('Währungssymbole für Text-Emails', 'CURRENCIES_TRANSLATIONS', 43, 'Welche Währungssymbole sollen für Text-Emails konvertiert werden?<br />Default = &pound;,EUR:&euro;,EUR', now(), now()),
...
('Warenkorb: Summe anzeigen', 'SHOW_TOTALS_IN_CART', 43, 'Soll die Summe unter dem Warenkorb angezeigt werden?<br />0= nein<br />1= ja<br />2= ja, kein Gewicht wenn 0', now(), now()),
...
VALUES ('LANGUAGE_VERSION 20100830', 'LANGUAGE_VERSION', '43', 'Deutsch');

REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(13, 'Show Category Counts', 'SHOW_COUNTS', 'false', 'Count recursively how many products are in each category', 1, 19, '2010-06-19 05:32:31', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(15, 'Display Prices with Tax', 'DISPLAY_PRICE_WITH_TAX', 'true', 'Display prices with tax included (true) or add the tax at the end (false)', 1, 21, '2010-06-19 05:32:50', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(16, 'Display Prices with Tax in Admin', 'DISPLAY_PRICE_WITH_TAX_ADMIN', 'true', 'Display prices with tax included (true) or add the tax at the end (false) in Admin(Invoices)', 1, 21, '2010-06-19 05:32:58', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(23, 'Show if version update available', 'SHOW_VERSION_UPDATE_IN_HEADER', 'true', 'Automatically check to see if a new version of Zen Cart is available. Enabling this can sometimes slow down the loading of Admin pages. (Displayed on main Index page after login, and Server Info page.)', 1, 44, '2010-06-19 05:33:20', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(29, 'HTML Editor', 'HTML_EDITOR_PREFERENCE', 'HTMLAREA', 'Please select the HTML/Rich-Text editor you wish to use for composing Admin-related emails, newsletters, and product descriptions', 1, 110, '2010-06-19 05:33:33', '2010-06-19 05:30:01', NULL, 'zen_cfg_pull_down_htmleditors(');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(31, 'Show Category Counts - Admin', 'SHOW_COUNTS_ADMIN', 'false', 'Show Category Counts in Admin?', 1, 19, '2010-06-19 05:32:43', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
# Ohne Defaulwerte fuer Suffix funktioniert Image Handler nicht
#REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(113, 'Product Info - Image Medium Suffix', 'IMAGE_SUFFIX_MEDIUM', '', 'Product Info Medium Image Suffix<br />Default = _MED', 4, 22, '2010-06-19 05:33:54', '2010-06-19 05:30:01', NULL, NULL);
#REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(114, 'Product Info - Image Large Suffix', 'IMAGE_SUFFIX_LARGE', '', 'Product Info Large Image Suffix<br />Default = _LRG', 4, 23, '2010-06-19 05:34:00', '2010-06-19 05:30:01', NULL, NULL);
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(130, 'Date of Birth', 'ACCOUNT_DOB', 'false', 'Display date of birth field during account creation and with account information<br />NOTE: Set Minimum Value Date of Birth to blank for not required<br />Set Minimum Value Date of Birth > 0 to require', 5, 2, '2010-06-19 05:34:44', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
# sinnvoll?
#REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(137, 'Show Newsletter Checkbox', 'ACCOUNT_NEWSLETTER_STATUS', '2', 'Show Newsletter Checkbox<br />0= off<br />1= Display Unchecked<br />2= Display Checked<br /><strong>Note: Defaulting this to accepted may be in violation of certain regulations for your state or country</strong>', 5, 45, '2010-06-19 05:38:24', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''0'', ''1'', ''2''), ');
# sinnvoll?
#REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(138, 'Customer Default Email Preference', 'ACCOUNT_EMAIL_PREFERENCE', '1', 'Set the Default Customer Default Email Preference<br />0= Text<br />1= HTML<br />', 5, 46, '2010-06-19 05:38:29', '2010-06-19 05:30:01', NULL, 'zen_cfg_select_option(array(''0'', ''1''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(202, 'Postal Code', 'SHIPPING_ORIGIN_ZIP', '1160', 'Enter the Postal Code (ZIP) of the Store to be used in shipping quotes. NOTE: For USA zip codes, only use your 5 digit zip code.', 7, 2, '2010-06-19 05:35:50', '2010-06-19 05:30:02', NULL, NULL);
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(213, 'Display Product Model', 'PRODUCT_LIST_MODEL', '1', 'Do you want to display the Product Model?', 8, 3, '2010-06-19 05:36:18', '2010-06-19 05:30:02', NULL, NULL);
#funktioniert auf den meisten Servern nicht - PHP waer besser
#REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(251, 'E-Mail Transport Method', 'EMAIL_TRANSPORT', 'sendmail-f', 'Defines the method for sending mail.<br /><strong>PHP</strong> is the default, and uses built-in PHP wrappers for processing.<br />Servers running on Windows and MacOS should change this setting to <strong>SMTP</strong>.<br /><br /><strong>SMTPAUTH</strong> should only be used if your server requires SMTP authorization to send messages. You must also configure your SMTPAUTH settings in the appropriate fields in this admin section.<br /><br /><strong>sendmail</strong> is for linux/unix hosts using the sendmail program on the server<br /><strong>"sendmail-f"</strong> is only for servers which require the use of the -f parameter to send mail. This is a security setting often used to prevent spoofing. Will cause errors if your host mailserver is not configured to use it.<br /><br /><strong>Qmail</strong> is used for linux/unix hosts running Qmail as sendmail wrapper at /var/qmail/bin/sendmail.', 12, 1, '2010-06-19 05:37:13', '2010-06-19 05:30:02', NULL, 'zen_cfg_select_option(array(''PHP'', ''sendmail'', ''sendmail-f'', ''smtp'', ''smtpauth'', ''Qmail''),');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(258, 'Use MIME HTML When Sending Emails', 'EMAIL_USE_HTML', 'true', 'Send e-mails in HTML format', 12, 3, '2010-06-19 05:37:24', '2010-06-19 05:30:02', NULL, 'zen_cfg_select_option(array(''true'', ''false''),');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(261, 'Email Archiving Active?', 'EMAIL_ARCHIVE', 'true', 'If you wish to have email messages archived/stored when sent, set this to "true".', 12, 6, '2010-06-19 05:37:35', '2010-06-19 05:30:02', NULL, 'zen_cfg_select_option(array(''true'', ''false''),');
# sinnvoll?
#REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(266, 'Email Admin Format?', 'ADMIN_EXTRA_EMAIL_FORMAT', 'HTML', 'Please select the Admin extra email format', 12, 12, '2010-06-19 05:37:47', now(), NULL, 'zen_cfg_select_option(array(''TEXT'', ''HTML''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(458, 'Confirm Terms and Conditions During Checkout Procedure', 'DISPLAY_CONDITIONS_ON_CHECKOUT', 'true', 'Show the Terms and Conditions during the checkout procedure which the customer must agree to.', 11, 1, '2010-06-19 05:38:59', '2010-06-19 05:30:03', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
REPLACE INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(459, 'Confirm Privacy Notice During Account Creation Procedure', 'DISPLAY_PRIVACY_CONDITIONS', 'true', 'Show the Privacy Notice during the account creation procedure which the customer must agree to.', 11, 2, '2010-06-19 05:39:06', '2010-06-19 05:30:03', NULL, 'zen_cfg_select_option(array(''true'', ''false''), ');
