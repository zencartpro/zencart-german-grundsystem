...
(NULL, 'CAPTCHA - Links Submit page', 'CAPTCHA_LINKS_SUBMIT', 'false', 'CAPTCHA Activate Validation on Links Submit page', @gid, 12, NOW(), NOW(),NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),'),
