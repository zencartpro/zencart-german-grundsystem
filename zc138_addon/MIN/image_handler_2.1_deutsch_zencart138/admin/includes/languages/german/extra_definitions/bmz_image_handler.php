 ...
 * @version $Id: bmz_image_handler.php,v 1.9 2008-12-13 14:10:10 webchills $
 */

define('BOX_TOOLS_IMAGE_HANDLER', 'Image Handler<sup>2</sup>');
define('ICON_IMAGE_HANDLER','Image Handler 2.1');
...
define('TABLE_HEADING_LARGE_SIZE','Grosses Bild');
...
define('TEXT_CLICK_TO_ENLARGE', 'Vergrössern');
...
define('TEXT_INFO_DEFAULT_IMAGE_HELP', 'Ein Hauptbild muss definiert sein. Das Hauptbild wird als kleinstes genommen, wenn mittlere und grosse Bilder angegeben werden.');
define('TEXT_INFO_CONFIRM_DELETE', "Löschen bestätigen;");
define('TEXT_INFO_CONFIRM_DELETE_SURE', 'Sind Sie sicher, dass Sie dieses Bild in allen verschiedenen Grössen löschen wollen?');
...
define('TEXT_MSG_DEFAULT_REQUIRED_FOR_RESIZE', 'Fehler: Für automatische Grössenanpassung wird ein Hauptbild benötigt.');
define('TEXT_MSG_NO_DEFAULT', 'Fehler: Es wurde kein Hauptbild angegeben.');
define('TEXT_MSG_FILE_EXISTS', 'Fehler: Die Datei existiert bereits! Bitter verändern Sie den Bildnamen oder das Suffix.');
...
define('TEXT_MSG_NOCREATE_LARGE_IMAGE_DIR', "Fehler: das Bildverzeichnis für grosse Bilder konnte nicht erstellt werden.");
...
define('TEXT_MSG_NOPERMS_LARGE_IMAGE_DIR', "Fehler: Die Berechtigungen des Bildverzeichnisses für grosse Bilder konnten nicht gesetzt werden.");

define('TEXT_MSG_NOUPLOAD_DEFAULT', "Das Hauptbild konnte nicht hochgeladen werden!");
define('TEXT_MSG_NORESIZE', "Die Grösse des Bildes konnte nicht verändert werden!");
define('TEXT_MSG_NOCOPY_LARGE', "Das grosse Bild konnte nicht kopiert werden!");
...
define('TEXT_MSG_NOPERMS_LARGE', "Die Berechtigungen für das grosse Bild konnten nicht gesetzt werden!");
...
define('TEXT_MSG_LARGE_DELETED', 'Grosses Bild gelöscht.');
define('TEXT_MSG_NO_DELETE_LARGE', 'Grosses Bild konnte nicht gelöscht werden.');
...
define('TEXT_MENU_ABOUT', 'Über');
define('TEXT_MENU_PREVIEW', 'Vorschau');
define('TEXT_MENU_ADMINISTRATION', 'Administration');
define('TEXT_MENU_MANAGER', 'Bildmanager');
