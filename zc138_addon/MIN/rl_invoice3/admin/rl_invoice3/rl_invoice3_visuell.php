...
<form id="form2" name="form2" method="post" action="rl_invoice3_ajax.php?p=formsave">
      ...
      <input class="xxx" name="RL_INVOICE3_ADDRESS1_POS[]" type="text" id="RL_INVOICE3_ADDRESS1_POS[]" value="0" />
      <input class="xxx" name="RL_INVOICE3_ADDRESS1_POS[]" type="text" id="RL_INVOICE3_ADDRESS1_POS[]" value="30" />
      <br />
      <label for="RL_INVOICE3_ADDRESS2_POS[]">RL_INVOICE3_ADDRESS2_POS</label>
      <input name="RL_INVOICE3_ADDRESS2_POS[]" type="text" id="RL_INVOICE3_ADDRESS2_POS[]" class="red" value="90" />
      <input name="RL_INVOICE3_ADDRESS2_POS[]" type="text" id="RL_INVOICE3_ADDRESS2_POS[]" class="red" value="36" />
      <br />
      <label for="RL_INVOICE3_DELTA[]">RL_INVOICE3_DELTA</label>
      <input name="RL_INVOICE3_DELTA[]" type="text" id="RL_INVOICE3_DELTA[]" value="20" />
      <input name="RL_INVOICE3_DELTA[]" type="text" id="RL_INVOICE3_DELTA[]" value="20" />
      <br />
      <label for="RL_INVOICE3_MARGIN[]">RL_INVOICE3_MARGIN</label>
      <input name="RL_INVOICE3_MARGIN[]" type="text" id="RL_INVOICE3_MARGIN[]" value="25" />
      <input name="RL_INVOICE3_MARGIN[]" type="text" id="RL_INVOICE3_MARGIN[]" value="10" />
      <input name="RL_INVOICE3_MARGIN[]" type="text" id="RL_INVOICE3_MARGIN[]" value="30" />
      <input name="RL_INVOICE3_MARGIN[]" type="text" id="RL_INVOICE3_MARGIN[]" value="20" />
      <br />
      <label for="RL_INVOICE3_PAPER[]">RL_INVOICE3_PAPER</label>
      <input name="RL_INVOICE3_PAPER[]" type="text" id="RL_INVOICE3_PAPER[]" value="A4" />
      <input name="RL_INVOICE3_PAPER[]" type="text" id="RL_INVOICE3_PAPER[]" value="mm" />
      <input name="RL_INVOICE3_PAPER[]" type="text" id="RL_INVOICE3_PAPER[]" value="P" />
      <br />
      ...
      <input name="RL_INVOICE3_ADDRESS_WIDTH[]" type="text" id="RL_INVOICE3_ADDRESS_WIDTH[]" class="red" value="80" />
      <input name="RL_INVOICE3_ADDRESS_WIDTH[]" type="text" id="RL_INVOICE3_ADDRESS_WIDTH[]" class="red" value="60" />
      <br />
      <br />
