        ...
        if (!defined('RL_INVOICE3_SEND_ORDERSTATUS_CHANGE')) {
            ...
            if ($multi) {
               ...
               $confArrMultiAdd = array(
                                    'RL_INVOICE3_ADDRESS1_POS' => "('RL_INVOICE3_ADDRESS1_POS', 43, 'XY-postion der adresse1', 'XY-postion der adresse1; es ist das delta zu den raendern einzugeben<br />Standard: 0|30')", 
                                    'RL_INVOICE3_ADDRESS2_POS' => "('RL_INVOICE3_ADDRESS2_POS', 43, 'XY-postion der adresse2', 'XY-postion der adresse2; es ist das delta zu den raendern einzugeben<br />Standard: 0|30')",
                                    ...
                                    'RL_INVOICE3_FONTS' => "('RL_INVOICE3_FONTS', 43, 'Schriftarten für Rechnung und Artikel', 'Welche Schriftarten wollen Sie verwenden? <br />1. Für Rechnungstexte <br >2. Für Artikel & Summe<br /><br />Standart: dejavusanscondensed|freemono<br />(Pfad/und Schriftart für Rechnung|Pfad/und Schriftart für Artikel+Summe<br />')", 
                                    'RL_INVOICE3_LINE_HEIGT' => "('RL_INVOICE3_LINE_HEIGT', 43, 'Zeilenhöhe', 'soll Rechnung bei Gratisprodukt dem Mail hinzugefügt werden')", 
                                    'RL_INVOICE3_LINE_THICK' => "('RL_INVOICE3_LINE_THICK', 43, 'dicke der TotalStriche', 'wie dick soll der Strich bei der Gesamtsumme sein')", 
                                    ...
                                    'RL_INVOICE3_NOT_NULL_INVOICE' => "('RL_INVOICE3_NOT_NULL_INVOICE', 43, 'Rechnung bei Gratisprodukt', 'soll Rechnung bei Gratisprodukt dem Mail hinzugefügt werden')", 
                                    'RL_INVOICE3_ORDERSTATUS' =>  "('RL_INVOICE3_ORDERSTATUS', 43, 'Rechnungsversand bei Bestellstatus', 'Rechnung nur mitshicken, wenn der Bestellstatus grösser/gleich ist [default: 3 == verschickt]')", 
                                    ...
                                    'RL_INVOICE3_PAPER' => "('RL_INVOICE3_PAPER', 43, 'papiergroesse|einheit|orientierung', '1. papiergroesse = A3|A4|A5|Letter|Legal <br />2. einheit: pt|mm|cm|inch <br />3. orientierung: L|P<br />')", 
                                    ...
                                    'RL_INVOICE3_SEND_PDF' => "('RL_INVOICE3_SEND_PDF', 43, 'Rechnung bei Bestellung', 'soll Rechnung bei Bestellung gesendet werden')", 
                                    'RL_INVOICE3_TABLE_TEMPLATE' => "('RL_INVOICE3_TABLE_TEMPLATE', 43, 'Template für Artikel- und Summentabelle', 'Template für Artikel- und Summentabelle<br />Definition ist in rl_invoice3_def.php<br />Standard: 30|30|30|60<br />Standard: col_templ_1|options_templ_1|total_col_1|total_opt_1<br />')",
