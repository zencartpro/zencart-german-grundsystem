...
//      $height = min($height, intval(MEDIUM_IMAGE_HEIGHT)); 
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' .
        ...
        . zen_image_button('button_new_file.gif', IMAGE_NEW_FILE) . '</a>');
...
<div class="aboutbox">
<p>
  <h2>Image Handler 2.2 for Zen-Cart 1.3.8 german</h2>
</p>
<p>
Image Handler 2.2 for Zen-Cart 1.3.8 german is based on Image Handler<sup>2</sup>, Rev. 8<br/>
...
2.2 was modified by <a href="http://www.webchills.at/">webchills</a> to use the multilanguage admin functionality in Zen-Cart 1.3.8 german
</p>
</div>
</div>
<?php
