...
('Speicherort und -Name der PDF-Datei', 'RL_INVOICE_PDF_PATH', 43, '1. Wie sollen PDF-Dateien gespeichert werden?<br />Standard: ../pdf/|1rnrn<br />', '2004-10-04 00:01:00', '2004-10-04 00:01:00'),
...
('Fusszeile der Rechnung', 'RL_INVOICE_FOOTER', 43, 'Was soll in der Fusszeile der Rechnung angezeigt werden?<br /><br />Beispiel:<br />Alle Waren bleiben bis zur vollständigen Bezahlung Eigentum der Fa. FiloSoFisch. Bankverbindung: BankAustria-Creditanstalt: BLZ 12000, KtoNr: 52014 127 901 UID: ATU55705801|8|#|25<br />', '2004-10-04 00:01:00', '2004-10-04 00:01:00'),
...
('Template für Artikel- und Summentabelle', 'RL_INVOICE_TABLE_TEMPLATE', 43, 'Template für Artikel- und Summentabelle<br />Definition ist in rl_invoice_def.php<br />Weitere Hilfe erhalten Sie in docs/rl_invoice/readme_ezpdf.pdf<br />Standard: col_templ_1|options_templ_1|total_col_1|total_opt_1<br />', '2004-10-04 00:01:00', '2004-10-04 00:01:00'),
('Papiergrösse und Ausrichtung', 'RL_INVOICE_PAPER', 43, '1. Papiergösse: ISO-Norm (A4, A5,..) + US (legal,...)<br />2. Ausrichtung: portrait ODER landscape<br />Standard: A4|portrait<br />', '2004-10-04 00:01:00', '2004-10-04 00:01:00'),
