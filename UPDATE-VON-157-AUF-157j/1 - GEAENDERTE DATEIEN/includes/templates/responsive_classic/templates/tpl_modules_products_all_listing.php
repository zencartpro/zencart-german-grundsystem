 ...
 * @version $Id: tpl_modules_products_all_listing 2024-01-10 07:32:58Z webchills $
 */
?>
  ...
  if ($products_all_split->number_of_rows > 0) {
    ...
    while (!$products_all->EOF) {
      ...
      if (PRODUCT_ALL_LIST_MODEL != '0' and zen_get_show_product_switch($products_all->fields['products_id'], 'model')) {
        $display_products_model = '<b>' . TEXT_PRODUCT_MODEL . '</b>' . $products_all->fields['products_model'] . str_repeat('<br>', substr(PRODUCT_ALL_LIST_MODEL, 3, 1));
      } else {
      ...
      if (PRODUCT_ALL_LIST_DATE_ADDED != '0' and zen_get_show_product_switch($products_all->fields['products_id'], 'date_added')) {
        $display_products_date_added = '<b>' . TEXT_DATE_ADDED_LISTING . '</b> ' . zen_date_long($products_all->fields['products_date_added']) . str_repeat('<br>', substr(PRODUCT_ALL_LIST_DATE_ADDED, 3, 1));
      } else {
