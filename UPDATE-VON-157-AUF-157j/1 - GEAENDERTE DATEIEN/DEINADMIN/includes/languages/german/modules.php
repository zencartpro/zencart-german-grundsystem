...
define('TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED', 'ALARM: Ihre Admineinstellungen in ' . STORE_NAME . ' wurden geändert.');
define('TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED', 'Dies ist eine automatische E-Mail von ' . STORE_NAME . ', um Sie auf eine vorgenommene Änderung in Ihren administrativen Einstellungen hinzuweisen: ' . "\n\n" . 'HINWEIS: Für das Modul [%s] wurden die Einstellungen verändert, die Änderung erfolgte durch den Admin Benutzer %s.' . "\n\n" . 'Wenn Sie diese Änderung nicht veranlasst haben, ist es empfehlenswert diese sofort zu überprüfen.' . "\n\n" . 'Sollten Sie bereits Kenntnis über diese Änderungen haben, dann ignorieren Sie diese automatisch generierte E-Mail.');
define('TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED', 'Dies ist eine automatische E-Mail von ' . STORE_NAME . ', um Sie auf eine vorgenommene Änderung in Ihren administrativen Einstellungen hinzuweisen: ' . "\n\n" . 'HINWEIS: Das Modul [%s] wurde von dem Admin Benutzer %s installiert.' . "\n\n" . 'Wenn Sie diese Änderung nicht veranlasst haben, ist es empfehlenswert diese sofort zu überprüfen.' . "\n\n" . 'Sollten Sie bereits Kenntnis über diese Änderungen haben, dann ignorieren Sie diese automatisch generierte E-Mail.');
define('TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED', 'Dies ist eine automatische E-Mail von ' . STORE_NAME . ', um Sie auf eine vorgenommene Änderung in Ihren administrativen Einstellungen hinzuweisen: ' . "\n\n" . 'HINWEIS: Das Modul [%s] wurde von dem Admin Benutzer %s entfernt.' . "\n\n" . 'Wenn Sie diese Änderung nicht veranlasst haben, ist es empfehlenswert diese sofort zu überprüfen.' . "\n\n" . 'Sollten Sie bereits Kenntnis über diese Änderungen haben, dann ignorieren Sie diese automatisch generierte E-Mail.');
