...
* @version $Id: index.php 2023-10-29 20:54:50Z webchills $
 */


define('TEXT_GREETING_GUEST', 'Willkommen <span class="greetUser">Gast!</span> Wollen Sie sich <a href="%s">anmelden</a>?');

define('TEXT_GREETING_GUEST_SHOWCASE', 'Willkommen! Bitte genießen Sie unseren Schauraum.');
...
define('HEADING_TITLE_NESTED', 'Willkommen in unserem Online Shop!');