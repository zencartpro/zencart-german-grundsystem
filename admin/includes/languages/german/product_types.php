...
define('TEXT_DELETE_PRODUCTS', 'Sollen die Artikel von diesem Artikeltyp gelöscht werden? (Beinhaltet auch Artikelvorschau, Sonderangebote und Artikel Neuerscheinungen)');
