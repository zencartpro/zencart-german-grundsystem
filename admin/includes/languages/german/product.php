...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', 'Sonderangebote, Artikel/Download ben&ouml;tigt eine Lieferadresse');
...
define('TEXT_COPY_DISCOUNTS_ONLY', 'Wird nur f&uuml;r doppelte Artikel mit Erm&auml;&szlig;igung verwendet ...');
define('TEXT_COPY_DISCOUNTS', 'Erm&auml;&szlig;igung zum Duplikat kopieren?');
...
define('TEXT_COPY_ATTRIBUTES_DELETE', '<strong>L&ouml;schen</strong> - Die vorhandenen Attribute werden gel&ouml;scht, bevor die neue Attribute kopiert werden');
define('TEXT_COPY_ATTRIBUTES_UPDATE', '<strong>Aktualisieren</strong> - Die vorhanden Attribute werden mit den neuen Einstellungen/Preise aktualisiert, bevor die neuen Attribute hinzuf&uuml;gt werden');
define('TEXT_COPY_ATTRIBUTES_IGNORE', '<strong>Ignorieren</strong> - Es werden nur neue Attribute hinzuf&uuml;gt');
...
define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_PREVIEW', '*Der angezeigte Preis enth&auml;lt den niedrigsten Gruppenattributspreis plus dem Grundpreis');
define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_EDIT', '*Der angezeigte Preis enth&auml;lt den niedrigsten Gruppenattributspreis plus dem Grundpreis');
...
// meta tags
define('TEXT_META_TAG_TITLE_INCLUDES', '<strong>W&auml;hlen Sie aus, welche Informationen die Metatags des Artikels enthalten sollen:</strong>');
