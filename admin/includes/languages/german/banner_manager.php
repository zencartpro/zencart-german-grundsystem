...
define('TEXT_BANNERS_HTML_TEXT_INFO', '<strong>NOTE: HTML-Banners zeichnen die klicks nicht auf</strong>');
define('TEXT_BANNERS_HTML_TEXT', 'HTML Text:');
define('TEXT_BANNERS_ALL_SORT_ORDER', 'Sortierfolge - banner_box_all');
define('TEXT_BANNERS_ALL_SORT_ORDER_INFO', '<strong>Anmerkung: Die banners_box_all sidebox zeigt die Banner in der Sortierfolge an</strong>');
...
define('SUCCESS_BANNER_ON_SSL_UPDATED', 'Erfolg: Der Status des Banners zum Darstellen auf SSL ist aktualisiert worden .');
