...
define('TEXT_PRODUCTS_MIXED_DISCOUNT_QUANTITY', 'Stückzahlermä&szlig;igung gilt für gemischte Attribute');
...
define('TEXT_FEATURED_PRODUCTS_STATUS', 'Status ähnlicher Artikel:');
...
define('TEXT_INFO_HEADING_DELETE_FEATURED', 'ähnliche Artikel löschen');
define('TEXT_INFO_DELETE_INTRO', 'Sind Sie sicher, dass Sie diesen Status löschen wollen?');
define('TEXT_ATTRIBUTES_INSERT_INFO', '<strong>Definieren Sie die Einstellungen der Attribute und klicken anschlie&szlig;end auf Einfügen, um die änderungen wirksam zu machen</strong>');
...
define('TEXT_PRODUCTS_DISCOUNT','Ermä&szlig;igung');
define('TEXT_PRODUCTS_DISCOUNT_QTY','Mindeststückzahl');
define('TEXT_PRODUCTS_DISCOUNT_PRICE','Ermä&szlig;igungswert');
...
define('TEXT_DISCOUNT_TYPE_INFO', 'Artikelermä&szlig;igung Info');
define('TEXT_DISCOUNT_TYPE','Ermä&szlig;igungstyp:');
define('TEXT_DISCOUNT_TYPE_FROM', 'Ermä&szlig;igungspreis von:');
