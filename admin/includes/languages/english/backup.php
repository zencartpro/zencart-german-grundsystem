...
define('TEXT_INFO_USE_BZIP', 'Use BZIP2');
define('TEXT_INFO_USE_NO_COMPRESSION', 'No Compression (Pure SQL)');
define('TEXT_INFO_SAVE_ONLY', 'Save on Server only');
define('TEXT_INFO_DOWNLOAD_AND_SAVE', 'Download and Save on Server');
...
define('ERROR_DECOMPRESSOR_NOT_AVAILABLE', 'Error: No suitable decompressor is available.');
...
define('TEXT_BACKUP_UNCOMPRESSED', 'Backup file has been uncompressed: ');
?>