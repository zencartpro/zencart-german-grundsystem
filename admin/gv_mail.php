...
<?php if (EMAIL_USE_HTML == 'true') {?>
              <tr>
                ...
                <td><?php echo zen_draw_textarea_field('message_html', 'soft', '100%', '20', ($_POST['message_html']=='') ? TEXT_GV_ANNOUNCE : stripslashes($_POST['message_html']), 'id="message_html" class="editorHook"'); ?></td>
              </tr>
<?php } ?>
              <tr>
