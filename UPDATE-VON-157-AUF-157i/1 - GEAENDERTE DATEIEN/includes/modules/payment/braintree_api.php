<?php
/**
 * @package Braintree SCA for Zen Cart German 1.5.7i and PHP 8.2.x/8.3.x
 * Zen Cart German Specific
 * based on braintree_web 3.111.1 and braintree_php 6.21.0 (November 2024)
 * @copyright Copyright 2018-2021 Numinix
 * @copyright Copyright 2003-2024 Zen Cart Development Team
 * Zen Cart German Version - www.zen-cart-pro.at
 * @copyright Portions Copyright 2003 osCommerce
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: braintree_api.php 2024-11-03 18:35:14 webchills $
*/
    ...
    function selection() {
        ...
        $fieldsArray[] = [
            'field' => "
                ...
                <script src='https://js.braintreegateway.com/web/3.111.1/js/client.min.js'></script>
                <script src='https://js.braintreegateway.com/web/3.111.1/js/three-d-secure.min.js'></script>
                <script src='https://js.braintreegateway.com/web/3.111.1/js/hosted-fields.min.js'></script> 
                <script>
                    let hf, threeDS;
