...
$result = $db->Execute("SELECT project_version_minor FROM " . TABLE_PROJECT_VERSION . " WHERE project_version_key = 'Zen-Cart Main'");
if ($result->fields['project_version_minor'] == '5.7g'){
