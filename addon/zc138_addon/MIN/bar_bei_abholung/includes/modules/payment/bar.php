...
// +----------------------------------------------------------------------+
// $Id: bar.php 294 2008-12-13 11:40:20Z webchills $
//
...
// www.zen-cart.at r.l. languages_id==43 START
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Bar bei Abholung', 'MODULE_PAYMENT_BAR_STATUS', '43', 'Wollen Sie Barzahlung bei Abholung aktivieren?', now())");
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION_LANGUAGE   . " (configuration_title, configuration_key, configuration_language_id, configuration_description, date_added) values ('Zone', 'MODULE_PAYMENT_BAR_ZONE', '43', 'Wenn eine Zone ausgewählt wird, ist diese Bezahlart nur in dieser Zone aktiviert.', now())");
