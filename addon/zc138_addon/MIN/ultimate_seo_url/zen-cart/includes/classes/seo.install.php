	...
	class SEO_URL_INSTALLER{	
		...
		function SEO_URL_INSTALLER() {
			...
			$this->default_config['SEO_ADD_CPATH_TO_PRODUCT_URLS'] = array(
				'DEFAULT' => 'false',
				'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES (NULL, 'Kategorienummer als cPath an die Produktlinks anhängen?', 'SEO_ADD_CPATH_TO_PRODUCT_URLS', 'false', 'Kategorienummer wird als cPath angehängt (z.B. - some-product-p-1.html?cPath=xx).', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'zen_cfg_select_option(array(''true'', ''false''),')"
			);
			$x++;

			$this->default_config['SEO_ADD_CAT_PARENT'] = array(
				'DEFAULT' => 'true',
				'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES (NULL, 'Oberkategorienamen am Anfang der Kategorielinks anzeigen?', 'SEO_ADD_CAT_PARENT', 'true', 'Übergeordnete Kategorie wird in Kategorielinks angezeigt (z.B. - parent-category-c-1.html).', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'zen_cfg_select_option(array(''true'', ''false''),')"
			);
			$x++;
			...
			$this->default_config['USE_SEO_REDIRECT'] = array(
				'DEFAULT' => 'true',
				'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES (NULL, 'Automatische Redirects aktivieren?', 'USE_SEO_REDIRECT', 'true', 'Automatischen Redirect aktivieren? 301 Header wird für alte an neue URLs uebermittelt.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'zen_cfg_select_option(array(''true'', ''false''),')"
			);
			$x++;

			$this->default_config['SEO_REWRITE_TYPE'] = array(
				'DEFAULT' => 'Rewrite',
				'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES (NULL, 'URL Rewrite Typ festlegen', 'SEO_REWRITE_TYPE', 'Rewrite', 'Welches SEO URL Format soll genutzt werden? (Derzeit wird nur Rewrite unterstützt!)', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'zen_cfg_select_option(array(''Rewrite''),')"
			);
			$x++;
