  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <td align="right" valign="bottom"><input type="button" id="defaults" value="<?php echo BUTTON_LOAD_DEFAULTS; ?>" onclick="populate_search(true);"></input></td>
        <td align="right" valign="bottom">
          <table border="0" cellspacing="0" cellpadding="2"><tr>
            <td align="left" class="smallText"><?php echo zen_draw_checkbox_field('new_window', '1', false) . CHECKBOX_NEW_WINDOW; ?><p><input type="button" id="btn_submit" value="<?php echo BUTTON_SEARCH; ?>" onclick="form_check();"></td>
          </tr></table>
        </td>
      </tr>
    </table>
