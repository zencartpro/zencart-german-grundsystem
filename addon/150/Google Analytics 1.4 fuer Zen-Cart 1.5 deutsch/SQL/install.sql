##########################################################################
# Google Analytics 1.4 Multilanguage Install 1.5 - 2011-09-17 - webchills
##########################################################################
...
('Google Analytics', 'Configure Google Analytics', '1', '1');
...
(@gid, 43, 'Google Analytics', 'Konfiguration von Google Analytics', '1', '1');
...
VALUES ('configProdGoogleAnalytics','BOX_CONFIGURATION_PRODUCT_GOOGLEANALYTICS','FILENAME_CONFIGURATION',CONCAT('gID=',@gid),'configuration','Y',@gid);
