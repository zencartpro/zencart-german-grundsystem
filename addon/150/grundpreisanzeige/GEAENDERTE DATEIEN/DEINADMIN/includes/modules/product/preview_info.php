 ...
 * @version $Id: preview_info.php for base unit price ZC150 2011-11-29 20:54:10Z webchills $
 */
...
// changed for base unit price 2006-05-20 CCS-cart #joco
...
($pInfo->products_base_unit_price > 0 ? '<span class="main">' . '<br />' . TEXT_PRODUCTS_BASE_UNIT_PRICE . ' ' . $currencies->format(zen_round($pInfo->products_base_unit_price,3)) . '/' . $pInfo->products_base_unit . '</span>' : '')  . 
($pInfo->products_virtual == 1 ? '<span class="errorText">' . '<br />' .   TEXT_VIRTUAL_PREVIEW . '</span>' : '') . 
($pInfo->product_is_always_free_shipping == 1 ? '<span class="errorText">' . '<br />' . TEXT_FREE_SHIPPING_PREVIEW . '</span>' : '') . 
($pInfo->products_priced_by_attribute == 1 ? '<span class="errorText">' . '<br />' . TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_PREVIEW . '</span>' : '') . 
											($pInfo->product_is_free == 1 ? '<span class="errorText">' . '<br />' . TEXT_PRODUCTS_IS_FREE_PREVIEW . '</span>' : '') . 
											($pInfo->product_is_call == 1 ? '<span class="errorText">' . '<br />' . TEXT_PRODUCTS_IS_CALL_PREVIEW . '</span>' : '') . 
											($pInfo->products_qty_box_status == 0 ? '<span class="errorText">' . '<br />' . TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW . '</span>' : '') . 
											($pInfo->products_priced_by_attribute == 1 ? '<br />' . zen_get_products_display_price($_GET['pID']) : ''); 
