 ...
 * @version $Id: collect_info.php for base unit price ZC150 2011-11-29 21:50:10Z webchills $
 */
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    $parameters = array('products_name' => '',
                       ...
                       'products_image' => '',
                       'products_price' => '',
// add for base unit price 2006-05-20 #joco
...
// changed for base unit price 2006-05-20 #joco
...
<?PHP // add for base unit price 2006-05-24 #joco ?>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_BASE_UNIT_PRICE; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_base_unit_price', $pInfo->products_base_unit_price, '') . '&nbsp;' . TEXT_PRODUCTS_BASE_UNIT_PRICE_INFO; ?></td>
          </tr>
          <tr bgcolor="#ebebff">
            <td class="main"><?php echo TEXT_PRODUCTS_BASE_UNIT; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_base_unit', $pInfo->products_base_unit, '') . '&nbsp;' . TEXT_PRODUCTS_BASE_UNIT_INFO; ?></td>
          </tr>
<?PHP // end base unit price ?>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          <tr>
