 ...
 * @version $Id: bmz_image_handler.php 2012-04-04 18:46:5 webchills $
 */

define('BOX_TOOLS_IMAGE_HANDLER', 'Image Handler<sup>4</sup>');
define('ICON_IMAGE_HANDLER','Image Handler 4');
...
define('IH_ABOUT_DOKU','<h2>Image Handler<sup>4</sup> v4.0 für Zen-Cart 1.5 deutsch</h2>

<p>
Image Handler<sup>4</sup> v4.0 für Zen-Cart 1.5 deutsch basiert auf der Grundentwicklung von Tim Kröger.<br /></p>
<fieldset>
