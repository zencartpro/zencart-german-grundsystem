 ...
 * @version $Id: orders.php for COWOA 3.0 ZC150 2011-11-28 09:12:25Z webchills $
 */
...
define('EMAIL_TEXT_COWOA_URL', 'Check order status:');
define('EMAIL_TEXT_COWOA_URL_CLICK', 'Click here to check the status of your order.');
