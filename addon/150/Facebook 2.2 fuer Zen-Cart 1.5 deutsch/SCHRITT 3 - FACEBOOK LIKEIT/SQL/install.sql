...
('Method', 'FACEBOOK_LIKE_BUTTON_METHOD', 'iframe', 'Use the iframe or XBFML method?', @gid, 2, NOW(), NOW(), NULL, 'zen_cfg_select_option(array(\'iframe\', \'XBFML\'),'),
...
VALUES ('configProdFacebookLikeIt','BOX_CONFIGURATION_PRODUCT_FACEBOOKLIKEIT','FILENAME_CONFIGURATION',CONCAT('gID=',@gid),'configuration','Y',@gid);
