...
?>
          ...
          ?>
              <tr bgcolor="#ebebff">
                ...
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_a_price', $pInfo->products_group_a_price, 'onKeyUp="updateGross()"'); ?></td>
              </tr>
              <tr bgcolor="#ebebff">
                <td class="main"><?php echo TEXT_PRODUCTS_GROUP_A_PRICE_GROSS; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_a_price_gross', $pInfo->products_group_a_price, 'OnKeyUp="updateNet()"'); ?></td>
              </tr>
          <?php
            }
            if ($group == GROUP_PRICE_PER_ITEM2) {
          ?>
              <tr bgcolor="#ebebff">
                ...
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_b_price', $pInfo->products_group_b_price, 'onKeyUp="updateGross()"'); ?></td>
              </tr>
              <tr bgcolor="#ebebff">
                <td class="main"><?php echo TEXT_PRODUCTS_GROUP_B_PRICE_GROSS; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_b_price_gross', $pInfo->products_group_b_price, 'OnKeyUp="updateNet()"'); ?></td>
              </tr>
          <?php
            }
            if ($group == GROUP_PRICE_PER_ITEM3) {
          ?>
              <tr bgcolor="#ebebff">
                ...
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_c_price', $pInfo->products_group_c_price, 'onKeyUp="updateGross()"'); ?></td>
              </tr>
              <tr bgcolor="#ebebff">
                <td class="main"><?php echo TEXT_PRODUCTS_GROUP_C_PRICE_GROSS; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_c_price_gross', $pInfo->products_group_c_price, 'OnKeyUp="updateNet()"'); ?></td>
              </tr>
          <?php
            }
            if ($group == GROUP_PRICE_PER_ITEM4) {
          ?>
              <tr bgcolor="#ebebff">
                ...
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_d_price', $pInfo->products_group_d_price, 'onKeyUp="updateGross()"'); ?></td>
              </tr>
              <tr bgcolor="#ebebff">
                <td class="main"><?php echo TEXT_PRODUCTS_GROUP_D_PRICE_GROSS; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_group_d_price_gross', $pInfo->products_group_d_price, 'OnKeyUp="updateNet()"'); ?></td>
              </tr>
          <?php
            }
          }
