 ...
 * @version $Id: header_php.php for UID 2.1 2013-10-02 06:33:29Z webchills $
 */
...
// UID BEGIN 
	if (ACCOUNT_COMPANY == 'true') $sql_data_array[] = array('fieldName'=>'entry_tva_intracom', 'value'=>$uid, 'type'=>'string');
// UID END
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
  $entry_query = "SELECT entry_gender, entry_company, entry_tva_intracom, entry_firstname, entry_lastname,
                  ...
                  AND    address_book_id = :addressBookID"; // UID
