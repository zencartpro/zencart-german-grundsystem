 ...
 * @version $Id: collect_info.php for Google Merchant Center 3.2 2013-10-16 08:14:41Z webchills $
 */
...
?>
          ...
          <tr>
           ...
           <tr bgcolor="#DDEACC">
            <td class="main"><?php echo TEXT_ADDITIONAL_FIELDS_MERCHANT_CENTER; ?></td>
            <td class="main"></td>
          </tr>
         <tr bgcolor="#DDEACC">
            <td class="main"><?php echo TEXT_PRODUCTS_EAN; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_ean', htmlspecialchars(stripslashes($pInfo->products_ean), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_ean')); ?></td>
          </tr>
          <tr bgcolor="#DDEACC">
            <td class="main"><?php echo TEXT_PRODUCTS_ISBN; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_isbn', htmlspecialchars(stripslashes($pInfo->products_isbn), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_isbn')); ?></td>
          </tr>
           <tr bgcolor="#DDEACC">
          ...
          <tr bgcolor="#DDEACC">
            ...
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_taxonomy', htmlspecialchars(stripslashes($pInfo->products_taxonomy), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_taxonomy','140'));  ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
