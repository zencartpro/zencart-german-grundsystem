 ...
 * @version $Id: copy_to_confirm.php for GMCDE 3.2 2013-10-16 07:44:02Z webchills $
 */
...
// Copy attributes to duplicate product
          ...
          if ($_POST['copy_as'] == 'link') {
            ...
            $product = $db->Execute("select products_type, products_quantity, products_model, products_image,
                                            ...
                                            products_tax_class_id, manufacturers_id, products_ean, products_isbn, products_condition, products_availability, products_brand, products_taxonomy,
            ...
            $db->Execute("insert into " . TABLE_PRODUCTS . "
                                      (products_type, products_quantity, products_model, products_image,
                                       ...
                                       manufacturers_id, products_ean, products_isbn, products_condition, products_availability, products_brand, products_taxonomy,
                                       products_quantity_order_min, products_quantity_order_units, products_priced_by_attribute,
                                       product_is_free, product_is_call, products_quantity_mixed,
                                       product_is_always_free_shipping, products_qty_box_status, products_quantity_order_max, products_sort_order,
                                       products_price_sorter, master_categories_id
                          ...
                          values ('" . zen_db_input($product->fields['products_type']) . "',
                                  ...
                                  '" . zen_db_input($product->fields['products_ean']) . "',
                                  '" . zen_db_input($product->fields['products_isbn']) . "',
                                  '" . (int)$product->fields['products_conditions'] . "',
								  '" . (int)$product->fields['products_availability'] . "',
                                  '" . zen_db_input($product->fields['products_brand']) . "',
								  '" . zen_db_input($product->fields['products_taxonomy']) . "',
