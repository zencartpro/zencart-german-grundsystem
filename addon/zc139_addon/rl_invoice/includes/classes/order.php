...
class order extends base {
  ...
  function query($order_id) {
    ...
    // r.l. EOF rl_invoice3
    $this->info = array_merge($this->info, setDelivery());
    // r.l. EOF rl_invoice3
...
*/
  ...
  function create($zf_ot_modules, $zf_mode = 2) {
    ...
    // r.l. BOF rl_invoice3
    $sql_data_array = array_merge($sql_data_array, setDelivery());
    // r.l. EOF rl_invoice3
...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode) {
    ...
    if($this->info['order_status'] == 100){ // r.l. nur bei rechnung eine mail an kunden
