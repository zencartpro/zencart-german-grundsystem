...
//Ende
  ...
  define('MODULE_PAYMENT_INVOICE_TEXT_EMAIL_FOOTER', 'Bitte überweisen Sie den Betrag nach Erhalt der Ware unter Angabe der Bestellnummer bis zum ' . $tag . ' auf unser Konto: ' . MODULE_PAYMENT_INVOICE_PAYTO . "\n\n" . 'Vielen Dank!');
