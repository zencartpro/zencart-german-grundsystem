 ...
 * Version 2.1 for Zen-Cart 1.3.9 german 2010-10-22 webchills
 */
    ...
    zen_draw_hidden_field('currency', $currency) .
      ...
      function before_process() {
		...
		if ( isset($_REQUEST['wafMerchMessage']) && trim($_REQUEST['wafMerchMessage']) != '') {
			$order->info['payment_method'] = '** Credit Card via WorldPay **';
			$this->title = '** Credit Card via WorldPay **';
