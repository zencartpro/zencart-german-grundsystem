...
?>
         ...
         <tr bgcolor="#DDEACC">
          ...
          <tr bgcolor="#DDEACC">
            ...
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_taxonomy', htmlspecialchars(stripslashes($pInfo->products_taxonomy), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_taxonomy', '120'));  ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
