 ...
 * @version $Id: specials.php for group pricing 2.2 2011-11-24 08:20:46Z webchills $
 */
...
// BEGIN modified for Group Pricing per item v1.3.3 add-on
...
// END modified for Group Pricing per item v1.3.3 add-on
                                              from " . TABLE_PRODUCTS . "
                                              where products_id = '" . (int)$products_id . "'");
