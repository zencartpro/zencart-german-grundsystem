 ...
 * @version $Id: update_product.php for group pricing per item 2.2 2011-11-25 08:17:35Z webchills $
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    ...
    $sql_data_array = array('products_quantity' => $products_quantity,
                            'products_type' =>
//BEGIN mod by Group Pricing per Item v1.3.3
...
// END mod by Group Pricing per Item v1.3.3
