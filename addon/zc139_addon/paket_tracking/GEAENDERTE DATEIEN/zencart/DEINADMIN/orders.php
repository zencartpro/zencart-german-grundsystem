 ...
 * @version $Id: orders.php for Paket Tracking 2.0 2011-06-28 08:17:51Z webchills $
 */
...
// End Paket Tracking 2.0
        ...
        $order_updated = false;
        $check_status = $db->Execute("SELECT customers_name, customers_email_address, orders_status, payment_module_code, shipping_module_code, date_purchased 
				      from " . TABLE_ORDERS . "
                                      where orders_id = '" . (int)$oID . "'");
...
<!-- End Paket Tracking 2.0 -->
      ...
      <tr>
		...
		<strong><?php echo ENTRY_CUSTOMER; ?></strong>
		</td>
