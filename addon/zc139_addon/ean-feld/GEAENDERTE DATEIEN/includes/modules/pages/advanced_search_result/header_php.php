 ...
 * @version $Id: header_php.php for EAN 2011-12-15 11:45:20Z webchills $
 */
...
$select_str = "SELECT DISTINCT " . $select_column_list .
              " m.manufacturers_id, p.products_id, p.products_ean, pd.products_name, p.products_price, p.products_tax_class_id, p.products_price_sorter, p.products_qty_box_status, p.master_categories_id ";
