 ...
 * @version $Id: orders.php for Paket Tracking 2.6 2016-03-12 17:31:16Z webchills $
 */
...
// Begin Paket Tracking 2.6
        ...
        $track_day = str_replace(" ", "", zen_db_prepare_input($_POST['track_day']));
        $track_month = str_replace(" ", "", zen_db_prepare_input($_POST['track_month']));
        $track_year = str_replace(" ", "", zen_db_prepare_input($_POST['track_year']));
// End Paket Tracking 2.6
