 ...
 * @version $Id: copy_to_confirm.php for YouTube 2016-03-05 19:25:16Z webchills $
 */
...
// Copy attributes to duplicate product
          ...
          if ($_POST['copy_as'] == 'link') {
            ...
            $product = $db->Execute("select products_type, products_quantity, products_model, products_image, products_youtube, 
            ...
            $db->Execute("insert into " . TABLE_PRODUCTS . "
                                      (products_type, products_quantity, products_model, products_image, products_youtube, 
                          ...
                          values ('" . zen_db_input($product->fields['products_type']) . "',
                                  ...
                                  '" . zen_db_input($product->fields['products_youtube']) . "',
                                  '" . $products_price . "',
