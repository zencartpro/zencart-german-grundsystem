 ...
 * @version $Id: preview_info.php for YouTube 2016-03-05 18:49:16Z webchills $
 */
  ...
  die('Illegal Access');
    ...
    if (zen_not_null($_POST)) {
      ...
      $product = $db->Execute("select p.products_id, pd.language_id, pd.products_name, pd.products_merkmale,
                                      ...
                                      p.products_model, p.products_image, p.products_youtube, p.products_price, p.products_virtual,
