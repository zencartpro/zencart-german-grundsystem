...
/*
$Id: nusoap.php 15 2006-07-19 09:22:27Z hugo13 $
...
// necessary classes
require_once('class.soapclientNU.php');
...
* @version  $Id: nusoap.php 15 2006-07-19 09:22:27Z hugo13 $
* @access   public
*/
class nusoap_base {
	/**
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (soapclientNU->response has contents of the response)");
			return false;
		}
...
/**
*
* soapclientNU higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $soapclient = new soapclientNU( string path [ ,boolean wsdl] );
*
