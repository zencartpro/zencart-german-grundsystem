...
define('BOX_INFORMATION','Das System verifizieren die von Ihrem Browser bei jeder Anfrage an den Server automatisch generierten Sicherheits ID.<br /><br />Diese Verifizierung prüft, ob alle Anfragen auch wirklich von Ihrem Browser stammen und nicht missbräuchlich verwendet werden.');
?>