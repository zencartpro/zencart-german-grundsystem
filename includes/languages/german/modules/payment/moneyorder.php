...
define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', 'Bitte &Uuml;berweisen Sie den Betrag auf unser Konto:<br />' . MODULE_PAYMENT_MONEYORDER_PAYTO . '<br /><br />' . 'Ihre Bestellung wird versendet, sobald wir den Betrag erhalten haben.');
