 ...
 * @version $Id: move_product.php 2 2020-01-18 16:49:16Z webchills $
 */
...
$contents[] = array('text' => sprintf(TEXT_MOVE_PRODUCTS_INTRO, $pInfo->products_id));
$contents[] = array('text' => zen_draw_label(sprintf(TEXT_MOVE, $pInfo->products_id, $pInfo->products_name, $product_current_category_string), 'move_to_category_id', 'style="font-weight:normal;font-size:larger;"') . zen_draw_pull_down_menu('move_to_category_id', zen_get_category_tree(), $current_category_id, 'id="move_to_category_id" class="form-control"'));
