...
define('ENTRY_REVIEW_TEXT', '<b>HINWEIS:</b> HTML ist nicht erlaubt (wird entfernt werden).');
...
define('TEXT_EDIT_REVIEW', 'Bearbeiten');
define('TEXT_DELETE_REVIEW', 'Löschen');
define('TEXT_VIEW_REVIEW', 'Im Frontend ansehen');
